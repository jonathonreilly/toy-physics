...
cited lattice Noether theorem, integer-valued by R7 Block 03) is a
...
the cited lattice Noether theorem.
...
By N2 of the cited lattice Noether theorem, Q̂_total is the conserved
...
By R3 Block 01 / N2 of cited Noether: [H, Q̂_total] = 0. Hence H
...
from a single cited one-hop dependency by elementary spectral functional
