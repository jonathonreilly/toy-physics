...
- `koide_a1_fractional_topology_no_go_synthesis_note_2026-04-24` — DOWNSTREAM
  aggregator (the synthesis note aggregates the 5 NO-GO probes including
  this one). Reference is backticked rather than markdown-linked because
  the citation graph direction is *synthesis → o13_probe*; a markdown link
  here would create the wrong-direction edge and a length-2 cycle.
