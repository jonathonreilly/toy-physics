...
inherits the LHCM family's `admitted_context_inputs` framing, which
records the staggered-Dirac realization gate per
[`MINIMAL_AXIOMS_2026-05-03.md`](MINIMAL_AXIOMS_2026-05-03.md) Section
"Staggered-Dirac realization derivation target" as an ambient
admitted-context input for any LHCM-family row that touches fermion
...
- [`LH_DOUBLET_EIGENVALUE_RATIO_PROOF_WALK_LATTICE_INDEPENDENCE_BOUNDED_NOTE_2026-05-10.md`](LH_DOUBLET_EIGENVALUE_RATIO_PROOF_WALK_LATTICE_INDEPENDENCE_BOUNDED_NOTE_2026-05-10.md)
  as a sibling proof-walk on the related ratio algebra (the same
  graph-first commutant structure supplies the multiplicities for both
  the eigenvalue ratio and the block dimensions).
...
- the SM-definition label `quark` for the SU(3)-charged Weyl fermion
  ...
  remaining residual identified by
...
The matter-assignment note's `positive_theorem` author hint is
retained: this proof-walk is itself a `bounded_theorem` and does not
