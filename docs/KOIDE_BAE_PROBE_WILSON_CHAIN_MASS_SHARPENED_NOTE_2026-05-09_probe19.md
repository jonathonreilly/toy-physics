...
retained content (Wilson action chain, retained `α_LM`, retained
...
1. **POSITIVE FINDING (scale closure):** The retained Wilson chain
   ...
   The exponent **18 = 16 + 2** has natural retained content reading:
...
admitted by this probe; all are pre-existing retained content.
...
2. **Exponent provenance.** The exponent 18 = 16 + 2 has clean
   retained content reading: 16 = staggered taste doublers in 4D
