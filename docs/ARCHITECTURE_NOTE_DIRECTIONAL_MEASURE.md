...
**Date:** 2026-04-05 (originally); 2026-05-03 (review-loop repair)
...
**Beta-derivation status:** [`docs/ANGULAR_KERNEL_UNDERDETERMINATION_NO_GO_NOTE.md`](ANGULAR_KERNEL_UNDERDETERMINATION_NO_GO_NOTE.md) — proves `β` cannot be derived from the current A1+A2 primitive core plus the named directional-measure constraints alone; β = 0.8 is observable-matched against the eikonal-slope criterion of [`BORN_SCATTERING_COMPARISON_NOTE.md`](BORN_SCATTERING_COMPARISON_NOTE.md) (closure route 3 of the no-go).
