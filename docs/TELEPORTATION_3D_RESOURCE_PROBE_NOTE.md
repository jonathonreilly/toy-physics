...
## Audit scope (numeric refresh 2026-05-10)

The audit ledger row for `teleportation_3d_resource_probe_note` flagged
the prior table as carrying stale numerical values relative to current
runner output. Auditor's repair target:
...
note remains `bounded_theorem` with `audited_conditional` audit status
per the live ledger.
...
| `3d_side2_G100` | `2.16713` | `0.887978` | `Psi+` | `0.112022` | `0.408015` | `0.925319` | `2.53149` | `0.387978` | `2.498e-16` | no |
| `3d_side2_G500` | `2.75551` | `0.991220` | `Psi+` | `0.008780` | `0.339187` | `0.994146` | `2.80370` | `0.491220` | `2.220e-16` | yes |
