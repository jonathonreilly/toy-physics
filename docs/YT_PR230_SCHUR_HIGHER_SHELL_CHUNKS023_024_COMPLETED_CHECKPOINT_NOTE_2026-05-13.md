# PR230 Higher-Shell Chunks023-024 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks023-024
completed-mode checkpoints passed; higher-shell support prefix now 24/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks023-024 completed-mode checkpoints passed; higher-shell support prefix 24/63
...
Higher-shell chunks023-024 completed under the separate non-colliding roots:
...
- fixed seeds `2026057023` and `2026057024`;
...
- chunk023: `created_utc=2026-05-13T06:58:50Z`, seed `2026057023`;
- chunk024: `created_utc=2026-05-13T06:59:02Z`, seed `2026057024`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[25,26]` if
the support campaign continues.

## Boundary

Chunks023-024 are higher-shell support rows only. They extend the completed
higher-shell prefix to 24/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 23 \
  --output outputs/yt_pr230_schur_higher_shell_chunk023_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 24 \
  --output outputs/yt_pr230_schur_higher_shell_chunk024_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..24]
