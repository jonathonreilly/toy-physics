...
**Generated:** 2026-05-03T14:08:56.819512+00:00
**Total pending:** 796
...
|---:|---|---|---|---|---:|---:|:---:|---|---|
| 1 | `gate_b_farfield_note` | bounded_theorem | unaudited | critical | 81 | 13.86 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/gate_b_farfield_harness.py` |
...
| 24 | `g_bare_derivation_note` | positive_theorem | unaudited | critical | 280 | 14.63 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_g_bare_derivation.py` |
| 25 | `g_bare_derivation_status_correction_audit_note_2026-05-02` | positive_theorem | unaudited | critical | 280 | 8.63 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_g_bare_derivation_status_audit.py` |
