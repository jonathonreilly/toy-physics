...
**Generated:** 2026-04-27T02:17:58.912648+00:00
**Total pending:** 1600
**Ready (all deps already at a stable tier):** 1202
...
| 23 | `graph_first_su3_integration_note` | critical | 275 | 23.11 | Y | cross_family_with_cross_confirmation | `scripts/frontier_graph_first_su3_integration.py` |
| 24 | `rconn_derived_note` | critical | 275 | 18.11 | Y | cross_family_with_cross_confirmation | `scripts/frontier_color_projection_mc.py` |
| 25 | `yt_color_projection_correction_note` | critical | 275 | 16.11 | Y | cross_family_with_cross_confirmation | `scripts/frontier_yt_color_projection_correction.py` |
| 26 | `g_bare_derivation_note` | critical | 275 | 13.61 | Y | cross_family_with_cross_confirmation | `scripts/frontier_g_bare_derivation.py` |
| 27 | `native_gauge_closure_note` | critical | 274 | 19.60 | Y | cross_family_with_cross_confirmation | - |
| 28 | `s3_mass_matrix_no_go_note` | critical | 274 | 16.10 | Y | cross_family_with_cross_confirmation | `scripts/frontier_s3_mass_matrix_no_go.py` |
| 29 | `s3_taste_cube_decomposition_note` | critical | 274 | 16.10 | Y | cross_family_with_cross_confirmation | `scripts/frontier_s3_action_taste_cube_decomposition.py` |
| 30 | `z2_hw1_mass_matrix_parametrization_note` | critical | 274 | 16.10 | Y | cross_family_with_cross_confirmation | `scripts/frontier_z2_hw1_mass_matrix_parametrization.py` |
| 31 | `g_bare_rigidity_theorem_note` | critical | 274 | 15.60 | Y | cross_family_with_cross_confirmation | `scripts/frontier_g_bare_rigidity_theorem.py` |
| 32 | `yt_qfp_insensitivity_support_note` | critical | 274 | 14.60 | Y | cross_family_with_cross_confirmation | `scripts/frontier_yt_qfp_insensitivity.py` |
| 33 | `yt_explicit_systematic_budget_note` | critical | 274 | 14.10 | Y | cross_family_with_cross_confirmation | `scripts/frontier_yt_explicit_systematic_budget.py` |
| 34 | `graph_first_selector_derivation_note` | critical | 274 | 13.60 | Y | cross_family_with_cross_confirmation | `scripts/frontier_graph_first_selector_derivation.py` |
| 35 | `higgs_mass_from_axiom_note` | critical | 274 | 13.10 | Y | cross_family_with_cross_confirmation | - |
| 36 | `confinement_string_tension_note` | critical | 118 | 14.39 | Y | cross_family_with_cross_confirmation | `scripts/frontier_confinement_string_tension.py` |
| 37 | `gauge_vacuum_plaquette_bridge_support_note` | critical | 278 | 14.62 |  | cross_family_with_cross_confirmation | - |
| 38 | `plaquette_self_consistency_note` | critical | 277 | 15.62 |  | cross_family_with_cross_confirmation | `scripts/frontier_plaquette_self_consistency.py` |
| 39 | `higgs_mass_derived_note` | critical | 276 | 20.11 |  | cross_family_with_cross_confirmation | - |
| 40 | `higgs_mechanism_note` | critical | 276 | 13.11 |  | cross_family_with_cross_confirmation | `scripts/frontier_higgs_mass_derived.py` |
| 41 | `higgs_from_lattice_note` | critical | 276 | 12.61 |  | cross_family_with_cross_confirmation | `scripts/frontier_higgs_mass_derived.py` |
| 42 | `alpha_s_derived_note` | critical | 275 | 32.61 |  | cross_family_with_cross_confirmation | - |
| 43 | `g_bare_dynamical_fixation_obstruction_note_2026-04-18` | critical | 274 | 14.10 |  | cross_family_with_cross_confirmation | `scripts/frontier_g_bare_critical_feature_scan.py` |
| 44 | `three_generation_structure_note` | critical | 273 | 25.10 |  | cross_family_with_cross_confirmation | - |
| 45 | `one_generation_matter_closure_note` | critical | 273 | 24.60 |  | cross_family_with_cross_confirmation | - |
| 46 | `three_generation_observable_theorem_note` | critical | 273 | 24.60 |  | cross_family_with_cross_confirmation | `scripts/frontier_three_generation_observable_theorem.py` |
| 47 | `yt_ward_identity_derivation_theorem` | critical | 273 | 23.10 |  | cross_family_with_cross_confirmation | `scripts/frontier_yt_ward_identity_derivation.py` |
| 48 | `anomaly_forces_time_theorem` | critical | 273 | 22.60 |  | cross_family_with_cross_confirmation | - |
| 49 | `minimal_axioms_2026-04-11` | critical | 273 | 21.60 |  | cross_family_with_cross_confirmation | - |
| 50 | `left_handed_charge_matching_note` | critical | 273 | 21.10 |  | cross_family_with_cross_confirmation | `scripts/frontier_graph_first_su3_integration.py` |
