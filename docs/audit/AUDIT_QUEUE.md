...
|---:|---|---|---|---|---:|---:|:---:|---|---|
| 1 | `source_driven_field_recovery_sweep_note` | bounded_theorem | audit_in_progress | critical | 456 | 9.34 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/source_driven_field_recovery_sweep.py` |
