...
**Generated:** 2026-04-29T12:48:06.172910+00:00
**Total pending:** 1353
...
| 2 | `gauge_vacuum_plaquette_transfer_operator_character_recurrence_note` | critical | 283 | 15.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_transfer_operator_character_recurrence.py` |
| 3 | `gauge_vacuum_plaquette_perron_jacobi_underdetermination_note` | critical | 283 | 15.15 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_perron_jacobi_underdetermination.py` |
| 4 | `gauge_vacuum_plaquette_source_sector_matrix_element_factorization_note` | critical | 283 | 15.15 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_source_sector_matrix_element_factorization.py` |
| 5 | `gauge_vacuum_plaquette_connected_hierarchy_theorem_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_connected_hierarchy_theorem.py` |
| 6 | `gauge_vacuum_plaquette_framework_point_underdetermination_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_framework_point_underdetermination.py` |
| 7 | `gauge_vacuum_plaquette_infinite_hierarchy_obstruction_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_infinite_hierarchy_obstruction.py` |
| 8 | `gauge_vacuum_plaquette_local_environment_factorization_theorem_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_local_environment_factorization.py` |
| 9 | `gauge_vacuum_plaquette_perron_reduction_theorem_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_perron_reduction_theorem.py` |
| 10 | `gauge_vacuum_plaquette_reduction_existence_theorem_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_reduction_existence_theorem.py` |
| 11 | `gauge_vacuum_plaquette_residual_environment_identification_theorem_note` | critical | 283 | 14.65 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_residual_environment_identification.py` |
