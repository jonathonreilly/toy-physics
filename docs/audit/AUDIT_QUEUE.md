...
**Generated:** 2026-05-01T18:19:18.272239+00:00
**Total pending:** 581
...
|---:|---|---|---:|---:|:---:|---|---|
| 1 | `su3_cubic_anomaly_cancellation_theorem_note_2026-04-24` | critical | 263 | 14.54 |  | fresh_context_or_stronger_with_cross_confirmation | - |
| 2 | `gauge_vacuum_plaquette_tensor_transfer_perron_solve_note` | critical | 263 | 9.04 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_tensor_transfer_perron_solve.py` |
...
| 4 | `gauge_vacuum_plaquette_bridge_support_note` | critical | 262 | 10.54 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_bridge_support.py` |
| 5 | `plaquette_self_consistency_note` | critical | 261 | 16.03 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_plaquette_self_consistency.py` |
| 6 | `ew_current_matching_ozi_suppression_theorem_note_2026-04-27` | critical | 260 | 8.53 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_color_projection_mc.py` |
| 7 | `g_bare_dynamical_fixation_obstruction_note_2026-04-18` | critical | 258 | 10.02 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_g_bare_critical_feature_scan.py` |
| 8 | `alpha_s_derived_note` | critical | 257 | 29.51 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_yt_zero_import_chain.py` |
| 9 | `yt_zero_import_authority_note` | critical | 257 | 11.51 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_yt_ward_identity_derivation.py` |
| 10 | `alpha_s_direct_wilson_loop_derivation_theorem_note_2026-04-30` | critical | 257 | 9.51 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_alpha_s_direct_wilson_loop.py` |
| 11 | `yt_flagship_boundary_note` | critical | 257 | 8.51 |  | fresh_context_or_stronger_with_cross_confirmation | - |
| 12 | `publication.ci3_z3.publication_matrix` | critical | 32 | 12.54 |  | fresh_context_or_stronger_with_cross_confirmation | - |
| 13 | `planck_parent_source_hidden_character_no_go_note_2026-04-24` | high | 42 | 10.43 | Y | fresh_context_or_stronger | `scripts/frontier_planck_parent_source_hidden_character_nogo.py` |
| 14 | `planck_finite_response_no_go_note_2026-04-24` | high | 41 | 9.89 | Y | fresh_context_or_stronger | `scripts/frontier_planck_finite_response_nogo.py` |
| 15 | `planck_target3_phase_unit_edge_statistics_boundary_note_2026-04-25` | high | 33 | 7.59 | Y | fresh_context_or_stronger | `scripts/frontier_planck_target3_phase_unit_edge_statistics.py` |
