...
271 citation cycles in the graph. Each cycle permanently blocks every member from `retained` until one node is re-audited with explicit cycle-break instructions or a 'see also' edge is stripped. Top 25 below; full list in `data/audit_queue.json` under `cycle_break_targets`.
...
| 10 | `cycle-0010` | 2 | 531 | `universal_gr_tensor_quotient_uniqueness_note` | critical | unaudited |
| 11 | `cycle-0011` | 2 | 531 | `universal_qg_canonical_textbook_continuum_gr_closure_note` | critical | unaudited |
| 12 | `cycle-0012` | 3 | 531 | `antigravity_sign_selector_boundary_note` | critical | unaudited |
| 13 | `cycle-0013` | 3 | 531 | `gravity_signed_source_density_boundary_note` | critical | unaudited |
| 14 | `cycle-0014` | 3 | 531 | `signed_gravity_aps_action_origin_superselection_stability_note` | critical | unaudited |
| 15 | `cycle-0015` | 3 | 531 | `signed_gravity_aps_locked_axiom_extension_note` | critical | unaudited |
| 16 | `cycle-0016` | 3 | 531 | `signed_gravity_aps_boundary_index_chi_probe_note` | critical | unaudited |
| 17 | `cycle-0017` | 3 | 531 | `signed_gravity_chi_selector_theorem_or_nogo_note` | critical | unaudited |
...
| 20 | `cycle-0020` | 3 | 531 | `signed_gravity_native_boundary_complex_containment_note` | critical | unaudited |
| 21 | `cycle-0021` | 3 | 531 | `signed_gravity_aps_locked_source_action_proposal_note` | critical | unaudited |
| 22 | `cycle-0022` | 3 | 531 | `universal_qg_canonical_textbook_weak_measure_equivalence_note` | critical | unaudited |
| 23 | `cycle-0023` | 4 | 531 | `antigravity_sign_selector_boundary_note` | critical | unaudited |
| 24 | `cycle-0024` | 4 | 531 | `gravity_signed_source_density_boundary_note` | critical | unaudited |
| 25 | `cycle-0025` | 4 | 531 | `gravity_signed_source_density_boundary_note` | critical | unaudited |
