...
| 2 | `gauge_vacuum_plaquette_rho_pq6_wilson_environment_bounded_note_2026-05-09` | bounded_theorem | unaudited | critical | 517 | 10.02 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_gauge_vacuum_plaquette_rho_pq_6_wilson_environment_compute.py` |
...
| 6 | `left_handed_charge_matching_note` | bounded_theorem | unaudited | critical | 605 | 27.24 |  | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_graph_first_su3_integration.py` |
...
| 9 | `cycle-0009` | 2 | 506 | `g_bare_canonical_convention_narrow_theorem_note_2026-05-02` | critical | unaudited |
| 10 | `cycle-0010` | 2 | 506 | `g_bare_forced_by_ward_rep_b_independence_theorem_note_2026-05-09` | critical | unaudited |
| 11 | `cycle-0011` | 3 | 506 | `g_bare_canonical_convention_narrow_theorem_note_2026-05-02` | critical | unaudited |
| 12 | `cycle-0012` | 6 | 506 | `g_bare_constraint_vs_convention_restatement_note_2026-05-07` | critical | unaudited |
| 13 | `cycle-0013` | 7 | 506 | `g_bare_constraint_vs_convention_restatement_note_2026-05-07` | critical | unaudited |
| 14 | `cycle-0014` | 8 | 506 | `alpha_s_derived_note` | critical | audited_conditional |
| 15 | `cycle-0015` | 8 | 506 | `alpha_s_derived_note` | critical | audited_conditional |
| 16 | `cycle-0016` | 8 | 506 | `alpha_s_derived_note` | critical | audited_conditional |
| 17 | `cycle-0017` | 8 | 506 | `alpha_s_derived_note` | critical | audited_conditional |
