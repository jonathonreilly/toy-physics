...
| 5 | `koide_cyclic_wilson_descendant_law_note_2026-04-18` | positive_theorem | unaudited | critical | 286 | 10.66 | Y | fresh_context_or_stronger_with_cross_confirmation | `scripts/frontier_koide_cyclic_wilson_descendant_law.py` |
