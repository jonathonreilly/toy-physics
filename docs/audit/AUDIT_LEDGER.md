...
**Generated:** 2026-04-30T17:15:52.237418+00:00
...
- runners classified: 1131
- runners with (C) first-principles compute hits: 519
- runners with (D) external comparator hits: 281
...
|---:|---|---|---:|---:|---|---|
| 1 | `alpha_s_derived_note` | critical | 243 | 29.43 | `unaudited` | ~~audited_failed~~ |
| 2 | `wolfenstein_lambda_a_structural_identities_theorem_note_2026-04-24` | critical | 115 | 28.86 | `unaudited` | ~~audited_failed~~ |
| 3 | `ckm_cp_phase_structural_identity_theorem_note_2026-04-24` | critical | 114 | 28.84 | `unaudited` | ~~audited_failed~~ |
...
| 7 | `ckm_magnitudes_structural_counts_theorem_note_2026-04-25` | critical | 101 | 23.67 | `unaudited` | ~~audited_failed~~ |
...
| 10 | `three_generation_structure_note` | critical | 250 | 20.97 | `unaudited` | ~~audited_failed~~ |
| 11 | `ckm_atlas_triangle_right_angle_theorem_note_2026-04-24` | critical | 113 | 20.83 | `unaudited` | ~~audited_failed~~ |
| 12 | `one_generation_matter_closure_note` | critical | 244 | 20.44 | `unaudited` | ~~audited_failed~~ |
| 13 | `ckm_nlo_barred_triangle_protected_gamma_theorem_note_2026-04-25` | critical | 93 | 19.55 | `unaudited` | ~~audited_failed~~ |
| 14 | `planck_parent_source_hidden_character_no_go_note_2026-04-24` | high | 42 | 18.43 | `audited_clean` | **retained** |
| 15 | `minimal_axioms_2026-04-11` | critical | 106 | 17.74 | `unaudited` | ~~audited_failed~~ |
| 16 | `left_handed_charge_matching_note` | critical | 251 | 17.48 | `audited_conditional` | ~~audited_conditional~~ |
| 17 | `anomaly_forces_time_theorem` | critical | 247 | 17.45 | `unaudited` | ~~audited_failed~~ |
| 18 | `ckm_atlas_axiom_closure_note` | critical | 74 | 17.23 | `unaudited` | ~~audited_failed~~ |
...
| 21 | `plaquette_self_consistency_note` | critical | 294 | 16.20 | `unaudited` | ~~audited_failed~~ |
| 22 | `physical_lattice_necessity_note` | critical | 278 | 15.62 | `unaudited` | ~~audited_failed~~ |
| 23 | `dm_neutrino_source_surface_active_half_plane_theorem_note_2026-04-16` | critical | 127 | 15.50 | `unaudited` | ~~audited_failed~~ |
| 24 | `site_phase_cube_shift_intertwiner_note` | critical | 285 | 15.16 | `audited_clean` | support |
| 25 | `cosmological_constant_spectral_gap_identity_theorem_note` | critical | 48 | 15.12 | `unaudited` | ~~audited_failed~~ |
...
| `gauge_vacuum_plaquette_local_environment_factorization_theorem_note` | open | ~~audited_clean~~ | open | fresh_context | codex-current | A | - |
...
| `graph_first_selector_derivation_note` | _proposed_retained_ | ~~audited_clean~~ | **retained** | fresh_context | codex-current | A | - |
...
| `asymmetry_persistence_joint_card_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `causal_escape_window_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `central_band_collapse_strength_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_dense_boundary_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_dense_joint_highn_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_dense_joint_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_dense_largen_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_layernorm_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `central_band_mass_window_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `charged_lepton_lane6_theorem_plan_note_2026-04-28` | open | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `charged_lepton_y_tau_m3_premise_self_correction_note_2026-04-28` | open | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `charged_lepton_y_tau_mechanism_stuck_fanout_note_2026-04-28` | open | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `charged_lepton_y_tau_ward_identity_su2_anchor_stretch_attempt_note_2026-04-28` | open | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `charged_lepton_y_tau_ward_identity_u1_anchor_stretch_attempt_note_2026-04-28` | open | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `chiral_3plus1d_boundary_phase_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `ckm_from_mass_hierarchy_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | fresh_context | codex-current | D | - |
...
| `dense_prune_guard_seed_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `diamond_absolute_unit_bridge_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `diamond_phase_ramp_bridge_card_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `dirac_source_smoothing_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `dirac_v4_convergence_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `dirac_weak_coupling_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `directional_b_density_stencil_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
| `directional_b_geometry_normalized_holdout_transfer_mass5_note` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-current | B | - |
...
| `dm_neutrino_source_surface_parity_compatible_observable_selector_theorem_note_2026-04-17` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | cross_family | codex-gpt-5 | A | - |
...
| `g_bare_two_ward_same_1pi_pinning_theorem_note_2026-04-19` | support | ~~audited_conditional~~ | ~~audited_conditional~~ | fresh_context | codex-gpt-5 | B | - |
...
| `gauge_vacuum_plaquette_connected_hierarchy_theorem_note` | unknown | ~~audited_conditional~~ | ~~audited_conditional~~ | fresh_context | codex-current | B | - |
...
| `gauge_vacuum_plaquette_perron_reduction_theorem_note` | support | ~~audited_conditional~~ | ~~audited_conditional~~ | fresh_context | codex-current | C | - |
...
| `quark_projector_parameter_audit_note_2026-04-19` | bounded | ~~audited_conditional~~ | ~~audited_conditional~~ | fresh_context | codex-current | B | `quark_projector_ray_phase_completion_note_2026-04-18` |
...
| `gauge_vacuum_plaquette_source_sector_matrix_element_factorization_note` | support | ~~audited_failed~~ | ~~audited_failed~~ | fresh_context | codex-current | A | - |
...
| `gauge_vacuum_plaquette_reduction_existence_theorem_note` | unknown | ~~audited_renaming~~ | ~~audited_renaming~~ | fresh_context | codex-current | E | - |
| `gauge_vacuum_plaquette_residual_environment_identification_theorem_note` | support | ~~audited_renaming~~ | ~~audited_renaming~~ | fresh_context | codex-current | F | - |
| `gauge_vacuum_plaquette_spatial_environment_character_measure_theorem_note` | support | ~~audited_renaming~~ | ~~audited_renaming~~ | fresh_context | codex-current | F | - |
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Action-Power Scaling Sweep: bounded fixed-family scaling replay  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** ALT Connectivity Family Complex Failure Note: diagnosed boundary for complex action on the alternative connectivity family  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** ALT Connectivity Family Failure Note: diagnosed failure boundary for the alternative connectivity family  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Asymmetry Persistence Mass Window Note: Asymmetry Persistence Mass Window Note  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Asymmetry Persistence Pilot Note: Asymmetry Persistence Pilot Note  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Audited Symmetry Synthesis Note: synthesis-ready on the validated subset only  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** support  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Per-Site Uniqueness of the Cl(3) Spinor Module: the stated finite-lattice/Cl(3) theorem is proved on the listed A_min objects and checked by the registered runner.  _(class `C`)_
...
- **rationale:** The load-bearing theorem is structural rather than a tuned numerical match: support — branch-local theorem note on A_min; runner passing; audit-pending.. The registered runner completed successfully and its classified PASS surface is {'A': 0, 'B': 0, 'C': 5, 'D': 0, 'total_pass': 5}. Residual risk is limited to the support/branch-local scope stated by the note; this does not promote the row beyond its author-declared tier.
- **auditor confidence:** high
...
- **effective_status:** support  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Cluster Decomposition / Lieb–Robinson Bound on Cl(3) ⊗ Z^3: the stated finite-lattice/Cl(3) theorem is proved on the listed A_min objects and checked by the registered runner.  _(class `C`)_
- **chain closes:** True — Yes. The note gives a self-contained structural proof on the stated A_min objects, and the registered runner completed successfully on the load-bearing algebraic checks.
- **rationale:** The load-bearing theorem is structural rather than a tuned numerical match: support — branch-local theorem note on A_min; runner passing; audit-pending.. The registered runner completed successfully and its classified PASS surface is {'A': 0, 'B': 0, 'C': 3, 'D': 0, 'total_pass': 3}. Residual risk is limited to the support/branch-local scope stated by the note; this does not promote the row beyond its author-declared tier.
- **auditor confidence:** high
...
- **effective_status:** support  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Coleman–Mermin–Wagner Lattice Analogue on Cl(3) ⊗ Z^d: the stated finite-lattice/Cl(3) theorem is proved on the listed A_min objects and checked by the registered runner.  _(class `C`)_
- **chain closes:** True — Yes. The note gives a self-contained structural proof on the stated A_min objects, and the registered runner completed successfully on the load-bearing algebraic checks.
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First CPT Theorem (Stretch Attempt) on Cl(3) ⊗ Z^3: bounded — branch-local stretch note on canonical A_min; fermion-sector runner passing; Wilson-plaquette SU(3) lift residual stated; audit-pending.  _(class `B`)_
- **chain closes:** False — No. The note itself leaves the wilson-plaquette su(3) lift as a residual stretch rather than a closed cpt theorem, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the note itself leaves the Wilson-plaquette SU(3) lift as a residual stretch rather than a closed CPT theorem. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **auditor confidence:** high
...
- **effective_status:** support  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Reflection Positivity for the Canonical CL3-on-Z3 Action: the stated finite-lattice/Cl(3) theorem is proved on the listed A_min objects and checked by the registered runner.  _(class `C`)_
- **chain closes:** True — Yes. The note gives a self-contained structural proof on the stated A_min objects, and the registered runner completed successfully on the load-bearing algebraic checks.
- **rationale:** The load-bearing theorem is structural rather than a tuned numerical match: support — branch-local theorem note on A_min; runner passing; audit-pending.. The registered runner completed successfully and its classified PASS surface is {'A': 0, 'B': 0, 'C': 21, 'D': 0, 'total_pass': 21}. Residual risk is limited to the support/branch-local scope stated by the note; this does not promote the row beyond its author-declared tier.
- **auditor confidence:** high
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Spectrum Condition (Lattice Analogue) on Cl(3) ⊗ Z^3: support — branch-local theorem note on A_min; runner passing; audit-pending.  _(class `B`)_
- **chain closes:** False — No. The proof imports the reflection-positivity companion as a load-bearing premise that is not listed as a ledger dependency for this row, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the proof imports the reflection-positivity companion as a load-bearing premise that is not listed as a ledger dependency for this row. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
...
- **effective_status:** support  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom-First Spin-Statistics Theorem on Cl(3) ⊗ Z^3: the stated finite-lattice/Cl(3) theorem is proved on the listed A_min objects and checked by the registered runner.  _(class `C`)_
- **chain closes:** True — Yes. The note gives a self-contained structural proof on the stated A_min objects, and the registered runner completed successfully on the load-bearing algebraic checks.
- **rationale:** The load-bearing theorem is structural rather than a tuned numerical match: support — branch-local theorem note on A_min; runner passing; audit-pending.. The registered runner completed successfully and its classified PASS surface is {'A': 0, 'B': 0, 'C': 9, 'D': 0, 'total_pass': 9}. Residual risk is limited to the support/branch-local scope stated by the note; this does not promote the row beyond its author-declared tier.
- **auditor confidence:** high

### `axiom_reduction_note`

- **Note:** [`AXIOM_REDUCTION_NOTE.md`](../../docs/AXIOM_REDUCTION_NOTE.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Axiom Reduction: Honest Minimal Assumption Inventory: Axiom Reduction: Honest Minimal Assumption Inventory  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Broken-Graph Action-Power Robustness Note: bounded graph-damage replay diagnostic on the upstream 3D ordered-lattice family; not a standalone tier-ratifiable theorem, the cited frozen log is missing, and the cited relation notes are themselves bounded fixed-family controls rather than audit-clean dependencies.  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Causal Cone Speed Map Note: bounded cone-speed probe on the center grown family  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Causal-Escape Window: Qualitative Regime (Conditional): bounded conditional finite-window diagnostic at `eta = 20` on the listed seeds — escape regime exists in the registered runner output, but the broader mechanism / boundary package (exposure-matched static escape, `c_crit` / `eta_max` / s-dependence tables, four-seed robustness gate) is not computed by the runner. Not a tier-ratifiable causal-escape theorem.  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`CAUSAL_MOVING_UNIFICATION_NOTE.md`](../../docs/CAUSAL_MOVING_UNIFICATION_NOTE.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Causal vs Moving-Source Unification Note: narrow classification note: shared causal-delay core, but genuinely separate observables  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`CHARGED_LEPTON_Y_TAU_M3_PREMISE_SELF_CORRECTION_NOTE_2026-04-28.md`](../../docs/CHARGED_LEPTON_Y_TAU_M3_PREMISE_SELF_CORRECTION_NOTE_2026-04-28.md)
- **current_status:** open
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** `y_τ` Cycle 4 Fan-out M3 Premise — Self-Correction: open branch-local **self-correction** note on  _(class `B`)_
- **chain closes:** False — No. The source note explicitly frames this as open, future, planning, or a stretch attempt rather than a closed theorem, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the source note explicitly frames this as open, future, planning, or a stretch attempt rather than a closed theorem. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **auditor:** `codex-fresh-context-20260430-07-ckm-down-scale`  (codex-current; independence=fresh_context)
- **load-bearing step:** R_pred / R_thresh = 1.0020 (+0.20%), with R_pred := (alpha_s(v)/sqrt(6))^(6/5) and R_thresh := m_s(2 GeV)/m_b(m_b).  _(class `G`)_
- **chain closes:** False — The arithmetic threshold-local match is reproduced, but the 5/6 bridge and threshold-local scale convention are not derived, and the runner hard-codes the full-loop transport value while constructing R_common from R_thresh.
- **rationale:** Issue: The load-bearing sub-percent result is a numerical match at the selected threshold-local scale, not a retained derivation of the down-type ratio or scale convention. Why this blocks: A proposed-retained claim needs exponent, comparator scale, and normalization/readout from retained inputs; here the 5/6 bridge and unique threshold-local scale choice remain open, and the runner hard-codes the transport value used to close the scale accounting. Repair target: Provide a retained theorem deriving the 5/6 bridge and framework-natural mass-scale convention, and update the runner to compute transport/common-scale comparison from independent inputs rather than defining one side from the other. Claim boundary until fixed: Bounded support for a +0.20% threshold-local coincidence and common-vs-threshold transport accounting, not retained theorem-grade closure.
- **open / conditional deps cited:**
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Complex Selectivity Compare Note: narrow comparison card for signed-source portability vs complex-action selectivity  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Composite-Source Additivity Cross-Family Note: bounded second-family additivity probe on the upstream 2D ordered lattice; not a standalone tier-ratifiable theorem and depends on unregistered upstream 2D ordered-lattice / continuum lane and 3D additivity note dependencies. Persistent-pattern inertia is explicitly left open.  _(class `B`)_
- **chain closes:** False — No. The source note explicitly frames this as open, future, planning, or a stretch attempt rather than a closed theorem, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the source note explicitly frames this as open, future, planning, or a stretch attempt rather than a closed theorem. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Coupled Field Generated Family Probe: bounded no-go for the minimal source-driven coupled-field rescue on the compact generated DAG family  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIAMOND_ABSOLUTE_UNIT_BRIDGE_NOTE.md`](../../docs/DIAMOND_ABSOLUTE_UNIT_BRIDGE_NOTE.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Diamond Absolute Unit Bridge Note: calibration bridge note, not an experimental claim  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIAMOND_PHASE_RAMP_BRIDGE_CARD_NOTE.md`](../../docs/DIAMOND_PHASE_RAMP_BRIDGE_CARD_NOTE.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Diamond Phase-Ramp Bridge Card Note: proxy-level bridge card, not an absolute NV claim  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIAMOND_SENSOR_PREDICTION_NOTE.md`](../../docs/DIAMOND_SENSOR_PREDICTION_NOTE.md)
- **current_status:** bounded
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Diamond Sensor Prediction Note: experiment-facing discriminator note, intentionally bounded  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Diamond Sensor Protocol Note: lab-facing discriminator protocol, intentionally bounded  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIRECTIONAL_B_GEOMETRY_NORMALIZED_HOLDOUT_TRANSFER_MASS5_NOTE.md`](../../docs/DIRECTIONAL_B_GEOMETRY_NORMALIZED_HOLDOUT_TRANSFER_MASS5_NOTE.md)
- **current_status:** bounded
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Directional-B Geometry-Normalized Holdout Transfer Mass5 Note: bounded widened-source holdout replay for geometry-normalized response density  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIRECTIONAL_B_GEOMETRY_NORMALIZED_HOLDOUT_TRANSFER_NOTE.md`](../../docs/DIRECTIONAL_B_GEOMETRY_NORMALIZED_HOLDOUT_TRANSFER_NOTE.md)
- **current_status:** bounded
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Directional-B Geometry-Normalized Holdout Transfer Note: bounded family-transfer replay for geometry-normalized response density  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIRECTIONAL_B_GEOMETRY_NORMALIZED_OVERLAP_MAP_NOTE.md`](../../docs/DIRECTIONAL_B_GEOMETRY_NORMALIZED_OVERLAP_MAP_NOTE.md)
- **current_status:** bounded
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Directional-B Geometry-Normalized Overlap Map Note: bounded overlap/occupancy map for the widened-source holdout  _(class `B`)_
- **chain closes:** False — No. The load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the load-bearing replay or comparison depends on an unregistered script/log/artifact that is not available as a primary runner in the restricted audit packet. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
...
- **Note:** [`DIRECTIONAL_B_GEOMETRY_NORMALIZED_OVERLAP_SUBCRITICAL_N12_NOTE.md`](../../docs/DIRECTIONAL_B_GEOMETRY_NORMALIZED_OVERLAP_SUBCRITICAL_N12_NOTE.md)
- **current_status:** bounded
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop:leaf-bottomup-2026-04-30`  (codex-current; independence=cross_family)
- **load-bearing step:** Distance Law Breakpoint Note: bounded narrow breakpoint table — the runner reprints hard-coded `alpha` / direction rows; the architecture-feature diagnosis (open directed vs shell vs reflection vs deep-branch routing) is not closed by matched ablation computations. Cited distance-law portability note is unknown; sign-invariant context is conditional. Not a tier-ratifiable architecture-feature theorem.  _(class `B`)_
- **chain closes:** False — No. The status line says the runner reprints hard-coded rows and the architecture-feature diagnosis lacks matched ablation computations, so the conclusion cannot be ratified from the source note alone.
- **rationale:** Issue: the status line says the runner reprints hard-coded rows and the architecture-feature diagnosis lacks matched ablation computations. Why this blocks: the audit packet does not independently close the load-bearing step, so the row cannot carry an audit-clean theorem/result beyond its stated bounded or open scope. Repair target: register a current runner/log or cite an audited dependency that proves the missing bridge, then re-audit the narrowed claim. Claim boundary until fixed: safe to cite as a bounded diagnostic, roadmap, archive, or finite-slice report only as worded in the source note.
- **open / conditional deps cited:**
  - `unregistered_or_missing_primary_runner_or_frozen_log`
- **auditor confidence:** high
...
- **Note:** [`DM_LEPTOGENESIS_TRANSPORT_DECOMPOSITION_THEOREM_NOTE_2026-04-16.md`](../../docs/DM_LEPTOGENESIS_TRANSPORT_DECOMPOSITION_THEOREM_NOTE_2026-04-16.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
...
- **Note:** [`DM_NEUTRINO_ODD_CIRCULANT_CURRENT_STACK_ZERO_LAW_NOTE_2026-04-15.md`](../../docs/DM_NEUTRINO_ODD_CIRCULANT_CURRENT_STACK_ZERO_LAW_NOTE_2026-04-15.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
...
- **Note:** [`DM_NEUTRINO_ODD_MIXED_BRIDGE_EXTENSION_NOTE_2026-04-15.md`](../../docs/DM_NEUTRINO_ODD_MIXED_BRIDGE_EXTENSION_NOTE_2026-04-15.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
- **load-bearing step:** Assuming the odd-slot theorem, current-stack zero law, two-Higgs minimality theorem, and continuity sheet theorem, any future positive local DM activator must be a residual-Z2-odd non-additive mixed bridge with one real amplitude slot.  _(class `B`)_
- **chain closes:** False — The extension-class conclusion follows only after importing multiple upstream local theorems; the runner checks their textual presence and the one-dimensional odd slot rather than independently proving the upstream minimality stack.
- **rationale:** Issue: the minimal surviving extension class is conditional on four upstream results, including the current-stack zero law and two-Higgs minimality/continuity theorems, none of which are provided as retained one-hop dependencies in this audit bundle. Why this blocks: the runner validates that those notes state the needed premises and checks the one-amplitude odd class, but it does not independently prove the exhaustive 'any future positive activator must' conclusion. Repair target: make the four upstream theorems retained dependencies and add a proof/runner that the listed extension class exhausts the admissible positive local activators. Claim boundary until fixed: conditional extension-class bookkeeping for the supplied upstream stack, not an audited final positive-extension theorem.
- **open / conditional deps cited:**
  - `DM_NEUTRINO_ODD_CIRCULANT_Z2_SLOT_THEOREM_NOTE_2026-04-15.md`
  - `DM_NEUTRINO_ODD_CIRCULANT_CURRENT_STACK_ZERO_LAW_NOTE_2026-04-15.md`
  - `DM_NEUTRINO_TWO_HIGGS_MINIMALITY_THEOREM_NOTE_2026-04-15.md`
  - `DM_NEUTRINO_TWO_HIGGS_CONTINUITY_SHEET_THEOREM_NOTE_2026-04-15.md`
- **auditor confidence:** high
...
- **Note:** [`DM_NEUTRINO_SOURCE_SURFACE_PARITY_COMPATIBLE_OBSERVABLE_SELECTOR_THEOREM_NOTE_2026-04-17.md`](../../docs/DM_NEUTRINO_SOURCE_SURFACE_PARITY_COMPATIBLE_OBSERVABLE_SELECTOR_THEOREM_NOTE_2026-04-17.md)
- **current_status:** unknown
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
- **load-bearing step:** Restricting the observable-principle scalar generator to the exact parity-compatible diagonal family D = diag(A,B,B) makes the zero-source curvature proportional to delta^2 + q_+^2, whose chamber minimizer is delta_* = q_+* = sqrt(6)/3.  _(class `A`)_
- **chain closes:** False — The determinant, Hessian, and chamber-minimizer algebra closes on the selected local route, but that route imports the observable generator, active source family, parity-compatible diagonal baseline, and half-plane chamber from unaudited or conditional authorities.
- **rationale:** Issue: the selected point delta_* = q_+* = sqrt(6)/3 is derived only after choosing the observable-principle generator on the parity-compatible diagonal baseline route and the active half-plane chamber. Why this blocks: the runner verifies those formulas and the subcritical transport readout after the route restrictions are supplied, but the cited route inputs are unknown/conditional and are not recorded as retained ledger dependencies. Repair target: audit/retain the observable-principle, active-affine, active-half-plane, parity-compatible baseline, and curvature-boundary inputs, then derive or retain the route-independent right-sensitive current-bank selector law. Claim boundary until fixed: exact local parity-compatible diagonal-route selector algebra with transport-subcritical readout, not route-independent current-bank or full quantitative DM closure.
- **open / conditional deps cited:**
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-critical-sweep-20260430`  (codex-gpt-5; independence=fresh_context)
- **load-bearing step:** The scalar-singlet four-fermion coefficient on the retained Q_L block is asserted to be the same off-surface 1PI coefficient as the Rep-B H_unit form factor route.  _(class `B`)_
- **chain closes:** False — The local step cannot be promoted because direct upstream authorities remain unaudited, support/open/unknown, or terminal non-clean: G_BARE_TWO_WARD_REP_B_INDEPENDENCE_THEOREM_NOTE_2026-04-19.md, YT_WARD_IDENTITY_DERIVATION_THEOREM.md.
- **rationale:** Issue: The load-bearing step still imports unratified direct authority: G_BARE_TWO_WARD_REP_B_INDEPENDENCE_THEOREM_NOTE_2026-04-19.md, YT_WARD_IDENTITY_DERIVATION_THEOREM.md. Why this blocks: Under the restricted one-hop audit context, those authorities are not retained/audited-clean, so the critical claim cannot be ratified as closed even when its local algebra or runner checks pass. Repair target: ratify or repair the listed upstream theorem/bridge rows and rerun the local runner so it computes the disputed bridge rather than only checking consequences. Claim boundary until fixed: the note may be cited as conditional/supporting local structure, but no retained or promoted audit status propagates through this row.
- **open / conditional deps cited:**
...
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-connected-hierarchy`  (codex-current; independence=fresh_context)
- **load-bearing step:** From the exact susceptibility-flow theorem, beta_eff'(beta) = chi_L(beta) / chi_1plaq(beta_eff(beta)); differentiating once more and substituting the hierarchy gives the displayed beta_eff'' transport formula.  _(class `B`)_
- **chain closes:** False — The finite Wilson source-shift identity itself closes by the chain rule. The stronger beta_eff transport and onset conclusions import an exact susceptibility-flow theorem and onset coefficients that were not supplied as one-hop authorities.
- **rationale:** Issue: The bridge from the connected cumulant hierarchy to beta_eff closure uses the exact susceptibility-flow theorem and onset laws as unprovided premises. Why this blocks: the hierarchy identity establishes d_beta C_n = sum C_{n+1}, but it does not by itself establish beta_eff'(beta) = chi_L(beta) / chi_1plaq(beta_eff(beta)) or the stated onset coefficient. Repair target: provide one-hop audited authorities for the transport/onset inputs, or include a self-contained derivation and runner that constructs them. Claim boundary until fixed: the finite-volume uniform-source connected-cumulant hierarchy is exact; the beta_eff closure and onset consequences remain conditional.
- **auditor confidence:** high
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-critical-sweep-20260430`  (codex-gpt-5; independence=fresh_context)
- **load-bearing step:** On the accepted Wilson 3 spatial + 1 derived-time surface, the minimal distinct connected shell containing a marked plaquette is the six-face elementary cube boundary.  _(class `A`)_
- **chain closes:** False — The local step cannot be promoted because direct upstream authorities remain unaudited, support/open/unknown, or terminal non-clean: GAUGE_VACUUM_PLAQUETTE_MIXED_CUMULANT_AUDIT_NOTE.md.
- **rationale:** Issue: The load-bearing step still imports unratified direct authority: GAUGE_VACUUM_PLAQUETTE_MIXED_CUMULANT_AUDIT_NOTE.md. Why this blocks: Under the restricted one-hop audit context, those authorities are not retained/audited-clean, so the critical claim cannot be ratified as closed even when its local algebra or runner checks pass. Repair target: ratify or repair the listed upstream theorem/bridge rows and rerun the local runner so it computes the disputed bridge rather than only checking consequences. Claim boundary until fixed: the note may be cited as conditional/supporting local structure, but no retained or promoted audit status propagates through this row.
- **open / conditional deps cited:**
...
- **auditor:** `codex-third-auditor-20260430-gauge-local-env-factorization`  (codex-current; independence=fresh_context)
- **load-bearing step:** Hence after trivial-channel normalization the full mixed-kernel compression on the marked plaquette character sector is exactly D_beta^mix,norm chi_(p,q) = a_(p,q)(beta)^4 chi_(p,q).  _(class `A`)_
- **chain closes:** True — The note reduces the mixed kernel to independent normalized central convolutions: four marked links each contribute a_(p,q)(beta), while non-marked links see only the trivial irrep and normalize to a representation-independent scalar. On the stated Wilson 3+1 source surface, this gives exactly a_(p,q)(beta)^4 and leaves no mixed-kernel environment sequence.
- **rationale:** This is a narrow exact locality/factorization claim, not a closure of P(6) or the residual source-sector environment. The load-bearing step is standard convolution/character algebra on the stated Wilson mixed kernel, with no external comparator, tuned input, or definition-as-derivation. The runner currently reports THEOREM PASS=4 SUPPORT=3 FAIL=0, and the stored runner classification gives A=0, B=0, C=10, D=0; zero D checks do not make this decoration because the note compresses the remaining gap rather than expanding a parent algebraic corollary.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-perron-reduction`  (codex-current; independence=fresh_context)
- **load-bearing step:** For beta > 0, the kernel of T_(L_s,beta) is pointwise strictly positive.  _(class `C`)_
- **chain closes:** False — The Perron/Jacobi reduction follows from a strictly positive compact self-adjoint transfer kernel, but the note does not derive that exact Wilson gauge-invariant kernel positivity from listed inputs. The runner checks a finite truncated transfer proxy, not the exact transfer operator.
- **rationale:** Issue: the exact pointwise strict positivity and positivity-improving property of T_(L_s,beta) is asserted rather than derived from listed dependencies. Why this blocks: Perron-Jentzsch then closes the reduction, but only after the missing exact transfer-kernel theorem is accepted. Repair target: add or cite a retained theorem constructing the exact gauge-invariant Wilson transfer kernel and proving strict positivity/trace-class behavior, with a runner that checks the exact bridge rather than a proxy. Claim boundary until fixed: the note may safely state a conditional Perron/Jacobi reduction for any exact finite-volume Wilson transfer operator with the stated positivity and compactness properties.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_renaming~~
- **effective_status:** ~~audited_renaming~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-reduction-existence`  (codex-current; independence=fresh_context)
- **load-bearing step:** beta_eff,L(beta) := P_1plaq^{-1}(P_L(beta))  _(class `E`)_
- **chain closes:** False — The inverse-map construction is mathematically well-defined once P_1plaq is bijective, but the claimed reduction law is obtained by defining beta_eff,L as the inverse image of P_L rather than deriving an independent reduction map.
- **rationale:** Issue: the load-bearing step defines beta_eff,L(beta) := P_1plaq^{-1}(P_L(beta)) and then reads P_L = P_1plaq(beta_eff,L) as the reduction law. Why this blocks: monotonicity and range prove a unique coordinate on the one-plaquette curve, not an independently derived finite-Wilson-to-one-plaquette reduction law. Repair target: derive beta_eff,L from Wilson dynamics without using P_L itself as the defining input, and separately list/ratify the onset-coefficient dependencies. Claim boundary until fixed: a unique inverse-coordinate parameter exists for finite Wilson plaquette values in [0,1), with the runner's numerics as support.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_renaming~~
- **effective_status:** ~~audited_renaming~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-residual-env-id`  (codex-current; independence=fresh_context)
- **load-bearing step:** What remains is exactly the compression of the unmarked spatial Wilson environment on the marked source sector. Call this operator R_beta^env.  _(class `F`)_
- **chain closes:** False — The note identifies the stripped residual factor with the unmarked spatial environment compression, but the restricted inputs do not derive that identification. The runner constructs a diagonal positive R_env by formula and checks consistency afterward.
- **rationale:** Issue: the load-bearing equality between the stripped residual source-sector factor and the compressed unmarked spatial Wilson environment is asserted as an identification, not derived from provided authorities. Why this blocks: the theorem's main content is exactly that physical/operator identification, and the runner hard-codes an admissible environment-shaped diagonal factor instead of computing the actual compression. Repair target: provide the upstream factorization/compression theorem and a runner that constructs R_beta^env from the unmarked Wilson environment before checking its properties. Claim boundary until fixed: it is safe to say that after choosing such an R_beta^env the displayed factorized operator has the checked algebraic properties.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_failed~~
- **effective_status:** ~~audited_failed~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-source-sector-matrix`  (codex-current; independence=fresh_context)
- **load-bearing step:** Because the stripped Wilson source-sector compression C_beta is positive, self-adjoint and central, Peter-Weyl implies C_beta chi_(p,q) = kappa_(p,q)(beta) chi_(p,q).  _(class `A`)_
- **chain closes:** False — The note does not establish that the residual compressed Wilson kernel is character-diagonal; positivity, self-adjointness, and simultaneous conjugation invariance are not enough to force diagonality in the SU(3) character basis.
- **rationale:** Issue: Theorem 2 upgrades real positive simultaneous-conjugation invariance of the stripped residual kernel to character-basis diagonality. Why this blocks: a positive self-adjoint operator on class functions can still mix characters unless a convolution/commuting-operator structure or the actual Wilson residual coefficients are derived. Repair target: prove C_beta is the required central convolution/commuting operator or compute the Wilson residual D_6 from the kernel with a runner that constructs it rather than injecting kappa. Claim boundary until fixed: the runner supports only a finite algebraic witness for a chosen positive diagonal kappa, not the exact Wilson beta=6 diagonal residual factorization.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_renaming~~
- **effective_status:** ~~audited_renaming~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-spatial-env-character`  (codex-current; independence=fresh_context)
...
- **chain closes:** False — The note defines `rho_(p,q)` from the boundary class function and then identifies the residual operator's diagonal data with the same `rho_(p,q)` without deriving that equality from provided inputs.
- **rationale:** Issue: the load-bearing equality identifies the residual environment operator with convolution by the newly defined boundary character measure by reusing the same coefficient symbol. Why this blocks: centrality and a character expansion of `Z_beta^env` do not by themselves prove that the residual compressed Wilson environment has those exact eigenvalues. Repair target: provide a theorem or runner that derives the residual operator kernel/eigenvalues from the unmarked spatial Wilson integral rather than assigning `rho_env`. Claim boundary until fixed: the note may define a normalized central boundary class function and state that, if its coefficients equal the residual operator eigenvalues, it represents `R_beta^env`.
- **auditor confidence:** high
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-critical-sweep-20260430`  (codex-gpt-5; independence=fresh_context)
- **load-bearing step:** The environment boundary class function is exactly a boundary amplitude of the positive spatial transfer operator, while the beta=6 Perron/boundary data remain to be supplied by the tensor-transfer theorem.  _(class `A`)_
- **chain closes:** False — The local step cannot be promoted because direct upstream authorities remain unaudited, support/open/unknown, or terminal non-clean: GAUGE_VACUUM_PLAQUETTE_SPATIAL_ENVIRONMENT_TENSOR_TRANSFER_THEOREM_NOTE.md.
- **rationale:** Issue: The load-bearing step still imports unratified direct authority: GAUGE_VACUUM_PLAQUETTE_SPATIAL_ENVIRONMENT_TENSOR_TRANSFER_THEOREM_NOTE.md. Why this blocks: Under the restricted one-hop audit context, those authorities are not retained/audited-clean, so the critical claim cannot be ratified as closed even when its local algebra or runner checks pass. Repair target: ratify or repair the listed upstream theorem/bridge rows and rerun the local runner so it computes the disputed bridge rather than only checking consequences. Claim boundary until fixed: the note may be cited as conditional/supporting local structure, but no retained or promoted audit status propagates through this row.
- **open / conditional deps cited:**
...
- **rationale:** The claim is an exact finite-surface generating-object theorem, not an empirical plaquette prediction or a beta = 6 closure claim. The load-bearing step is standard pushforward/Laplace-transform algebra over a compact source space, followed by Hausdorff determinacy on [-1,1]. The runner is mostly structural support rather than a proof engine, but the source-note proof itself is elementary and closes without hidden physical identification, tuned comparator matching, or dependency import.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-susceptibility-flow`  (codex-current; independence=fresh_context)
- **load-bearing step:** The previously closed exact implicit reduction law P_L(beta) = P_1plaq(beta_eff,L(beta)) may now be differentiated exactly to obtain chi_L(beta) = chi_1plaq(beta_eff,L(beta)) * beta_eff,L'(beta).  _(class `A`)_
- **chain closes:** False — The differentiation step is valid algebra/calculus if the exact implicit reduction law and upstream onset coefficients are available, but those inputs are not supplied as one-hop dependencies in the restricted audit context.
- **rationale:** Issue: the flow theorem imports the previously closed implicit reduction law and the mixed-cumulant onset theorem without supplied dependency notes. Why this blocks: the note's main equation follows conditionally from those upstream facts, but the audit chain as provided cannot verify that the imported equality and coefficients are ratified inputs rather than hidden premises. Repair target: list and provide the reduction-existence theorem and mixed-cumulant theorem as one-hop dependencies with clean/ratified status, or restate this note explicitly as a conditional calculus corollary. Claim boundary until fixed: the note supports the conditional identity beta_eff' = chi_L / chi_1plaq given the implicit law, but not an independently closed nonperturbative flow theorem.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-gauge-transfer-character`  (codex-current; independence=fresh_context)
- **load-bearing step:** Because the Wilson weight is real and positive, this kernel is pointwise positive. By time-reversal / Haar invariance it is symmetric in U,U'. Hence it defines a positive self-adjoint transfer operator T_(L_s,beta).  _(class `A`)_
- **chain closes:** False — The SU(3) character recurrence closes, but the positive transfer-state/operator step is not established by pointwise positivity plus symmetry alone. The runner checks character algebra and slice counts, not reflection positivity or positivity of the transfer operator/state.
- **rationale:** Issue: The note uses an insufficient implication from a pointwise positive symmetric kernel to a positive self-adjoint transfer operator and positive transfer state. Why this blocks: the claimed spectral measure in the transfer state requires that positive state/operator construction, not just the local character recurrence. Repair target: add a retained finite Wilson transfer-matrix/reflection-positivity theorem, or a direct construction of the positive transfer state for the marked plaquette algebra, with a runner that checks that bridge. Claim boundary until fixed: the exact local SU(3) plaquette character recurrence and self-adjoint multiplication operator J are supported; the full transfer-state realization remains conditional.
- **auditor confidence:** high
...
- **audit_status:** ~~audited_clean~~
- **effective_status:** **retained**  (reason: `self`)
- **auditor:** `codex-third-auditor-20260430-graph-first-selector`  (codex-current; independence=fresh_context)
- **load-bearing step:** V_sel(phi) = Tr H(phi)^4 - (1/8)(Tr H(phi)^2)^2 = 32 sum_{i<j} phi_i^2 phi_j^2, which after p_i = phi_i^2 / sum_j phi_j^2 gives the pairwise-overlap selector F(p) with axis minima.  _(class `A`)_
- **chain closes:** True — On the stated canonical graph-shift surface, the S_i are commuting involutive cube-shift matrices, so the trace identities and quartic selector follow by direct algebra. The normalized F(p) is nonnegative and vanishes exactly at the three simplex vertices, giving the stated residual Z_2 stabilizers.
- **rationale:** The note is explicitly bounded to deriving the selector on the canonical graph-shift surface and does not claim downstream SU(3) or abelian-factor closure. The load-bearing step is an algebraic closure over the constructed graph shifts, not a definition, renaming, tuned numerical match, or external comparator. The runner returns PASS=63 FAIL=0 and checks algebraic properties, trace formulas, normalization behavior, and the axis-minimum structure. Residual physical identification of the selected axis belongs to downstream integration, outside this note's bounded claim.
- **auditor confidence:** high
...
- **Note:** [`KOIDE_Z3_SCALAR_POTENTIAL_SUPPORT_NOTE_2026-04-19.md`](../../docs/KOIDE_Z3_SCALAR_POTENTIAL_SUPPORT_NOTE_2026-04-19.md)
- **current_status:** support
- **audit_status:** ~~audited_conditional~~
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
- **load-bearing step:** On the selected slice K_Z3^sel(m) = K_frozen + m T_m, the Clifford involution T_m^2 = I_3 fixes Tr(T_m^2)=3 and Tr(T_m^3)=1, giving V(m)=V0+(c1+c2/2)m+(3/2)m^2+(1/6)m^3.  _(class `A`)_
- **chain closes:** False — The trace identities close as selected-slice algebra, but the selected-slice K_Z3 construction is imported from conditional upstream notes and this row has no runner verifying the coefficients end to end.
- **rationale:** Issue: the scalar potential is derived only after importing the selected-slice frozen-bank/K_Z3 machinery and does not select the physical m_* point. Why this blocks: the note honestly records that V_eff's minimum misses m_* and that the PDG/transport observations are checks only, so it cannot support a framework-derived charged-lepton tower or selector law. Repair target: audit/retain the selected-slice frozen-bank and Z3 doublet-block construction, add a runner for the trace/potential coefficients, and derive the microscopic condition selecting m_* if the claim is to be promoted. Claim boundary until fixed: support-level selected-slice scalar-potential algebra with an explicit gap to the physical selected point.
- **open / conditional deps cited:**
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
- **load-bearing step:** Under the stated first-order coframe/worldtube carrier hypotheses, the runner verifies the 2^4 Boolean event-cell decomposition, selects the first homogeneous packet P_1=P_A, rejects the rank-equal Hodge-dual P_3 by first-order locality, and computes Tr((I_16/16)P_A)=1/4 while preserving non-closure flags.  _(class `B`)_
- **chain closes:** False — The combinatorial first-order carrier theorem is verified as support, but the physical identification of gravitational boundary/action density with that first-order coframe carrier remains an explicit bridge premise and the note does not close the Planck minimal stack or SI constants.
- **rationale:** Issue: the support theorem is internally correct on its stated coframe-carrier surface, but it is not a standalone Planck-scale derivation. Why this blocks: P_A is selected only after assuming first-order locality, axis additivity, coframe-slot symmetry, and unit primitive response; the runner explicitly confirms PLANCK_MINIMAL_STACK_CLOSURE=FALSE and names the residual boundary/action-density theorem target. Repair target: register and audit the physical theorem identifying gravitational boundary/action density with the first-order coframe/worldtube carrier, plus the finite-boundary extension and source-unit normalization dependencies if promoting the Planck lane. Claim boundary until fixed: positive support that first-order coframe carrier equals P_A and gives c_cell=1/4, not a minimal-stack derivation of a^{-1}=M_Pl or SI Planck constants.
- **open / conditional deps cited:**
...
- **audit_status:** ~~audited_numerical_match~~
- **effective_status:** ~~audited_numerical_match~~  (reason: `self`)
- **auditor:** `codex-fresh-context-20260430-08-quark-cp`  (codex-current; independence=fresh_context)
- **load-bearing step:** On the bounded extended surface there is numerical full quark closure for mass ratios, CKM magnitudes, J, and arg det(M_u M_d)=0 after solving large complex carriers xi_u and xi_d.  _(class `G`)_
...
- **audit_status:** ~~audited_numerical_match~~
- **effective_status:** ~~audited_numerical_match~~  (reason: `self`)
- **auditor:** `codex-fresh-context-20260430-09-quark-ray`  (codex-current; independence=fresh_context)
- **load-bearing step:** Adding one shared phase closes the full quark package numerically after solving a_u, a_d, and phi_shared on the fixed projector ray.  _(class `G`)_
- **chain closes:** False — The runner reproduces PASS=8 FAIL=0 for an optimized fit, but the amplitudes and shared phase are solved/tuned, the source status is bounded, and the one-hop dependency is bounded.
- **rationale:** Issue: The load-bearing closure is obtained by optimizing two real sector amplitudes and one shared phase on a fixed ray, while the upstream carrier-completion dependency remains bounded and the parameters are not retained-derived. Why this blocks: A tuned numerical existence fit cannot be treated as a closed projector theorem; the runner verifies the fitted ansatz after the free parameters are chosen. Repair target: Provide a retained derivation of a_u, a_d, and phi_shared plus a retained upstream base/projector-carrier theorem, or keep the result as bounded numerical support. Claim boundary until fixed: Runner-verified bounded support that a fixed projector-ray ansatz with two amplitudes and one shared phase matches the quoted checks within tolerance.
- **open / conditional deps cited:**
  - `QUARK_CP_CARRIER_COMPLETION_NOTE_2026-04-18.md`
- **auditor confidence:** 0.86
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-critical-sweep-20260430`  (codex-gpt-5; independence=fresh_context)
- **load-bearing step:** R_base = (3/5)[C2(3) dim(adj3)+C2(2) dim(adj2)]/[C2(2) dim(adj2)] = 31/9.  _(class `A`)_
- **chain closes:** False — The local step cannot be promoted because direct upstream authorities remain unaudited, support/open/unknown, or terminal non-clean: HYPERCHARGE_IDENTIFICATION_NOTE.md, NATIVE_GAUGE_CLOSURE_NOTE.md.
- **rationale:** Issue: The load-bearing step still imports unratified direct authority: HYPERCHARGE_IDENTIFICATION_NOTE.md, NATIVE_GAUGE_CLOSURE_NOTE.md. Why this blocks: Under the restricted one-hop audit context, those authorities are not retained/audited-clean, so the critical claim cannot be ratified as closed even when its local algebra or runner checks pass. Repair target: ratify or repair the listed upstream theorem/bridge rows and rerun the local runner so it computes the disputed bridge rather than only checking consequences. Claim boundary until fixed: the note may be cited as conditional/supporting local structure, but no retained or promoted audit status propagates through this row.
- **open / conditional deps cited:**
...
- **effective_status:** ~~audited_conditional~~  (reason: `self`)
- **auditor:** `codex-audit-loop-round-2`  (codex-gpt-5; independence=cross_family)
- **load-bearing step:** The unregistered capstone runner verifies a finite overlap-covariance/action-stationarity patching calculation for K_GR(D)=H_D otimes Lambda_R and checks by text search that positive-background, Lorentzian, global-atlas, and PL S3 x R authority notes exist.  _(class `B`)_
- **chain closes:** False — The local patching algebra passes, but the claimed global GR closure depends on several upstream route notes and a non-hermetic runner that reads hard-coded files outside the current worktree; the ledger row records no one-hop dependencies or runner path.
- **rationale:** Issue: the capstone claim is broader than the auditable artifact. Why this blocks: `scripts/frontier_universal_gr_discrete_global_closure.py` passes 5/5, but it imports authority text from `/Users/jonreilly/Projects/Physics` rather than the audited worktree and only checks substring presence plus a finite chart-overlap algebra toy; it does not independently prove the positive-background, Lorentzian-signature, global-atlas, or PL S3 x R inputs. Repair target: register the runner in the ledger, make it repo-root relative, add audited one-hop dependencies for each route component, and scope the theorem to discrete-global stationary action patching unless/until continuum GR interpretation is separately proved. Claim boundary until fixed: conditional capstone over supplied direct-universal GR route notes, not a standalone audited full-GR closure theorem.
- **open / conditional deps cited:**
  - `scripts/frontier_universal_gr_discrete_global_closure.py hard-coded external ROOT`
