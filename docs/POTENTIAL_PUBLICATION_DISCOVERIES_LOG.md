...
| D24 | Dirac-sea boundary-law probe: on the 2D periodic staggered lattice, entanglement entropy and Schmidt rank from the filled negative-energy sector scale more cleanly with boundary size than with region volume in both the free and self-gravitating cases | staggered many-body boundary law | `bounded-retained` | Strong many-body-style boundary-law result, with gravity preserving the boundary-law preference while shifting the fitted coefficient; valuable for future holography triage without overclaiming AdS/CFT | [`HOLOGRAPHIC_PROBE_NOTE_2026-04-11.md`](HOLOGRAPHIC_PROBE_NOTE_2026-04-11.md) |
| D25 | Retarded pulse memory on a ring: a transient field pulse produces a small but repeatable permanent post-pulse separation shift with weak-amplitude linear scaling and strong-pulse nonlinearity | staggered retarded field memory | `bounded-retained` | Clean bounded positive signal with exact zero-drift control; worth preserving as a toy-model memory-style effect while staying short of a GR-equivalence claim | [`GRAVITATIONAL_MEMORY_NOTE_2026-04-11.md`](GRAVITATIONAL_MEMORY_NOTE_2026-04-11.md) |
| D26 | BMV-like branch-mediated entanglement: on a fixed 2D staggered lattice with an externally imposed geometry/source branch, the coherent branch superposition entangles two separated particles beyond the corresponding classical mixture | staggered branch-mediated entanglement | `bounded-retained` | Strong positive toy-model entanglement result with exact norm conservation, useful as a bridge toward more realistic two-particle geometry-branch protocols | [`BMV_ENTANGLEMENT_NOTE_2026-04-11.md`](BMV_ENTANGLEMENT_NOTE_2026-04-11.md) |
...
| D28 | Three-body branch-mediated entanglement: on a fixed 2D staggered lattice with an externally imposed two-branch source/field protocol, three separated probes develop strong GHZ-like tripartite entanglement with peak `tau_3 = 0.848522` | staggered tripartite branch entanglement | `bounded-retained` | Clean bounded extension of the two-body branch-entanglement story; useful for paper triage without overclaiming a multipartite BMV witness | [`BMV_THREEBODY_NOTE_2026-04-11.md`](BMV_THREEBODY_NOTE_2026-04-11.md) |
