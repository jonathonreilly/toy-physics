...
| D29 | Open-boundary Wilson two-orbital mutual attraction: the two-body channel survives on larger open 3D Wilson lattices with clean `shared` vs `self_only` separation, but the fitted law is non-Newtonian | Wilson two-body | `bounded-retained` | First genuinely clean two-orbital mutual-attraction channel in the repo that survives removal of the periodic small-box sign flip, while also showing that the emergent law is not yet Newtonian | [`WILSON_TWO_BODY_OPEN_NOTE_2026-04-11.md`](WILSON_TWO_BODY_OPEN_NOTE_2026-04-11.md) |
