...
- [KOIDE_A1_FRACTIONAL_TOPOLOGY_NO_GO_SYNTHESIS_NOTE_2026-04-24.md](KOIDE_A1_FRACTIONAL_TOPOLOGY_NO_GO_SYNTHESIS_NOTE_2026-04-24.md)
  ...
  live authority surface; identifies the open primitive this note does
  **not** discharge.
- [KOIDE_A1_RADIAN_BRIDGE_IRREDUCIBILITY_AUDIT_NOTE_2026-04-24.md](KOIDE_A1_RADIAN_BRIDGE_IRREDUCIBILITY_AUDIT_NOTE_2026-04-24.md)
  — parent audit on the radian-bridge irreducibility question.
- [KOIDE_BERRY_PHASE_THEOREM_NOTE_2026-04-19.md](KOIDE_BERRY_PHASE_THEOREM_NOTE_2026-04-19.md)
  — actual-route Berry-phase theorem (support-grade); the load-bearing
  physical identification any future closure would need to promote.
...
## 0. Status correction (review-driven)

A prior version of this note framed its content as "closure of the
radian-bridge / `P_A1` residual on the Brannen observable". The original
review of branch `claude/flamboyant-hodgkin-e16786` (verdict: not
approved as submitted; downgrade-only path landable) flagged the
overclaim, and that review's findings are integrated into this rewrite
(this §0 records the status correction; §6 records the resubmission
target). Specifically:
...
note for the markdown-linked dependency surface. The original review
(branch `claude/flamboyant-hodgkin-e16786`, recoverable via the
`archive/claude__flamboyant-hodgkin-e16786-2026-04-28` tag pushed
during the 2026-04-27 cleanup) is the source of the §0 status
correction and the §6 resubmission-target list; its findings are
integrated into the body of this note rather than carried as a
separate file.
