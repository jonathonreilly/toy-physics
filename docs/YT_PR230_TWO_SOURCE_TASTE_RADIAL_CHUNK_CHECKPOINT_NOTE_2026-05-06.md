...
python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 3 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk003_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 4 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk004_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 5 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk005_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 6 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk006_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 7 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk007_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 8 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk008_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 9 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk009_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 10 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk010_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 11 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk011_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 12 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk012_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 17 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk017_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 18 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk018_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 19 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk019_checkpoint_2026-05-06.json
...
python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 23 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk023_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 24 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk024_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 25 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk025_checkpoint_2026-05-06.json

python3 scripts/frontier_yt_pr230_two_source_taste_radial_chunk_checkpoint.py \
  --chunk-index 26 \
  --output outputs/yt_pr230_two_source_taste_radial_chunk026_checkpoint_2026-05-06.json
```

Expected pending summary while chunk001 is active and not yet complete:
`PASS=2 FAIL=0`.

Completed chunks001-026 now pass completed mode with `PASS=15 FAIL=0`
each.  Chunks025-026 add the same selected-mass-only FH/LSZ/source-row
metadata and `numba_gauge_seed_v1` seed-control surface as the prior ready
set, advancing the combiner-ready packet to `ready=26/63`.
Chunks027-028 are active under the row-wave supervisor's two-worker cap and
