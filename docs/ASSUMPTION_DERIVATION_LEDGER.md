...
| Continuum / asymptotic bridge | **open but stronger than before** | There is now real asymptotic evidence in 3D/4D modular lanes, including large-`N` decoherence sweeps and a branch-side 3D density study suggesting a convergent mass exponent. What is still missing is a clean continuum derivation and a stricter fixed-mass distance-law bridge. |
