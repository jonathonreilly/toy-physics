# Koide One-Scalar Obstruction Triangulation Theorem — Candidate Retention Note

**Date:** 2026-04-18
**Status:** CANDIDATE THEOREM PROMOTION — structural lower-bound theorem on the
charged-lepton Koide promotion gap, awaiting review for retention
**Target:** retire the open "scalar-selector" conditional of the charged-lepton
Koide lane as a *structurally derived* one-scalar gap, not a
