# V=1 SU(3) Wilson Picard-Fuchs ODE Bounded Synthesis

**Date:** 2026-05-06
**Claim type:** bounded_theorem
**Status:** bounded support theorem; audit status is set only by the
independent audit lane. This note consolidates the runner artifacts
without self-promoting status.
**Primary runner:**
...
An independent audit can evaluate this consolidated theorem from:

1. The PR #541 ODE statement, with the documented bounded scope:
...
The scoped claim remains bounded: V=1 single-plaquette SU(3)
Wilson-integral Picard-Fuchs ODE and `β = 6` logarithmic-derivative value,
excluding any thermodynamic-limit, multi-plaquette, higher-irrep, or
bridge promotion.
...
```yaml
claim_id: plaquette_v1_picard_fuchs_ode_bounded_synthesis_note_2026-05-06
note_path: docs/PLAQUETTE_V1_PICARD_FUCHS_ODE_BOUNDED_SYNTHESIS_NOTE_2026-05-06.md
