...
**Status:** **support-grade** — this note does **not** close `Q_l = 2/3`.
It articulates the OP-uniqueness Path (a) interpretation precisely and
addresses each of Codex's V3 review findings. The closure remains
conditional on a separate theorem-grade authority proving the
OP-uniqueness → scalar source-domain exclusivity bridge for ALL
scalar-observable backgrounds (not just source perturbations), including
Z exclusion.
**Runner:** `scripts/frontier_koide_q_op_uniqueness_source_domain_support.py`
**Supersedes:** the V3 closure-claim framing on the
`koide-q-closure-via-op-uniqueness` branch (commit `9df758bc`,
recoverable via the `archive/koide-q-closure-via-op-uniqueness-2026-04-28`
tag pushed during the 2026-04-27 cleanup). V3 was not landed on `main`;
this V4 note supersedes the snapshot version in
`archive_unlanded/koide-q-closure-via-op-uniqueness/`.

**Cited authorities (one-hop deps):**
- [OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md](OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md)
  — OP, retained. The runner audits this file from disk for the
  "unique additive CPT-even" clause + the "local projectors P_x"
  Theorem 2 source-domain clause (§1).
- [KOIDE_Q_ONSITE_SOURCE_DOMAIN_NO_GO_SYNTHESIS_NOTE_2026-04-25.md](KOIDE_Q_ONSITE_SOURCE_DOMAIN_NO_GO_SYNTHESIS_NOTE_2026-04-25.md)
  — ONSITE, retained. The runner audits this file from disk for the
  "Z is not an onsite diagonal source function" no-go (§2).
- [KOIDE_Q_BACKGROUND_ZERO_Z_ERASURE_CRITERION_THEOREM_NOTE_2026-04-25.md](KOIDE_Q_BACKGROUND_ZERO_Z_ERASURE_CRITERION_THEOREM_NOTE_2026-04-25.md)
  — CRIT, retained. The runner audits this file from disk for the
  `K = 0 ⇔ z = 0 ⇔ Q = 2/3` criterion (§3).
- [KOIDE_Q_SOURCE_DOMAIN_CANONICAL_DESCENT_THEOREM_NOTE_2026-04-25.md](KOIDE_Q_SOURCE_DOMAIN_CANONICAL_DESCENT_THEOREM_NOTE_2026-04-25.md)
  — CD, retained. Canonical-descent context for the open
  source-perturbations-vs-backgrounds residual (§5).
- [KOIDE_Q_SO2_PHASE_ERASURE_SUPPORT_NOTE_2026-04-25.md](KOIDE_Q_SO2_PHASE_ERASURE_SUPPORT_NOTE_2026-04-25.md)
  — SO2, support. Accepted V1 Q-SO(2) algebra as upstream support.

The Codex-branch boundary note
(`KOIDE_Q_OP_LOCAL_DESCENT_PROTOCOL_BOUNDARY_NOTE_2026-04-25.md`) and
the V3 closure note are referenced only as recovery-tag history; neither
exists on `main`, so they are not citation-graph deps of this V4
support landing.
...
Codex's review of V3 (verdict: NOT READY to land as retained closure;
the review record is on the recovery-tag history of the
`koide-q-closure-via-op-uniqueness` branch, recoverable via
`archive/koide-q-closure-via-op-uniqueness-2026-04-28`). Three specific
findings:
...
See the **Cited authorities (one-hop deps)** block at the top of this
note for the markdown-linked dependency surface (the citation graph
builder requires `[text](path.md)` form to extract deps).

Recovery-tag history (not on `main`, recoverable via the listed tags):
...
- Codex's V2 boundary note (`KOIDE_Q_OP_LOCAL_DESCENT_PROTOCOL_BOUNDARY_NOTE_2026-04-25.md`,
  ...
  via the corresponding `archive/...` tag.
