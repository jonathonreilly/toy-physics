...
(Companion subtheorems are referenced by backticked file name rather than
markdown link — they CONSUME this note's `lambda` and `A` identities, so
the citation graph direction is *companion → wolfenstein*, downstream
not upstream. Markdown links here would create wolfenstein → companion
edges and cycles.)
...
| CKM CP radius and phase identities | `CKM_CP_PHASE_STRUCTURAL_IDENTITY_THEOREM_NOTE_2026-04-24.md` (downstream companion; consumes wolfenstein) |
...
- [`CKM_ATLAS_AXIOM_CLOSURE_NOTE.md`](CKM_ATLAS_AXIOM_CLOSURE_NOTE.md)
  - parent CKM package.
- `CKM_CP_PHASE_STRUCTURAL_IDENTITY_THEOREM_NOTE_2026-04-24.md`
  - companion `rho`, `eta`, phase, and `J` identities (downstream of this note).
- `CKM_FIRST_ROW_MAGNITUDES_THEOREM_NOTE_2026-04-24.md`
  - companion first-row atlas-leading magnitude identities (downstream of this note).
- `CKM_THIRD_ROW_MAGNITUDES_THEOREM_NOTE_2026-04-24.md`
  - companion third-row atlas-leading magnitude identities (downstream of this note).
