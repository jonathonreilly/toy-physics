...
recovered lift, and the shift quotient; the split-2 reduction chain supplies
the low-slack box, the lower-repair constraint, and the upper-`m` ridge that
this upper-face cap-profile collapse refines.
