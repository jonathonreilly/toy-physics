...
**Date:** 2026-04-26
**Status:** retained no-go theorem on `main`-compatible surface, landed
branch-locally on `frontier/hubble-h0-20260426` for later
review-and-integration. Bounds the closure space for Lane 5: any retained
derivation of `H_0` (or equivalently `L = Omega_Lambda`) requires at least
one structural premise beyond the
...
The routes already listed in `ROUTE_PORTFOLIO.md` (R1-R8) all map into
this taxonomy:
...
- `ROUTE_PORTFOLIO.md` (workstream pack) — routes R1-R8.
