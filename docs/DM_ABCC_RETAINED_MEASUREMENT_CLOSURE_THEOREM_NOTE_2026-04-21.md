...
`C_base`. This closes A-BCC on the review surface. What remains open on the
DM lane is the finer right-sensitive microscopic selector law for the
...
blocked by branch choice. The only live DM blocker is now the finer
right-sensitive microscopic selector law.
...
The first item is still the live DM flagship blocker. The second item is now
a closure-grade boundary statement rather than a review-surface blocker.

---

## 4. Review-surface consequence

The DM flagship gate is no longer:
...
also closed on the retained measurement surface, the only live DM burden is
the finer right-sensitive microscopic point-selection law.
