...
The audit verdict is terminal under
`effective_status_reason = terminal_audit`. This is a **leaf
...
| Live retained axiom-set anchor | [`MINIMAL_AXIOMS_2026-05-03.md`](MINIMAL_AXIOMS_2026-05-03.md) | `unaudited` / `meta` | retained-axiom anchor for the dm_wilson direct-descendant lane |
...
this row remains `audited_conditional` and the safe read is the
runner-replay-verified structural no-go (no single raw or normalized
