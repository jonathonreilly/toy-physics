...
1. **Current flagship paper review**
...
Do **not** start with old lane summaries, old flagship notes, or raw chronology.

## If You Need Repo Archaeology

Then use the older repo-organization layer:
...
5. [CANONICAL_HARNESS_INDEX.md](CANONICAL_HARNESS_INDEX.md)

Those documents are still useful, but they are **not** the right first stop for
the current `Cl(3)` / `Z^3` paper surface.
...
- do not assume the current repo center of gravity is the old staggered /
  parity-coupling frontier
...
1. [CURRENT_FLAGSHIP_ENTRYPOINT_2026-04-14.md](CURRENT_FLAGSHIP_ENTRYPOINT_2026-04-14.md)
2. then the curated publication package on branch `codex/publication-prep`
