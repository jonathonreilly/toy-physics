...
1. current flagship package review
2. repo archaeology / historical lane review

Use the right one.

## If You Are Reviewing The Current Package
...
3. [publication/ci3_z3/EXTERNAL_REVIEWER_GUIDE.md](publication/ci3_z3/EXTERNAL_REVIEWER_GUIDE.md)
...
If you are specifically reviewing the current bounded EW / `y_t` / Higgs
package after that, use this local authority stack:
...
## If You Need The Axiom / Framework Surface

Use:

1. [CI3_Z3_PUBLICATION_STATE_2026-04-12.md](CI3_Z3_PUBLICATION_STATE_2026-04-12.md)
2. [MINIMAL_AXIOMS_2026-04-11.md](MINIMAL_AXIOMS_2026-04-11.md)
3. [ASSUMPTION_DERIVATION_LEDGER.md](ASSUMPTION_DERIVATION_LEDGER.md)
4. [CANONICAL_HARNESS_INDEX.md](CANONICAL_HARNESS_INDEX.md)

## If You Need Repo Archaeology

Then use the historical organization layer:

1. [repo/LANE_STATUS_BOARD.md](repo/LANE_STATUS_BOARD.md)
2. [repo/REPO_ORGANIZATION.md](repo/REPO_ORGANIZATION.md)
3. [repo/ROOT_FILE_GUIDE.md](repo/ROOT_FILE_GUIDE.md)
4. [lanes/README.md](lanes/README.md)
