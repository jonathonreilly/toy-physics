...
- [`docs/DM_NEUTRINO_ATMOSPHERIC_SCALE_THEOREM_NOTE_2026-04-15.md`](DM_NEUTRINO_ATMOSPHERIC_SCALE_THEOREM_NOTE_2026-04-15.md) — R1, R2
- [`docs/NEUTRINO_MASS_DERIVED_NOTE.md`](NEUTRINO_MASS_DERIVED_NOTE.md) — R3 + open-lane status
- [`docs/NEUTRINO_MAJORANA_RETAINED_LANE_PACKET_2026-04-16.md`](NEUTRINO_MAJORANA_RETAINED_LANE_PACKET_2026-04-16.md) — Majorana
  lane negative closure
- [`docs/NEUTRINO_MAJORANA_ADJACENT_SINGLET_PLACEMENT_THEOREM_NOTE.md`](NEUTRINO_MAJORANA_ADJACENT_SINGLET_PLACEMENT_THEOREM_NOTE.md) —
