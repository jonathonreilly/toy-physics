...
| RouteD_Form | `V(Φ) = [e_1² − 6 e_2]²` is the candidate Newton-Girard form for A1 | route-status note: [`KOIDE_A1_DERIVATION_STATUS_NOTE.md`](KOIDE_A1_DERIVATION_STATUS_NOTE.md) §"Route D" |
