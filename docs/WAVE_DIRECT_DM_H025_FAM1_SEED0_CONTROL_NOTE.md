...
- `docs/WAVE_DIRECT_DM_H025_SEED0_CROSSFAMILY_NOTE.md` (DOWNSTREAM
  cross-family compressor; backticked to avoid length-2 cycle —
  citation graph direction is *crossfamily → this_note*)
