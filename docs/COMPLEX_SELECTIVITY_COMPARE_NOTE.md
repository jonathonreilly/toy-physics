...
bounded selectivity split." The audit verdict is terminal under
`effective_status_reason = terminal_audit`. The claim-scope is
...
| Live retained axiom-set anchor | [`MINIMAL_AXIOMS_2026-05-03.md`](MINIMAL_AXIOMS_2026-05-03.md) | `unaudited` / `meta` | retained-axiom anchor for the path-sum architecture |
...
the partial comparison over the supplied retained authorities.
