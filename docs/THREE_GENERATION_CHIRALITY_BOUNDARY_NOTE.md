...
4. The full-framework chirality claim is carried by anomaly-forced time and
...
3. A full flavor-hierarchy or mass-spectrum closure from the generation note
   alone.
...
3. [ONE_GENERATION_MATTER_CLOSURE_NOTE.md](./ONE_GENERATION_MATTER_CLOSURE_NOTE.md)
   carries the full-framework chirality / right-handed completion claim.
4. [ANOMALY_FORCES_TIME_THEOREM.md](./ANOMALY_FORCES_TIME_THEOREM.md)
...
> `Z^3`; and the triplet sectors are therefore retained as physical species
> structure rather than taste artifacts. Chirality is not claimed on the pure
> spatial surface alone, but in the full framework through anomaly-forced time
> and the one-generation matter-closure theorem.
