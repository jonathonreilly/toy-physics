...
The completed chunks001-026 provide finite same-ensemble source/complement
...
chunks001-026 the row audit is clean, all finite inverse rows are finite with
...
`ready=26/63` packet, not strict neutral-kernel `A/B/C` pole rows, not
