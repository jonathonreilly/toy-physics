...
The completed chunks001-016 provide finite same-ensemble source/complement
...
chunks001-016 the row audit is clean, all finite inverse rows are finite with
...
`ready=16/63` packet, not strict neutral-kernel `A/B/C` pole rows, not
