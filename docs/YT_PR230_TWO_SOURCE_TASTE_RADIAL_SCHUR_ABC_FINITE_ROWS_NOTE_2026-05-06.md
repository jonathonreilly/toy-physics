...
The completed chunks001-024 provide finite same-ensemble source/complement
...
chunks001-024 the row audit is clean, all finite inverse rows are finite with
...
`ready=24/63` packet, not strict neutral-kernel `A/B/C` pole rows, not
