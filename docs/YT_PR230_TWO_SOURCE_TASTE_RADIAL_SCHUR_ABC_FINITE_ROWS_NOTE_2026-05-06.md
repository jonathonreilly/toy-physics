...
The completed chunks001-022 provide finite same-ensemble source/complement
...
chunks001-022 the row audit is clean, all finite inverse rows are finite with
...
`ready=22/63` packet, not strict neutral-kernel `A/B/C` pole rows, not
