# PR230 Higher-Shell Chunks057-058 Launch Checkpoint

**Status:** run-control support / higher-shell Schur scalar-LSZ chunks057-058
launched; completed higher-shell support prefix remains 56/63; no closure
...
```yaml
actual_current_surface_status: run-control support / higher-shell Schur scalar-LSZ chunks057-058 launched; completed higher-shell support prefix remains 56/63
...
After Block90 packaged chunks055-056 and the completed higher-shell support
prefix reached 56/63, the wave launcher was run in explicit launch mode for
...
- chunk057: pid `12669`, seed `2026057057`, log
  ...
  production root
  `outputs/yt_direct_lattice_correlator_production_schur_higher_shell_rows/L12_T24_chunk057`;
- chunk058: pid `12670`, seed `2026057058`, log
  ...
  production root
  `outputs/yt_direct_lattice_correlator_production_schur_higher_shell_rows/L12_T24_chunk058`.
...
```text
12669 Rs 00:13 100.0% CPU
12670 Rs 00:13  99.4% CPU
```
...
`planned_launch_chunk_indices=[57,58]` alongside the launched process rows.
The durable completed prefix remains the previously packaged `[1..56]` until
chunks057-058 write row JSONs, volume artifacts, and completed-mode chunk
checkpoints pass.
...
evidence. Chunks057-058 do not yet supply higher-shell rows, a complete
