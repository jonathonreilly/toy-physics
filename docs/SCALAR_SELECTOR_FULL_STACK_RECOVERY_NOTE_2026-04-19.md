...
The valuable content recovered here remains useful, but the honest current
package read is narrower:

- the charged-lepton Koide lane has the strongest current executable support
  stack, but still leaves open the physical/source-law bridge behind
