...
`(C2-X)` is **not closed** by this note. Nothing in this edit
promotes audit status; the note remains an honest stretch-attempt
...
| Live retained axiom-set anchor | [`MINIMAL_AXIOMS_2026-05-03.md`](MINIMAL_AXIOMS_2026-05-03.md) | `unaudited` / `meta` | strict/permissive reading of axiom 3 is the substrate-class admissibility fork |
...
as a closure move). Until one of those two paths lands, this row
remains `audited_conditional` and the unconditional `(C2-X)` /
