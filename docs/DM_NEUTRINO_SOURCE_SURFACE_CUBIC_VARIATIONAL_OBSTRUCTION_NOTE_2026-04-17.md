...
**Theorem (Cubic variational obstruction).** Let `W[J_act]` be the Schur-baseline scalar
...
- a theorem-grade **obstruction**: the cubic the cubic variational selection obstruction route cannot produce an
 ...
 alone
- a narrowing of the selector gate open-surface: route (b) in the upstream narrowed-gap
