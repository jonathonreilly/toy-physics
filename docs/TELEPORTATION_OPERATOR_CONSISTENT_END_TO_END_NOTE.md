...
runner alone; it sits on top of imported upstream premises. The audit
ledger row for `teleportation_operator_consistent_end_to_end_note`
classified this source as `audited_conditional` / `bounded_theorem`
