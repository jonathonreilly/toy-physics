...
This is the reviewer front door for the live charged-lepton Koide branch.

It is a branch packet for honest review, consolidation, and downstream
promotion work. It is not a claim that charged leptons are already retained
closed on the current framework surface.
...
- the April 18 branch closes the exact circulant/character bridge to the April
  17 Koide package
...
- reviewer-facing charged-lepton intake for this branch
...
This packet is clean enough for branch review and consolidation.

It is not yet clean enough to promote charged leptons to retained closure,
because the current branch still stops one step short of a retained selector
law for the final microscopic scalar.

So the right classification is:

- review-ready branch packet
- exact candidate-route closure
