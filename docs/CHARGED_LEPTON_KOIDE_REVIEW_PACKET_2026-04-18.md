...
1. `CHARGED_LEPTON_MASS_HIERARCHY_REVIEW_NOTE_2026-04-17.md`
2. `KOIDE_CIRCULANT_CHARACTER_DERIVATION_NOTE_2026-04-18.md`
3. `KOIDE_CIRCULANT_CHARACTER_BRIDGE_NOTE_2026-04-18.md`
