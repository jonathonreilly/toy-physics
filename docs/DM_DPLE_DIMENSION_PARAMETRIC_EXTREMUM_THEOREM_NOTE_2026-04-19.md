...
- `scalar_selector_cycle1_science_review_note_2026-04-19` (DOWNSTREAM
  science review consumer; backticked to avoid length-2 cycle —
  citation graph direction is *cycle1_review → this_theorem*)
- `scalar_selector_synthesis_note_2026-04-19` (DOWNSTREAM publishable
  synthesis; backticked to avoid length-2 cycle — citation graph
  direction is *synthesis → this_theorem*)
