...
This section registers the upstream notes proving the exact inverse-limit
Gaussian cylinder family, projective compatibility, refinement-independent
cylindrical observables, and any needed continuity of the stationary mean
functional. The following are the load-bearing repo-native authorities for
each ingredient enumerated in the "Exact setup" section; the markdown links
