# Chronology Protection: Operational No-Past-Signaling Support Theorem

**Date:** 2026-04-25
**Status:** exact support theorem for the opened chronology-protection lane;
...
- the lane-opening statement and non-closure boundary from
...
This note supplies an exact support theorem for the chronology-protection lane:
