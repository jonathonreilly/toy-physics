...
**Primary runner:** [`scripts/structured_mirror_reconciliation.py`](../scripts/structured_mirror_reconciliation.py) (canonical structured-growth on joint-validator harness; harness-level discrepancy)
