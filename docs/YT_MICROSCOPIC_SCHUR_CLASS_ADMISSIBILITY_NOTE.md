...
The branch answer is now no at branch scale.
...
>
> Then, on the current branch locality tube around the accepted bridge data,
...
So the branch no longer carries a separate microscopic-admissibility loophole
at this scale.
...
2. that coarse operator has a unique normal-form class under intrinsic branch
...
This note closes that branch-scale loophole.
...
What it *does* prove is the stronger branch-scale statement needed now:
