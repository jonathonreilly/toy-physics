...
**Status:** audited-conditional/open bridge; exact algebra under the imported active transport profile only, with no retained-grade derivation of that lower-level profile claimed here.
