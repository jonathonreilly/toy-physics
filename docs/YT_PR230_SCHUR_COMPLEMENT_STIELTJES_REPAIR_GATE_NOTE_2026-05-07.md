...
The completed two-source taste-radial chunks001-036 contain a stricter finite
...
36 ready chunks (`z=134.33514802069274`).

The complement residual `C_x|s` is the useful new artifact: it is positive and
decreases from the zero mode to the first shell across the 36 ready chunks
(`z=-494.595619807674`).  This
...
# SUMMARY: PASS=22 FAIL=0, ready=36/63
```
