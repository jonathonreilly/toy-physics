...
**Date:** 2026-04-19  
**Status:** **RETAINED conditional theorem** — σ_hier = (2, 1, 0) is the
...
- σ_hier is promoted from "free conditional" to "conditionally retained":
  uniquely selected by observation, not internally derived.
