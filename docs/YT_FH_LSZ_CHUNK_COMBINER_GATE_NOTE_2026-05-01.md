...
**Status:** open / FH-LSZ chunk combiner gate blocks partial evidence
...
No absent, partial, or L12-only chunk set is PR #230 retained closure.  Even a
complete L12 combination would still need L16/L24 scaling, an isolated scalar
pole inverse-derivative fit, finite-volume/IR/zero-mode control, and the
