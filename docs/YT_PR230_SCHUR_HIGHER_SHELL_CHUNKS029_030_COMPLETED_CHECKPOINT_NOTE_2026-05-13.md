# PR230 Higher-Shell Chunks029-030 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks029-030
completed-mode checkpoints passed; higher-shell support prefix now 30/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks029-030 completed-mode checkpoints passed; higher-shell support prefix 30/63
...
Higher-shell chunks029-030 completed under the separate non-colliding roots:
...
- fixed seeds `2026057029` and `2026057030`;
...
- chunk029: `created_utc=2026-05-13T14:07:27Z`, seed `2026057029`;
- chunk030: `created_utc=2026-05-13T14:07:29Z`, seed `2026057030`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[31,32]` if
the support campaign continues.

## Boundary

Chunks029-030 are higher-shell support rows only. They extend the completed
higher-shell prefix to 30/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 29 \
  --output outputs/yt_pr230_schur_higher_shell_chunk029_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 30 \
  --output outputs/yt_pr230_schur_higher_shell_chunk030_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..30]
