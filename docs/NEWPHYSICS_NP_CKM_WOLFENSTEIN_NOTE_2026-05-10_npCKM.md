...
| Z7 | Z_3 generator C acts on H_{hw=1} (Z1 axis of Z³) | structural input |
...
| C_3[111] cyclic substrate | [`MINIMAL_AXIOMS_2026-04-11.md`](MINIMAL_AXIOMS_2026-04-11.md) (Axiom 2, Z³ substrate); existing 3-generation framework context | retained |
