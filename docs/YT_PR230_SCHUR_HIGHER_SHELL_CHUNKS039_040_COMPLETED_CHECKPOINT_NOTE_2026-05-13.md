# PR230 Higher-Shell Chunks039-040 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks039-040
completed-mode checkpoints passed; higher-shell support prefix now 40/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks039-040 completed-mode checkpoints passed; higher-shell support prefix 40/63
...
Higher-shell chunks039-040 completed under the separate non-colliding roots:
...
- fixed seeds `2026057039` and `2026057040`;
...
- chunk039: `created_utc=2026-05-14T01:30:11Z`, seed `2026057039`;
- chunk040: `created_utc=2026-05-14T01:30:21Z`, seed `2026057040`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[41,42]` if
the support campaign continues.

## Boundary

Chunks039-040 are higher-shell support rows only. They extend the completed
higher-shell prefix to 40/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 39 \
  --output outputs/yt_pr230_schur_higher_shell_chunk039_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 40 \
  --output outputs/yt_pr230_schur_higher_shell_chunk040_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..40]
