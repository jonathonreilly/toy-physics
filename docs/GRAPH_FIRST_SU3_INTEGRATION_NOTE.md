...
**Status:** STRUCTURAL CLOSURE ON REVIEW -- selected graph axis integrates canonically into the bounded commutant theorem  
...
This note closes the structural graph-first route to `su(3)` on review.
