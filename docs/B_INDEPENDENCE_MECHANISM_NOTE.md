...
diagnostics rest on. Nothing in this source edit sets audit status; the
...
| Cited authority | File / note | Ledger snapshot (2026-05-10) | Conditional on |
|---|---|---|---|
...
flag; until one lands, this row remains ledger-derived; at the cited audit snapshot it was conditional and
