...
**Primary runner:** `scripts/frontier_dm_neutrino_source_surface_split2_low_slack_upper_m_ridge_candidate.py`
...
quotient, and the preferred recovered lane; the split-2 reduction notes
supply the low-slack interval and the lower-repair / lane-distance objectives
this slice-wise scan reads off.
