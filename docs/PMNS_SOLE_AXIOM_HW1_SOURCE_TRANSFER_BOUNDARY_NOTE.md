...
**Date:** 2026-04-16  
**Audit repair:** 2026-05-07 - the runner now instantiates the restricted
...
It then instantiates the retained `hw=1` `Z^3` character triplet
...
`I + C`. The retained PMNS closure stack is then invoked as a live
consistency check and rejects the same pack for the same reason.
