...
retained content (`C_3`-Plancherel decomposition, character-algebra
...
character-algebra rational** under retained content alone. Specifically:
...
character-algebra retained content.
...
dimensionless `2/9` is exact retained content; the radian
...
The following retained content is load-bearing for Step 1 (positive
closure):
...
The following retained content is load-bearing for Step 2 (named
obstruction):
...
retained content, not a new admission.
