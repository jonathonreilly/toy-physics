# PR230 Higher-Shell Chunks035-036 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks035-036
completed-mode checkpoints passed; higher-shell support prefix now 36/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks035-036 completed-mode checkpoints passed; higher-shell support prefix 36/63
...
Higher-shell chunks035-036 completed under the separate non-colliding roots:
...
- fixed seeds `2026057035` and `2026057036`;
...
- chunk035: `created_utc=2026-05-13T21:02:08Z`, seed `2026057035`;
- chunk036: `created_utc=2026-05-13T21:02:27Z`, seed `2026057036`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[37,38]` if
the support campaign continues.

## Boundary

Chunks035-036 are higher-shell support rows only. They extend the completed
higher-shell prefix to 36/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 35 \
  --output outputs/yt_pr230_schur_higher_shell_chunk035_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 36 \
  --output outputs/yt_pr230_schur_higher_shell_chunk036_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..36]
