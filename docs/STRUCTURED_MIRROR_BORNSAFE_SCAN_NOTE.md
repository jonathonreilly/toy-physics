...
The audit verdict (2026-05-09) noted that the registered sliced runner
verifies a representative 32-config slice rather than the full 540-config
scanned family. The companion full-grid scan source is present in the
worktree:

- Sliced runner (registered, fast, audit-packet): `scripts/structured_mirror_bornsafe_sliced_runner_2026_05_09.py`
...
audit gap noted by the 2026-05-09 verdict.
