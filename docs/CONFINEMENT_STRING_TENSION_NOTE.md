...
with the framework's `<P> = 0.5934`). The retained alpha_s derivation
note supplies the `alpha_s(M_Z) = 0.1181` value used by the Step 4
two-loop running and the Step 5 EFT/lattice bridge to `sqrt(sigma)`.
