...
The audit verdict (2026-05-09) requested explicit registration of the
primary-runner source plus completed cached stdout backing the three weak-fit
rows. These artifacts are present in the worktree:
