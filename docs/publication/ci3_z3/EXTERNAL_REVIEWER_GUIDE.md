...
- **Charged-lepton Koide review/support package** (`Q = 2/3`, `δ = 2/9`). Reviewer entry points: [KOIDE_Q_DELTA_CLOSURE_PACKAGE_README_2026-04-21.md](../../KOIDE_Q_DELTA_CLOSURE_PACKAGE_README_2026-04-21.md) and [CHARGED_LEPTON_KOIDE_REVIEW_PACKET_2026-04-18.md](../../CHARGED_LEPTON_KOIDE_REVIEW_PACKET_2026-04-18.md). Package status: strongest current executable support, not retained closure. The historical observational-pin baseline and route-pruning notes remain provenance and compatibility context. The remaining live issues are the extremal-principle bridge behind `Q`, the physical Brannen-phase bridge behind `δ`, and the separate overall scale `v_0`. 8 runners, 201 PASS / 0 FAIL.
