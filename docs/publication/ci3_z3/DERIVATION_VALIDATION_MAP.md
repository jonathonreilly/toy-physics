...
| Graph-first structural `SU(3)` | main text | [GRAPH_FIRST_SU3_INTEGRATION_NOTE.md](../../GRAPH_FIRST_SU3_INTEGRATION_NOTE.md) | [frontier_graph_first_su3_integration.py](../../../scripts/frontier_graph_first_su3_integration.py) | `logs/retained/su3_*`; selector uniqueness is audited up to graph automorphism |
...
| Electroweak hierarchy / `v` scale on the exact minimal `3+1` block | main text or Extended Data theorem box | [OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md](../../OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md) | [frontier_hierarchy_observable_principle_from_axiom.py](../../../scripts/frontier_hierarchy_observable_principle_from_axiom.py) | `logs/retained/hierarchy_v_*`; exact theorem is the minimal-block source-response structure and the numeric value is the pinned `u_0` / plaquette evaluation |
| Retained `S^3` compactification / topology closure | main text or SI theorem box | [S3_GENERAL_R_DERIVATION_NOTE.md](../../S3_GENERAL_R_DERIVATION_NOTE.md), [S3_CAP_UNIQUENESS_NOTE.md](../../S3_CAP_UNIQUENESS_NOTE.md) | [frontier_s3_boundary_link_theorem.py](../../../scripts/frontier_s3_boundary_link_theorem.py), [frontier_s3_cap_uniqueness.py](../../../scripts/frontier_s3_cap_uniqueness.py), [frontier_s3_general_r.py](../../../scripts/frontier_s3_general_r.py) | `logs/retained/s3_*` |
...
|---|---|---|---|---|
| DM relic mapping | [DM_RELIC_PAPER_NOTE.md](../../DM_RELIC_PAPER_NOTE.md), [OMEGA_LAMBDA_DERIVATION_NOTE.md](../../OMEGA_LAMBDA_DERIVATION_NOTE.md) | [frontier_dm_relic_paper.py](../../../scripts/frontier_dm_relic_paper.py), [frontier_omega_lambda_derivation.py](../../../scripts/frontier_omega_lambda_derivation.py) | bounded/open | graph-to-relic bridge, normalization, and cancellation steps still outrun the paper bar |
| Renormalized `y_t` matching | [YT_ZERO_IMPORT_CLOSURE_NOTE.md](../../YT_ZERO_IMPORT_CLOSURE_NOTE.md), [YT_VERTEX_POWER_DERIVATION.md](../../YT_VERTEX_POWER_DERIVATION.md), [YT_GAUGE_CROSSOVER_THEOREM.md](../../YT_GAUGE_CROSSOVER_THEOREM.md) | [frontier_yt_2loop_chain.py](../../../scripts/frontier_yt_2loop_chain.py), [frontier_vertex_power.py](../../../scripts/frontier_vertex_power.py), [frontier_yt_gauge_crossover_theorem.py](../../../scripts/frontier_yt_gauge_crossover_theorem.py) | bounded/open | the new coupling-map theorem and 2-loop chain materially narrow the gate, but the latest authority still self-classifies the renormalized low-energy bridge as bounded |
