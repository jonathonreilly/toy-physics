...
| Electroweak hierarchy / `v` scale on the exact minimal `3+1` block | main text or Extended Data theorem box | [OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md](../../OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md) | [frontier_hierarchy_observable_principle_from_axiom.py](../../../scripts/frontier_hierarchy_observable_principle_from_axiom.py) | `logs/retained/hierarchy_v_*` |
