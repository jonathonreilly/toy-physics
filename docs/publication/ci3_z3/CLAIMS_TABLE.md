...
| stricter textbook geometric/action comparison beyond the already-closed canonical smooth weak/Gaussian gravitational route | bounded | arXiv / SI only | [UNIVERSAL_QG_CONTINUUM_BRIDGE_REDUCTION_NOTE.md](../../UNIVERSAL_QG_CONTINUUM_BRIDGE_REDUCTION_NOTE.md) |
