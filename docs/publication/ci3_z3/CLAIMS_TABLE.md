...
| `y_t(v) = 0.9176`, canonical `m_t(pole) = 173.10 GeV` (3-loop) with retained `172.57 GeV` (2-loop) support | derived-with-explicit-systematic quantitative lane | quantitative table | [YT_ZERO_IMPORT_AUTHORITY_NOTE.md](../../YT_ZERO_IMPORT_AUTHORITY_NOTE.md), [YT_COLOR_PROJECTION_CORRECTION_NOTE.md](../../YT_COLOR_PROJECTION_CORRECTION_NOTE.md), [YT_EXPLICIT_SYSTEMATIC_BUDGET_NOTE.md](../../YT_EXPLICIT_SYSTEMATIC_BUDGET_NOTE.md), [YT_QFP_INSENSITIVITY_SUPPORT_NOTE.md](../../YT_QFP_INSENSITIVITY_SUPPORT_NOTE.md) | [frontier_yt_color_projection_correction.py](../../../scripts/frontier_yt_color_projection_correction.py), [frontier_yt_explicit_systematic_budget.py](../../../scripts/frontier_yt_explicit_systematic_budget.py), [frontier_yt_exact_interacting_bridge_transport.py](../../../scripts/frontier_yt_exact_interacting_bridge_transport.py), [frontier_yt_microscopic_schur_class_admissibility.py](../../../scripts/frontier_yt_microscopic_schur_class_admissibility.py) |
| canonical `m_H = 125.1 GeV` (framework-side 3-loop route), with retained `119.8 GeV` (2-loop support route), plus vacuum stability readout with inherited `y_t` budget | derived-with-inherited-explicit-systematic quantitative lane | quantitative table / discussion | [HIGGS_VACUUM_EXPLICIT_SYSTEMATIC_NOTE.md](../../HIGGS_VACUUM_EXPLICIT_SYSTEMATIC_NOTE.md), [HIGGS_MASS_DERIVED_NOTE.md](../../HIGGS_MASS_DERIVED_NOTE.md) | [frontier_higgs_mass_full_3loop.py](../../../scripts/frontier_higgs_mass_full_3loop.py), [frontier_yt_color_projection_correction.py](../../../scripts/frontier_yt_color_projection_correction.py), [frontier_yt_explicit_systematic_budget.py](../../../scripts/frontier_yt_explicit_systematic_budget.py) |
...
| DM flagship gate support stack | open flagship gate | withheld from retained paper surface; exact transport chain is closed and PMNS reduced-surface support is stronger, but final DM quantitative closure is still open | [DM_LEPTOGENESIS_TRANSPORT_STATUS_NOTE_2026-04-16.md](../../DM_LEPTOGENESIS_TRANSPORT_STATUS_NOTE_2026-04-16.md), [DM_LEPTOGENESIS_PMNS_REDUCTION_EXHAUSTION_THEOREM_NOTE_2026-04-16.md](../../DM_LEPTOGENESIS_PMNS_REDUCTION_EXHAUSTION_THEOREM_NOTE_2026-04-16.md), [DM_LEPTOGENESIS_PMNS_REDUCED_SURFACE_SELECTOR_SUPPORT_NOTE_2026-04-16.md](../../DM_LEPTOGENESIS_PMNS_REDUCED_SURFACE_SELECTOR_SUPPORT_NOTE_2026-04-16.md) |
