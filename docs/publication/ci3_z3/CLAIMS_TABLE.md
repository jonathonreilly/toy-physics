...
The charged-lepton review-facing closure package is not a retained theorem-row.
It is conditioned on an explicit three-real observational pin from PDG
charged-lepton masses and is classified below under bounded/review-facing
companions.
...
| charged-lepton mass-hierarchy observational-pin closure (Koide `Q = 2/3`) | review-facing closure-class package at `retained-map-plus-observational-promotion`; strict-review verdict `TRUE_NO_PREDICTION` | review-facing note / companion package only | [CHARGED_LEPTON_MASS_HIERARCHY_REVIEW_NOTE_2026-04-17.md](../../CHARGED_LEPTON_MASS_HIERARCHY_REVIEW_NOTE_2026-04-17.md), [HIGHER_ORDER_STRUCTURAL_THEOREMS_NOTE.md](../../HIGHER_ORDER_STRUCTURAL_THEOREMS_NOTE.md) |
