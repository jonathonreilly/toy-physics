...
| `m_H = 119.8 GeV` (2-loop), `125.3 GeV` (3-loop); vacuum absolutely stable (contradicts SM metastability) | bounded quantitative lane | quantitative table / discussion | [HIGGS_VACUUM_PROMOTED_NOTE.md](../../HIGGS_VACUUM_PROMOTED_NOTE.md), [SHARP_COMPANION_PREDICTIONS_NOTE.md](../../SHARP_COMPANION_PREDICTIONS_NOTE.md) | [frontier_higgs_mass_full_3loop.py](../../../scripts/frontier_higgs_mass_full_3loop.py), [frontier_yt_color_projection_correction.py](../../../scripts/frontier_yt_color_projection_correction.py) |
...
| proton lifetime `tau_p ~ 10^{47.6}` years | bounded sharp prediction | discussion / arXiv companion | [PROTON_LIFETIME_DERIVED_NOTE.md](../../PROTON_LIFETIME_DERIVED_NOTE.md), [SHARP_COMPANION_PREDICTIONS_NOTE.md](../../SHARP_COMPANION_PREDICTIONS_NOTE.md) |
...
| gravitational decoherence (Penrose-Diosi + lattice form factor, BMV feasible) | bounded sharp prediction | discussion / arXiv companion | [GRAV_DECOHERENCE_DERIVED_NOTE.md](../../GRAV_DECOHERENCE_DERIVED_NOTE.md), [SHARP_COMPANION_PREDICTIONS_NOTE.md](../../SHARP_COMPANION_PREDICTIONS_NOTE.md) |
