...
| continuum identification: gravity (exact 19-step chain) + gauge (structural SU(3) + universality + EFT bridge) | retained positioning | main text / discussion | [CONTINUUM_IDENTIFICATION_NOTE.md](../../CONTINUUM_IDENTIFICATION_NOTE.md) | [frontier_continuum_identification_audit.py](../../../scripts/frontier_continuum_identification_audit.py) |
