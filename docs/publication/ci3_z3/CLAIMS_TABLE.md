...
| continuum / unrestricted GR beyond the project's discrete `3+1` route | bounded | arXiv / SI only | [UNIVERSAL_GR_CURVATURE_LOCALIZATION_BLOCKER_NOTE.md](../../UNIVERSAL_GR_CURVATURE_LOCALIZATION_BLOCKER_NOTE.md) |
