...
| continuum / unrestricted GR beyond the project's discrete `3+1` route, and continuum/QG inverse-limit interpretation beyond the discrete refinement family | bounded | arXiv / SI only | [UNIVERSAL_GR_CURVATURE_LOCALIZATION_BLOCKER_NOTE.md](../../UNIVERSAL_GR_CURVATURE_LOCALIZATION_BLOCKER_NOTE.md), [UNIVERSAL_QG_CONTINUUM_BRIDGE_REDUCTION_NOTE.md](../../UNIVERSAL_QG_CONTINUUM_BRIDGE_REDUCTION_NOTE.md) |
