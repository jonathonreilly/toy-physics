...
| SU(3) confinement at `T = 0` with `√σ ≈ 465 MeV` (structural + bounded quantitative) | retained structural / bounded quantitative | main text | [CONFINEMENT_STRING_TENSION_NOTE.md](../../CONFINEMENT_STRING_TENSION_NOTE.md) | [frontier_confinement_string_tension.py](../../../scripts/frontier_confinement_string_tension.py) |
