...
| continuum / unrestricted gravity beyond the project's discrete `3+1` route, plus continuum/QG smooth-equivalence beyond the exact discrete project-native PL weak Gaussian Sobolev completion | bounded / later-paper material | `F06` |
