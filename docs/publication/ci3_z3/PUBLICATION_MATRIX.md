...
| continuum / unrestricted gravity beyond the project's discrete `3+1` route, plus continuum/QG smooth-equivalence beyond the exact discrete project-native PL Gaussian completion | bounded / later-paper material | `F06` |
