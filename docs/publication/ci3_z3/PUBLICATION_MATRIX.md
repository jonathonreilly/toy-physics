...
| continuum / unrestricted gravity beyond the project's discrete `3+1` route, plus continuum/QG inverse-limit interpretation beyond the discrete refinement family | bounded / later-paper material | `F06` |
