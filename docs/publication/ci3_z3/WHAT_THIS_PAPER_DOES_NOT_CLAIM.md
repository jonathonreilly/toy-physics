...
**Date:** 2026-04-15  
**Purpose:** one canonical public boundary note stating which stronger claims
are intentionally not being made on the current paper surface.

This note exists so the paper can be read for what it actually proves, rather
than for a stronger slogan a reviewer might infer from breadth alone.

## 1. Gravity and QG

The paper does **not** claim:

- every possible smooth or continuum packaging of gravity is closed;
...
- that the CKM barred-triangle Brocard points in
  [CKM_BARRED_BROCARD_POINTS_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md](../../CKM_BARRED_BROCARD_POINTS_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md)
  are directly measured CKM observables or extend beyond the retained NLO
...
- that the B_s mixing phase, Thales-mediated B_d/B_s CP-ratio, or CP-product
  alpha_s estimator include all higher-order Wolfenstein, exact-sine, hadronic,
...
The paper does **not** claim that only exact theorem-core rows matter.

The package already carries a bounded prediction surface, but these rows are
