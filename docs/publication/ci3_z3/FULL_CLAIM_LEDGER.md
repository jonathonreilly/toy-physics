...
| stricter textbook geometric/action comparison beyond the already-closed canonical smooth weak/Gaussian gravitational route | frozen-out of flagship core | the discrete route, the canonical textbook weak/Gaussian object, and the chosen smooth global weak/Gaussian gravitational realization are all promoted on the QG side, but stronger textbook geometric/action interpretation remains a separate theorem question | `F06` |
