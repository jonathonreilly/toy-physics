...
| Down-type mass-ratio CKM-dual lane | three-layer status: retained structural identities (Layer 1) + proposed new retained primitive (Layer 2, P-AT) + bounded quantitative readout (Layer 3) | **Layer 1 (retained SI1-SI3):** `\sqrt{6}` in `|V_{cb}|_{atlas}` = retained Ward Clebsch-Gordan `\sqrt{N_c \cdot N_{iso}}` on `Q_L`; GST exponent `1/2 = 1/n_{pair}`; `5/6` bridge exponent = retained atlas `1+5` orthogonal-complement projector weight on the six-state quark block (the `C_F - T_F = 5/6` Casimir combination is a numerical coincidence check, not the retained origin). **Layer 2 (proposed new retained primitive P-AT):** atlas-projector-weighted `(2,3)` off-diagonal `M_d(2,3) = m_s^{5/6} m_b^{1/6}` in the down-type `hw=1` NNI mass matrix; under P-AT, diagonalization gives GST `|V_{us}| = \sqrt{m_d/m_s}` and `5/6` bridge `|V_{cb}| = (m_s/m_b)^{5/6}` as leading-order exact hierarchical identities, and combining with the retained CKM atlas gives the identification surface `m_d/m_s = \alpha_s(v)/n_{pair}`, `m_s/m_b = [\alpha_s(v)/\sqrt{n_{quark}}]^{6/5}` as framework output. P-AT is a **new framework proposal**, not a derivation from pre-existing retained primitives; its acceptance is a framework-level decision with review pending. **Layer 3 (bounded quantitative):** `m_d/m_s = 0.05165`, `m_s/m_b = 0.02239`, `m_d/m_b = 0.001156` inherit the bounded mass-hierarchy systematic. Still open: framework-internal derivation of P-AT from an operator-theoretic argument on the atlas bilinear tensor carrier `K_R`; theorem-grade scale-selection rule for the threshold-local comparator | [CKM_DUAL_BRIDGE_IDENTITY_THEOREM_NOTE_2026-04-17.md](../../CKM_DUAL_BRIDGE_IDENTITY_THEOREM_NOTE_2026-04-17.md), [DOWN_TYPE_MASS_RATIO_CKM_DUAL_NOTE.md](../../DOWN_TYPE_MASS_RATIO_CKM_DUAL_NOTE.md), [CKM_FIVE_SIXTHS_BRIDGE_SUPPORT_NOTE.md](../../CKM_FIVE_SIXTHS_BRIDGE_SUPPORT_NOTE.md) | matrix row `Down-type mass-ratio CKM-dual lane` |
...
|---|---|---|---|
| DM flagship gate | exact transport chain closed; the same-surface DM thermal layer is theorem-grade bounded and certifies the current-bank numerator-selector no-go; the source-side bank reduces and closes negatively to the right-sensitive `2`-real `Z_3` doublet-block law; the PMNS branch contains an exact constructive `eta/eta_obs = 1` point on the fixed native `N_e` seed surface; the remaining positive theorem target is a right-sensitive microscopic selector law on `dW_e^H = Schur_Ee(D_-)`, equivalently the intrinsic `2`-real `Z_3` doublet-block point-selection law; current-bank quantitative DM mapping remains open | right-sensitive microscopic selector law plus current-bank DM numerator selector / mapping remain open | [DM_LEPTOGENESIS_TRANSPORT_STATUS_NOTE_2026-04-16.md](../../DM_LEPTOGENESIS_TRANSPORT_STATUS_NOTE_2026-04-16.md), [DM_FULL_CLOSURE_SAME_SURFACE_THERMAL_BOUNDING_THEOREM_NOTE_2026-04-17.md](../../DM_FULL_CLOSURE_SAME_SURFACE_THERMAL_BOUNDING_THEOREM_NOTE_2026-04-17.md), [DM_FULL_CLOSURE_SAME_SURFACE_NUMERATOR_SELECTOR_BOUNDARY_NOTE_2026-04-16.md](../../DM_FULL_CLOSURE_SAME_SURFACE_NUMERATOR_SELECTOR_BOUNDARY_NOTE_2026-04-16.md), [DM_NEUTRINO_SOURCE_SURFACE_Z3_DOUBLET_BLOCK_FULL_CLOSURE_BOUNDARY_NOTE_2026-04-16.md](../../DM_NEUTRINO_SOURCE_SURFACE_Z3_DOUBLET_BLOCK_FULL_CLOSURE_BOUNDARY_NOTE_2026-04-16.md), [DM_LEPTOGENESIS_PMNS_CONSTRUCTIVE_CONTINUITY_CLOSURE_THEOREM_NOTE_2026-04-17.md](../../DM_LEPTOGENESIS_PMNS_CONSTRUCTIVE_CONTINUITY_CLOSURE_THEOREM_NOTE_2026-04-17.md), [DM_LEPTOGENESIS_PMNS_MICROSCOPIC_SELECTOR_REDUCTION_THEOREM_NOTE_2026-04-17.md](../../DM_LEPTOGENESIS_PMNS_MICROSCOPIC_SELECTOR_REDUCTION_THEOREM_NOTE_2026-04-17.md), [OMEGA_LAMBDA_DERIVATION_NOTE.md](../../OMEGA_LAMBDA_DERIVATION_NOTE.md) |
