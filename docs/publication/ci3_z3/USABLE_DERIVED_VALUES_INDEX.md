...
The updated Perron/Jacobi underdetermination theorem then shows that the
remaining open object is specifically the positive diagonal mixed-kernel
coefficient sequence `D_6`, equivalently the Perron eigenvector / moments of
that explicit factorized operator.
