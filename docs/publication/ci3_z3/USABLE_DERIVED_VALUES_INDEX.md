...
So the remaining open object is now the explicit connected plaquette hierarchy
at `beta = 6`, whose first projection is the connected Wilson plaquette
