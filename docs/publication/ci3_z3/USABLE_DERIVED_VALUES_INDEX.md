...
| CKM-side Bernoulli `2/9` readout | `2/9` | support | exact CKM pair/color arithmetic: `K1=A^2(1-A^2)=K2=2rho A^2=K5=A^2/N_color=K6=(N_color-1)/N_color^2=2/9`; simultaneous `2/9` iff `N_pair=2`, `N_color=3` over positive integers | Koide bridge targeting only; does not close charged-lepton Koide or `N_gen=N_color` | [CKM_BERNOULLI_TWO_NINTHS_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md](../../CKM_BERNOULLI_TWO_NINTHS_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md) |
| CKM-side `n/9` structural family | `1/9, ..., 9/9` | support | exact CKM target-class arithmetic: retained `A^2`, `rho`, `eta^2`, and pair/color counts generate `F_n=n/9` for `n=1,...,9`, with `F5=5/9` from both `1-A^4` and `eta^2 N_pair^2` | Koide bridge bookkeeping only; does not prove a Koide `n/9` family or `N_gen=N_color` | [CKM_N9_STRUCTURAL_FAMILY_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md](../../CKM_N9_STRUCTURAL_FAMILY_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md) |
| CKM-side cubic Bernoulli tower | `W(2)=1/8`, `W(3)=2/27`, `W(6)=5/216` | support | exact CKM target-class arithmetic: retained `A^2`, `rho`, `eta^2`, and pair/color counts generate the 4x3 `M^(k)(N)` tower through `k=3`, including `eta^2=V(2)M(3)M(6)` and `rho eta^2=W(6)` | Koide bridge bookkeeping only; does not prove Koide `cos^2(theta_K)`, Koide cubic variance, or `N_gen=N_color` | [CKM_CUBIC_BERNOULLI_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md](../../CKM_CUBIC_BERNOULLI_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md) |
| CKM-side Egyptian-fraction Bernoulli sums | `1/2+1/3+1/6=1`; `sum_N W(N)=2/9` | support | exact CKM target-class arithmetic: retained pair/color/quark counts give the Egyptian identity, unique `(2,3,6)` pinning under pair/color primitives, exact Bernoulli-series sums, and `sum_N W(N)=2/9` | Koide bridge bookkeeping only; does not prove Koide `cos^2(theta_K)`, Koide ternary unitarity, or `N_gen=N_color` | [CKM_EGYPTIAN_BERNOULLI_CLOSURES_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md](../../CKM_EGYPTIAN_BERNOULLI_CLOSURES_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md) |
| CKM-side consecutive-primes / `S_3` support | `(2,3)`, `|S_3|=6`, class sizes `{1,2,3}`, `dim(std S_3)=2` | support | exact CKM target-class arithmetic/group bookkeeping: retained pair/color/quark counts match unique consecutive primes, divisor structure, enumerated `S_3` classes, Burnside sum, standard-rep dimension, and Fibonacci triple | Koide bridge bookkeeping only; does not prove charged-lepton Koide, PMNS closure, or `N_gen=N_color` | [CKM_CONSECUTIVE_PRIMES_S3_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md](../../CKM_CONSECUTIVE_PRIMES_S3_KOIDE_BRIDGE_SUPPORT_NOTE_2026-04-25.md) |
...
| NLO orthocenter `H` | `(0.16236, 0.37460)` | derived support | exact `H=(rho_bar,(20+alpha_s(v))/(24 sqrt(5)))` on the retained protected-`gamma_bar` surface | CKM barred-triangle center geometry, altitude bookkeeping, and joint-fit comparators | [CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md](../../CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md) |
| NLO apex-orthocenter offset `H-V_3` | `(0, 0.011550)` | derived support | exact `H-V_3=(0,alpha_s(v) sqrt(5)/20)` on the retained protected-`gamma_bar` surface | CKM barred-triangle center geometry, N7 slope bookkeeping, and joint-fit comparators | [CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md](../../CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md) |
...
| NLO Euler-line identity | `H=3G-2O` exactly | derived support | exact Euclidean center relation on the retained protected-`gamma_bar` surface | CKM barred-triangle center geometry and structural consistency checks | [CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md](../../CKM_BARRED_ORTHOCENTER_EULER_LINE_EXACT_CLOSED_FORM_THEOREM_NOTE_2026-04-25.md) |
