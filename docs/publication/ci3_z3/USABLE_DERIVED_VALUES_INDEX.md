...
| APBC selector factor | `(7/8)^(1/4) = 0.967168210134` | exact / structural | zero-input structural | hierarchy selector and pre/post-selector normalization | [HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md](../../HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md), [OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md](../../OBSERVABLE_PRINCIPLE_FROM_AXIOM_NOTE.md), [HIERARCHY_BOSONIC_BILINEAR_SELECTOR_NOTE.md](../../HIERARCHY_BOSONIC_BILINEAR_SELECTOR_NOTE.md) |
| dimensionless electroweak hierarchy theorem `a v` | `2.017223509625104939e-17` | exact / structural | same-surface plaquette derivative + exact minimal-block selector; no absolute-scale import | retained no-import hierarchy carrier and all lattice-unit hierarchy bookkeeping | [HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md](../../HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md) |
| pre-selector hierarchy baseline `M_Pl * alpha_LM^16` | `254.643210673818 GeV` | bounded companion | same-surface plaquette derivative + Planck-lattice identification `a^(-1) = M_Pl` | hierarchy support analyses and endpoint comparisons only with the bounded qualifier attached | [HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md](../../HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md) |
| electroweak scale `v` | `246.282818290129 GeV` | bounded companion | same-surface hierarchy theorem plus Planck-lattice identification `a^(-1) = M_Pl` | canonical EW-scale companion only with the bounded qualifier attached | [HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md](../../HIERARCHY_NO_IMPORT_STATUS_NOTE_2026-04-22.md) |
