...
| Higgs mass `m_H` | mechanism derived; exact mass bounded | `125 GeV` | not closed | open/bounded | multiple remaining assumptions and route ambiguity | not for flagship promotion | [HIGGS_MASS_DERIVED_NOTE.md](../../HIGGS_MASS_DERIVED_NOTE.md) | [frontier_higgs_mass_derived.py](../../../scripts/frontier_higgs_mass_derived.py) |
