...
| `m_H` 2-loop | `119.8 GeV` | `125.25 GeV` | `-4.4%` | bounded | corrected-input 2-loop support route | [HIGGS_VACUUM_BOUNDED_NOTE.md](../../HIGGS_VACUUM_BOUNDED_NOTE.md) |
| `m_H` framework-side 3-loop | `125.3 GeV` | `125.25 GeV` | `+0.0%` | bounded | direct framework-native 3-loop computation; remaining bound is inherited from the `~3%` bounded `y_t` lane | [HIGGS_VACUUM_BOUNDED_NOTE.md](../../HIGGS_VACUUM_BOUNDED_NOTE.md) |
| Vacuum stability | qualitatively favorable | SM metastability comparator | qualitative prediction | bounded | inherits the bounded Yukawa / Higgs status on the current route | [HIGGS_VACUUM_BOUNDED_NOTE.md](../../HIGGS_VACUUM_BOUNDED_NOTE.md) |
