...
| `\alpha_s(M_Z)` zero-import route | `0.1181` | `0.1179` | `+0.2%` | bounded | zero-input chain, still bounded by review | review-only until closure | [YT_ZERO_IMPORT_CLOSURE_NOTE.md](../../YT_ZERO_IMPORT_CLOSURE_NOTE.md) | [frontier_yt_2loop_chain.py](../../../scripts/frontier_yt_2loop_chain.py) |
| top mass `m_t` zero-import route | `169.4 GeV` | `172.69 GeV` | `-1.9%` | bounded | zero-input 2-loop chain, still bounded | review-only until closure | [YT_ZERO_IMPORT_CLOSURE_NOTE.md](../../YT_ZERO_IMPORT_CLOSURE_NOTE.md) | [frontier_yt_2loop_chain.py](../../../scripts/frontier_yt_2loop_chain.py) |
...
| Cabibbo angle | `0.2236` | `0.2243` | near-match | bounded/fitted | fitted `\epsilon = 1/3` | frozen pending authority refresh | [CABIBBO_JARLSKOG_PREDICTION_2026-04-12.md](../../CABIBBO_JARLSKOG_PREDICTION_2026-04-12.md) | [frontier_ckm_from_z3.py](../../../scripts/frontier_ckm_from_z3.py) |
| Jarlskog invariant | `3.145 x 10^-5` | `3.08 x 10^-5` | near-match | bounded/partial | derived phase + observed angles | frozen pending authority refresh | [CABIBBO_JARLSKOG_PREDICTION_2026-04-12.md](../../CABIBBO_JARLSKOG_PREDICTION_2026-04-12.md) | [frontier_jarlskog_derived.py](../../../scripts/frontier_jarlskog_derived.py) |
...
| Higgs mass `m_H` | bounded only | `125 GeV` | not closed | open/bounded | multiple remaining assumptions | not for flagship promotion | [HIGGS_MASS_DERIVED_NOTE.md](../../HIGGS_MASS_DERIVED_NOTE.md) | [frontier_higgs_mass_derived.py](../../../scripts/frontier_higgs_mass_derived.py) |
...
| GW echo timing | `t_echo = 67.66 ms`, `f_echo = 14.8 Hz` (GW150914) | no confirmed echo detection; early claim family near `~100 ms` remains unconfirmed | sharp unconfirmed prediction | bounded/off-scope | frozen-star compact-object identification layer | later companion paper only | [GW_ECHO_DERIVED_NOTE.md](../../GW_ECHO_DERIVED_NOTE.md) | [frontier_gw_echo_derived.py](../../../scripts/frontier_gw_echo_derived.py) |
