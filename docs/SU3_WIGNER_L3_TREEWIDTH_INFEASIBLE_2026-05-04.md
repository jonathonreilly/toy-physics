...
Proposed claim id: `su3_wigner_l3_treewidth_infeasible_2026-05-04`.
Claim type: `bounded_theorem`.
...
- TN contractor POC where the `8^9` estimate originated: PR #507
  (not landed as a source dependency here).
- Greedy contractor failure: PR #509 (not landed as a source dependency
  here).
- L_s=3 Haar MC negative: [`SU3_WIGNER_L3_CUBE_HAAR_MC_NEGATIVE_RESULT_2026-05-04.md`](SU3_WIGNER_L3_CUBE_HAAR_MC_NEGATIVE_RESULT_2026-05-04.md) (PR #506).
- Block 5 (L_s=2 verdict): [`SU3_WIGNER_INTERTWINER_BLOCK4_BLOCK5_THEOREM_NOTE_2026-05-03.md`](SU3_WIGNER_INTERTWINER_BLOCK4_BLOCK5_THEOREM_NOTE_2026-05-03.md) (PR #501).
