...
The completed two-source taste-radial chunks001-046 contain real selected-mass
...
```text
zero-mode mean C_ss  = 0.1223691511848695
first-shell mean     = 0.12531953154981804
shell - zero         = 0.0029503803649485573
z-score              = 170.33620497910093
```
