...
**Date:** 2026-04-11  
**Status:** bounded exploratory positive on frontier; not yet promoted  
...
This is still frontier-only for three reasons:

1. It is an **external-source** result, not a self-consistent two-body closure.
2. It lives on an **open cubic lattice** only, not the full staggered graph
   family program.
3. The primary retained staggered baseline in the repo is still the
   force-based card, not a trajectory card.
