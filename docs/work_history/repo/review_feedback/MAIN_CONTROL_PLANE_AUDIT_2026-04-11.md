...
- [`docs/work_history/POTENTIAL_PUBLICATION_DISCOVERIES_LOG.md`](../../POTENTIAL_PUBLICATION_DISCOVERIES_LOG.md)
...
[`docs/work_history/POTENTIAL_PUBLICATION_DISCOVERIES_LOG.md`](../../POTENTIAL_PUBLICATION_DISCOVERIES_LOG.md) entry `D30` previously pointed to a note that was not present on `main`.
