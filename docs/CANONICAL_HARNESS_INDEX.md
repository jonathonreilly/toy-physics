...
| lane | authority | primary runner |
|---|---|---|
| plaquette analytic support stack | [GAUGE_VACUUM_PLAQUETTE_ANALYTIC_SUPPORT_NOTE.md](GAUGE_VACUUM_PLAQUETTE_ANALYTIC_SUPPORT_NOTE.md), [SCALAR_3PLUS1_TEMPORAL_RATIO_NOTE.md](SCALAR_3PLUS1_TEMPORAL_RATIO_NOTE.md) | `frontier_gauge_vacuum_plaquette_analytic_support.py`, `frontier_scalar_3plus1_temporal_ratio.py` |
