...
| lane | authority | primary runner |
|---|---|---|
| plaquette scalar-bridge support stack | [GAUGE_VACUUM_PLAQUETTE_BRIDGE_SUPPORT_NOTE.md](GAUGE_VACUUM_PLAQUETTE_BRIDGE_SUPPORT_NOTE.md), [SCALAR_3PLUS1_TEMPORAL_RATIO_NOTE.md](SCALAR_3PLUS1_TEMPORAL_RATIO_NOTE.md) | `frontier_gauge_vacuum_plaquette_bridge_support.py`, `frontier_scalar_3plus1_temporal_ratio.py` |
