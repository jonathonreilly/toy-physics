...
| lane | authority | primary runner |
|---|---|---|
| baryogenesis / `η` closure gate | [BARYOGENESIS_CLOSURE_GATE_NOTE.md](BARYOGENESIS_CLOSURE_GATE_NOTE.md), [BARYOGENESIS_EWPT_WASHOUT_TARGET_NOTE.md](BARYOGENESIS_EWPT_WASHOUT_TARGET_NOTE.md), [BARYOGENESIS_FINITE_T_REDUCTION_NOTE.md](BARYOGENESIS_FINITE_T_REDUCTION_NOTE.md) | `frontier_baryogenesis_closure_gate.py`, `frontier_baryogenesis_ewpt_washout_target.py`, `frontier_baryogenesis_finite_t_reduction.py` |
