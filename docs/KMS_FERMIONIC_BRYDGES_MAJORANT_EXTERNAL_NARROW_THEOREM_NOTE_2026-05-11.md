...
- specifically: the (A1)/(A2) admissions of `HIERARCHY_BBS_STAGGERED_TASTE_BLOCKING_BRIDGE_SCAFFOLD_AVAILABILITY_BOUNDED_NOTE_2026-05-11.md` (PR #1126) remain open; KMS provides published fermionic-RG technology, but the substrate-specific bridge to those admissions would still need to be separately constructed.
...
6. source-note boundary checks excluding framework bridge claims, framework-substrate-specific identification, and any (A1)/(A2)/(A3) closure;
