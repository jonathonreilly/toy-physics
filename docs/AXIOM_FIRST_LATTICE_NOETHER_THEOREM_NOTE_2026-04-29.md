...
**Audit-driven repair clarification (2026-05-03 second pass):** the
...
algebraic derivation that the audit's repair-target requested.
...
substitution. The audit's "specialisation does not close
