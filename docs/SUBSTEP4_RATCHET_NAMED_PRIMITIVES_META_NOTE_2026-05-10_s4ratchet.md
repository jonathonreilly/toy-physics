...
4. Add a new mathematical axiom. A1+A2 of
   `MINIMAL_AXIOMS_2026-05-03.md` still suffice. The framework's
...
6. The note does not add a new mathematical axiom (A1+A2 still
   suffice).
