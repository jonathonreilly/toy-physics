...
statistics, but only chunks011-012 carry per-configuration source-response and
scalar-LSZ target time series. Chunks001-010 are ready production chunks, but
they predate target-timeseries serialization.
...
The current replacement queue is chunks001-010. Chunk013 and later can add new
target-timeseries support, but `complete_for_all_ready_chunks` remains false
while chunks001-010 stay in the ready set without target-series replacement.
...
After chunk013 is processed, choose whether to continue chunk014 or rerun
chunk001 with target-timeseries serialization before trying to make the
ready-set target ESS gate complete.
