# PR230 Higher-Shell Chunks033-034 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks033-034
completed-mode checkpoints passed; higher-shell support prefix now 34/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks033-034 completed-mode checkpoints passed; higher-shell support prefix 34/63
...
Higher-shell chunks033-034 completed under the separate non-colliding roots:
...
- fixed seeds `2026057033` and `2026057034`;
...
- chunk033: `created_utc=2026-05-13T18:43:08Z`, seed `2026057033`;
- chunk034: `created_utc=2026-05-13T18:42:43Z`, seed `2026057034`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[35,36]` if
the support campaign continues.

## Boundary

Chunks033-034 are higher-shell support rows only. They extend the completed
higher-shell prefix to 34/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 33 \
  --output outputs/yt_pr230_schur_higher_shell_chunk033_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 34 \
  --output outputs/yt_pr230_schur_higher_shell_chunk034_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..34]
