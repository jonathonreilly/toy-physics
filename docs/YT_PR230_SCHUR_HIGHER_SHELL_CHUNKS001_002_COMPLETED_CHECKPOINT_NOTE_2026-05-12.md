# PR230 Higher-Shell Chunks001-002 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks001-002
...
Higher-shell chunks001-002 have completed under the separate non-colliding
roots:
...
- fixed seeds `2026057001` and `2026057002`;
...
`completed_chunk_indices=[1,2]`, and next launch capacity for chunks003-004
under the same two-worker cap.  It does not launch successors in this block.

## Boundary

These rows are partial higher-shell support.  They are not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 1 \
  --output outputs/yt_pr230_schur_higher_shell_chunk001_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 2 \
  --output outputs/yt_pr230_schur_higher_shell_chunk002_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0
