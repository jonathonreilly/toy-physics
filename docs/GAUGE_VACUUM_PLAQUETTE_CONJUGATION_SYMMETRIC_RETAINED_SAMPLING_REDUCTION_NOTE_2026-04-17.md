...
**Script:** `scripts/frontier_gauge_vacuum_plaquette_conjugation_symmetric_retained_sampling_reduction_2026_04_17.py`
...
```bash
python3 scripts/frontier_gauge_vacuum_plaquette_conjugation_symmetric_retained_sampling_reduction_2026_04_17.py
```
