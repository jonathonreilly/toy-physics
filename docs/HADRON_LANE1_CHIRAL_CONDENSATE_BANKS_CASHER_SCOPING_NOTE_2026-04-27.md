...
**Date:** 2026-04-27
**Status:** retained branch-local scoping note on
`frontier/hadron-mass-program-20260427`. Audits the Lane-1-internal
route to retained chiral condensate `Sigma` via the Banks-Casher
relation `Sigma = pi * rho_Dirac(0)` on the framework's staggered-Dirac
