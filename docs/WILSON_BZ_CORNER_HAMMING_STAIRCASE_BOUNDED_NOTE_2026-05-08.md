...
- [`HIGGS_MASS_FROM_AXIOM_NOTE.md`](HIGGS_MASS_FROM_AXIOM_NOTE.md)
  carries the `(1, 4, 6, 4, 1) staircase` reference in the
  "remaining +12% gap" section of the Higgs gap chain. That note
  asserts the staircase exists; this note records the direct
  combinatorial derivation on the same canonical lattice surface.
...
- any retention upgrade of [`HIGGS_MASS_FROM_AXIOM_NOTE.md`](HIGGS_MASS_FROM_AXIOM_NOTE.md);
