...
**Primary runner:** [`scripts/lattice_nn_deterministic_rescale.py`](../scripts/lattice_nn_deterministic_rescale.py) (deterministic geometric rescale, Born-clean through h=0.0625)
