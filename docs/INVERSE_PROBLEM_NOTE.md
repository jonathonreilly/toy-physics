...
gravity holds across the four "structure-preserving" variants
(baseline, asymmetric, jittered, sparse). Heavy random edge deletion
...
> and sparse_nn_only. TOWARD gravity holds for the latter four
