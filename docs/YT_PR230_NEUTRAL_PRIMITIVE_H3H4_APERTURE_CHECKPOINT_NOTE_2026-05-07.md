...
```yaml
actual_current_surface_status: bounded-support / neutral primitive H3/H4 aperture checkpoint; H1/H2 support and 56 C_sx/C_xx chunks do not supply physical neutral transfer or source-canonical-Higgs coupling
...
- The two-source taste-radial row combiner now sees the contiguous `001-056`
...
prefix dynamically.  At this checkpoint it consumes `ready=56/63` rather than
