...
- The two-source taste-radial row combiner now sees the contiguous `001-052`
...
prefix dynamically.  At this checkpoint it consumes `ready=52/63` rather than
the earlier `ready=44/63` prefix; the H3/H4 boundary is unchanged.
