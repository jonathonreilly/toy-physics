...
2026-04-25 primitive-edge progress:
...
- derive the entropy-spectrum selector, or supply an operational argument that
  the primitive trace itself is the entropy functional rather than ordinary
