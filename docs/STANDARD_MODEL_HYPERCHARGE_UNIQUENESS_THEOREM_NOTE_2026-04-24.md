...
scope declarations, not audit verdicts. Older promotion wording is
interpreted as the author's role-statement for this row, not an
audit-grade label.
...
Audit-grade status is set independently by the audit pipeline; this note's
table records only the author-stated standalone role, not an audit verdict.
