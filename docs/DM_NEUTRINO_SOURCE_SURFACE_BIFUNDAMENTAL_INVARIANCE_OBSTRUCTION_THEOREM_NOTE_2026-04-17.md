# (the bifundamental-invariance obstruction theorem) — Bifundamental Invariance U(2)_L × U(2)_R on the Active Doublet Block: Obstruction Theorem

**Date:** 2026-04-17
**Status:** **OBSTRUCTION THEOREM** (CASE 3). Five independent sole-axiom derivations converge: the retained atlas does **not** support independent `U(2)_L × U(2)_R` bifundamental invariance on the active-sheet doublet block `K_doublet`. The conditional closure gate that (the U(2)-invariance+quartic-isotropy obstruction theorem) identified is therefore **not available**.
...
(the U(2)-invariance+quartic-isotropy obstruction theorem) identified a conditional closure gate for the selector gate: IF independent
...
(the bifundamental-invariance obstruction theorem) mission produces an independent derivation of the same
obstruction.
...
of (the U(2)-invariance+quartic-isotropy obstruction theorem) Line 1). There is no extra invariance to be pinned
down.
...
D. **Frobenius preserved under bifundamental action on the non-Hermitian
  linear space** ((the U(2)-invariance+quartic-isotropy obstruction theorem) Line 1 re-verification): this is the
