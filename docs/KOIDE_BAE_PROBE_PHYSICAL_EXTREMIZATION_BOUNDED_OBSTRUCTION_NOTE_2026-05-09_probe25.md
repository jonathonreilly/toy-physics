...
new positive content: F1 structurally rejected by retained dynamics)
...
The retained Hamiltonian dynamics canonically selects **F3**
...
F1-vs-F3 ambiguity is **resolved against F1** by retained dynamics,
but F3 gives κ=1, NOT BAE — so retained Hamiltonian dynamics fails to
...
**Question (Probe 25):** Does the retained Hamiltonian dynamics on
...
| RP-H | Reflection positivity → reconstructed Hamiltonian `H_phys = -log T / a_τ` on `H_phys`, bounded below | retained per [`AXIOM_FIRST_REFLECTION_POSITIVITY_THEOREM_NOTE_2026-04-29.md`](AXIOM_FIRST_REFLECTION_POSITIVITY_THEOREM_NOTE_2026-04-29.md) |
...
| Probe21 | Native bilinear matter Hamiltonian: `S_native = α Tr(H_x²) + κ Tr(H_x H_y)` (NN); only retained operators | retained per [`KOIDE_BAE_PROBE_NATIVE_LATTICE_FLOW_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe21.md`](KOIDE_BAE_PROBE_NATIVE_LATTICE_FLOW_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe21.md) |
| Probe18 | F1-vs-F3 residue within retained additive log-isotype class | retained per [`KOIDE_BAE_PROBE_F1_CANONICAL_FUNCTIONAL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe18.md`](KOIDE_BAE_PROBE_F1_CANONICAL_FUNCTIONAL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe18.md) |
...
| Probe13 | K-real structure supplies Z_2 of (1,1) but not SO(2) | retained per [`KOIDE_A1_PROBE_REAL_STRUCTURE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe13.md`](KOIDE_A1_PROBE_REAL_STRUCTURE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe13.md) |
...
## The retained Hamiltonian dynamics
...
### The structural impossibility of F1 from retained dynamics
...
(e) The Probe 18 F1-vs-F3 ambiguity is RESOLVED by retained dynamics
...
Therefore: retained Hamiltonian dynamics canonically selects F3, NOT
...
Probe 25's contribution: takes the retained Hamiltonian dynamics
...
rejected by retained dynamics; F3 is canonical."**
...
- `claim_type`: `bounded_theorem` (sharpened obstruction with new
  positive content: F1 structurally rejected by retained dynamics)
...
- `admitted_context_inputs`: `["BAE-condition: |b|²/a² = 1/2 (legacy:
  ...
  weighted, (1, 1)) is structurally rejected by retained dynamics. F3
  gives κ=1, NOT BAE."**
...
5. Sharpens the campaign's terminal residue from "F1 vs F3 ambiguous
   ...
   **"retained Hamiltonian dynamics canonically gives F3, NOT F1, and
   F3 gives NOT-BAE."**
...
extremization functional from retained Hamiltonian dynamics directly.
...
3. **The Probe 18 F1-vs-F3 ambiguity is resolved against F1** by
   retained dynamics. The campaign's terminal residue acquires its
   sharpest characterization to date: **"F1 = (1, 1) (multiplicity
   weighting) is the BAE-giving functional, BUT it is not realized by
   retained Hamiltonian dynamics. The canonical retained-dynamics
   functional is F3 = (1, 2) (real-dim weighting), which gives
   κ=1, NOT BAE."**

4. **BAE is therefore NOT canonical from retained dynamics.** Any
...
5. **Cross-validation of Probes 12, 13, 21:** Probe 12 (Plancherel
   ...
   fixed-point family. All are consistent with: retained dynamics
...
2. **Sharpened residue characterization**: the campaign's open piece
   ...
   structurally absent from retained dynamics; the canonical retained-
...
- `feedback_compute_speed_not_human_timelines.md`: alternative routes
  ...
  retained dynamics), not how-long-they-would-take.
