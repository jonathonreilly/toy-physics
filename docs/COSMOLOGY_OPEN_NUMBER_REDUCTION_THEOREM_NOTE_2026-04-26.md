# Cosmology Open-Number Reduction Theorem: The Late-Time Bounded Surface Has Exactly Two Open Numbers
...
review-and-integration. Packages the matter-bridge identity (2026-04-22),
the structural lock theorem (2026-04-26), and the single-ratio inverse
reconstruction certificate (2026-04-25) into one open-number-count statement.
...
Hence the late-time bounded cosmology surface has **exactly two
structurally open numbers**: `H_0` and `L`. Equivalently, knowing any
...
```text
|open structural numbers in S| = 2     (the pair (H_0, L)).
```
...
| Structural lock theorem | `HUBBLE_TENSION_STRUCTURAL_LOCK_THEOREM_NOTE_2026-04-26.md` |
| `R_base = 31/9` | `R_BASE_GROUP_THEORY_DERIVATION_THEOREM_NOTE_2026-04-24.md` |
| `1 + z_mr = Omega_m / Omega_r` | `MATTER_RADIATION_EQUALITY_STRUCTURAL_IDENTITY_THEOREM_NOTE_2026-04-24.md` |
...
known to have exactly two open structural numbers: `H_0` and `L`. The
...
of the two open structural numbers; both close the surface.
...
items already on `main` or landed branch-locally on this workstream.
