...
promotes audit status. The audit-clean content of this note is
...
interpretation: the audit-clean perimeter is the single-metric, fixed-
three-property AND-search result, not a full exhaustion of
node-level classifiers. A future audit-clean exhaustion theorem
