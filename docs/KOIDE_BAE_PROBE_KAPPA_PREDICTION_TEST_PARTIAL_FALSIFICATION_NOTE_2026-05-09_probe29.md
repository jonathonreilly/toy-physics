...
sector under retained content alone; κ-prediction test against empirical
κ ≈ 2)
...
retained content actually **predicts** for charged leptons, then compares
...
content alone. The framework's combined retained content (free Gaussian
...
give κ ≈ 2.000037. The framework's retained-content κ-prediction
...
under retained content alone.** No new admission is added; the BAE
admission count is UNCHANGED. The framework would need a multiplicity-
counting principle (not derivable from retained content per Probe 25)
...
- **"BAE-condition" (Brannen Amplitude Equipartition)** = the
  ...
  `hw=1 ≅ ℂ³`. Per the rename in PR #790 (2026-05-09, commit
  `2cce201b9`), **BAE is the primary name**; the legacy alias
...
retained-content angle to **close** BAE — i.e., to derive κ = 2 from
...
> Instead of asking "can retained content close BAE?", take the
> framework's retained content seriously as a **predictor** of κ, and
> test that prediction against the empirical observation κ ≈ 2.

Three honest outcomes were considered before running:

1. **CLOSURE**: framework predicts κ = 2 via specific retained-content
   chain ⇒ BAE closes.
2. **PARTIAL FALSIFICATION**: framework predicts κ ≠ 2 ⇒ framework's
   charged-lepton sector is wrong or incomplete.
3. **AMBIGUOUS**: retained content does not pin κ uniquely.
...
The framework's free retained matter-sector dynamics on Herm_circ(3)
...
sector under retained content alone.**
...
weighting) that is **not derivable from retained Hamiltonian dynamics**
...
retained content alone, with a single-clause characterization of the
...
| BlockTotalFrob | `E_+ = 3a²`, `E_⊥ = 6\|b\|²` on `M_3(ℂ)_Herm`; §4 enumerates `(μ, ν)` log-laws | retained per [`KOIDE_KAPPA_BLOCK_TOTAL_FROBENIUS_MEASURE_THEOREM_NOTE_2026-04-19.md`](KOIDE_KAPPA_BLOCK_TOTAL_FROBENIUS_MEASURE_THEOREM_NOTE_2026-04-19.md) |
...
| KoideAlg | Koide `Q = 2/3 ⟺ a² = 2\|b\|² ⟺ κ = 2` | retained per [`CHARGED_LEPTON_KOIDE_CONE_ALGEBRAIC_EQUIVALENCE_NOTE.md`](CHARGED_LEPTON_KOIDE_CONE_ALGEBRAIC_EQUIVALENCE_NOTE.md) |
| Bridge | Cone slack = -9 × BAE slack; spectrum-cone is operator-side equivalent | retained per [`KOIDE_KAPPA_SPECTRUM_OPERATOR_BRIDGE_THEOREM_NOTE_2026-04-19.md`](KOIDE_KAPPA_SPECTRUM_OPERATOR_BRIDGE_THEOREM_NOTE_2026-04-19.md) |
| LR | Lieb-Robinson microcausality + finite-range r=1 matter Hamiltonian | retained per [`AXIOM_FIRST_MICROCAUSALITY_LIEB_ROBINSON_THEOREM_NOTE_2026-05-01.md`](AXIOM_FIRST_MICROCAUSALITY_LIEB_ROBINSON_THEOREM_NOTE_2026-05-01.md) |
| Probe25 | Retained Gaussian dynamics on Herm_circ(3) gives F3 (real-dim weighting); F1 structurally absent | retained per [`KOIDE_BAE_PROBE_PHYSICAL_EXTREMIZATION_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe25.md`](KOIDE_BAE_PROBE_PHYSICAL_EXTREMIZATION_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe25.md) |
| Probe22 | Spectrum-cone pivot bridge-equivalent to operator-side BAE | retained per [`KOIDE_BAE_PROBE_SPECTRUM_CONE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe22.md`](KOIDE_BAE_PROBE_SPECTRUM_CONE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe22.md) |
| Probe18 | F1 vs F3 algebraic ambiguity (F2 ruled out structurally) | retained per [`KOIDE_BAE_PROBE_F1_CANONICAL_FUNCTIONAL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe18.md`](KOIDE_BAE_PROBE_F1_CANONICAL_FUNCTIONAL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe18.md) |
| Probe12 | Plancherel-uniform on `Ĉ_3` gives (1, 2) → F3 | retained per [`KOIDE_A1_PROBE_PLANCHEREL_PETER_WEYL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe12.md`](KOIDE_A1_PROBE_PLANCHEREL_PETER_WEYL_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe12.md) |
| Probe19 | Wilson chain `m_τ = M_Pl (7/8)^{1/4} u_0 α_LM^{18}` fixes mass scale | retained per [`KOIDE_BAE_PROBE_WILSON_CHAIN_MASS_SHARPENED_NOTE_2026-05-09_probe19.md`](KOIDE_BAE_PROBE_WILSON_CHAIN_MASS_SHARPENED_NOTE_2026-05-09_probe19.md) |
| Probe24 | φ_dimensionless = 2/9 from C_3 character algebra (n_eff/d² = 2/9) | retained per [`KOIDE_BAE_PROBE_PHI_FROM_Z3_CHARACTER_SHARPENED_NOTE_2026-05-09_probe24.md`](KOIDE_BAE_PROBE_PHI_FROM_Z3_CHARACTER_SHARPENED_NOTE_2026-05-09_probe24.md) |
| Probe26 | Wilson chain rescaling H → rH preserves κ (κ scale-invariant) | retained per [`KOIDE_BAE_PROBE_WILSON_DIMENSIONAL_OBSTRUCTION_NOTE_2026-05-09_probe26.md`](KOIDE_BAE_PROBE_WILSON_DIMENSIONAL_OBSTRUCTION_NOTE_2026-05-09_probe26.md) |
| Probe21 | Native bilinear matter Hamiltonian: `S_native = α Tr(H_x²) + κ Tr(H_x H_y)` | retained per [`KOIDE_BAE_PROBE_NATIVE_LATTICE_FLOW_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe21.md`](KOIDE_BAE_PROBE_NATIVE_LATTICE_FLOW_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe21.md) |
...
**The framework's retained-content κ-prediction is κ = 1.**
...
| Framework prediction (retained content alone) | 1 | Probe 25 / Probe 29 |
...
extremum, with the same canonical retained dynamics → F3 → κ = 1.
...
### KP-AV6 — Combined retained-content canonical functional
...
κ ≈ 2.000037. The framework's retained-content prediction κ = 1
...
This admission is **not derivable from retained content** per Probe 25
...
**Theorem.** On A1 + A2 + retained Hamiltonian dynamics + retained
...
(g) Closing BAE requires admitting a multiplicity-counting principle
    ...
    derivable from retained content per Probe 25.
    [Section 10.]

Therefore: the framework's retained content gives a unique κ-prediction
...
charged-lepton sector under retained content alone. No new admission
...
**The framework's retained content currently predicts the wrong
charged-lepton Koide ratio.**

Probes 1-26 attacked the BAE-closure problem from the closure side
("can retained content force κ = 2?"). The answer was uniformly
...
1. **Framework prediction is unique**: combining all κ-determining
   retained content (free Gaussian dynamics, Plancherel state, spectrum
...
- `effective_status`: `retained_bounded` after audit review, with
...
1. Combines all κ-determining retained content (KP-AV1-AV3) into a
...
2. Computes the framework's κ-prediction = 1 from this functional's
   extremum.
3. Verifies that κ-neutral retained content (KP-AV4-AV5) does not
...
5. Documents the factor-2 discrepancy honestly as partial falsification
   of the framework's charged-lepton sector under retained content.
...
5. Does NOT load-bear PDG values into a derivation step (KP-AV1-AV7
   are derived from retained content; PDG appears only in KP-AV8 as
...
| **Probe 29** | **Synthesizes all retained content into κ-predictor; tests against PDG** | **κ = 1 prediction; PARTIAL FALSIFICATION vs PDG κ ≈ 2** |
...
- **All retained-content κ-determining AVs converge on κ = 1:**
...
- Probe 26 (Wilson dimensional consistency): [`KOIDE_BAE_PROBE_WILSON_DIMENSIONAL_OBSTRUCTION_NOTE_2026-05-09_probe26.md`](KOIDE_BAE_PROBE_WILSON_DIMENSIONAL_OBSTRUCTION_NOTE_2026-05-09_probe26.md)
...
4. Section 7 — KP-AV6: combined retained content gives Φ_canonical
   with κ = 1 prediction.
5. Section 8 — KP-AV7: MRU image of integer-(μ, ν) class shows F1
   structurally absent from retained dynamics.
