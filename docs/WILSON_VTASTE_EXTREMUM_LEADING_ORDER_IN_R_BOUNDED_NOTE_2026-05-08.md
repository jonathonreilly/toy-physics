...
- [`WILSON_CORRECTED_V_TASTE_TREE_LEVEL_BOUNDED_NOTE_2026-05-08.md`](WILSON_CORRECTED_V_TASTE_TREE_LEVEL_BOUNDED_NOTE_2026-05-08.md)
  ...
  derivatives (this note's load-bearing input). **Forward-reference:**
  on a sister branch; not on `origin/main` at the time of writing. The
  runner handles graceful absence per the established pattern.
