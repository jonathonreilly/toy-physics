...
`frontier/hadron-mass-program-20260427`. Reduces Lane 1 (hadron mass
program) to a sharp pion/proton mass theorem plan using current
confinement, `alpha_s` running, and Lane 3 quark-mass dependencies.
Identifies Lane-1-internal work that proceeds in parallel with Lane 3.
...
- Phase-1 Lane-1-internal (parallel to Lane 3): **3E**, plus an
  optional Lane-1-internal route to retained chiral condensate `Sigma`
...
- **3E** `sqrt(sigma)` retained promotion (Lane-1-internal; no Lane-3
  blocker).
