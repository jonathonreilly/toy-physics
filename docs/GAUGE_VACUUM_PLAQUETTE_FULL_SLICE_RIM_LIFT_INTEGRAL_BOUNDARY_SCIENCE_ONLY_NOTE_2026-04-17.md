...
**Script:** `scripts/frontier_gauge_vacuum_plaquette_full_slice_rim_lift_integral_boundary_science_only_2026_04_17.py`
...
```bash
python3 scripts/frontier_gauge_vacuum_plaquette_full_slice_rim_lift_integral_boundary_science_only_2026_04_17.py
```
