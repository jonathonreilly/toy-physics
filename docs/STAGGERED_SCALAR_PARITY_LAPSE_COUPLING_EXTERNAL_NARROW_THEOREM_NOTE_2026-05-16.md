...
et al. 2020 and Dempsey-Klich-Lopez 2025 for the lattice scalar-coupling
...
(Zache et al. 2020 Sec. 2; Dempsey-Klich-Lopez 2025 Sec. 3).
...
- that the parity coupling (P) or lapse coupling (L) is derived from
  the framework's restored axiom set (A1: Cl(3) local algebra;
  A2: Z^3 spatial substrate; see `MINIMAL_AXIOMS_2026-05-03.md`);
- closure of the `staggered_dirac_realization_gate_note_2026-05-03`
  ...
  from A1+A2 is delegated to that gate and the in-flight supporting
  notes; this note does not discharge any of substeps (1)-(4) of that
  gate's closure target);
...
strictly stronger question: whether A1 + A2 plus admissible mathematical
infrastructure **forces** the Grassmann staggered-Dirac realization
...
- T. V. Zache, M. Van Damme, J. C. Halimeh, P. Hauke, D. Banerjee,
  ...
  (and Zache et al. 2020 framework-coupling identification therein).
- K. Dempsey, I. Klich, A. Lopez, "Staggered fermion couplings to
  external scalar backgrounds and the equivalence principle on the
  lattice", arXiv:2503.xxxxx (Dempsey et al. 2025; cited for the
  spin-taste 1 (x) 1 scalar-coupling identification on the
  Kogut-Susskind lattice).
