...
and cited authorities, not an audited dependency. Nothing in this source edit sets audit status; the note remains an honest stretch-
...
to cover the SU(2)-anchor variant. Until either path lands, this row remains ledger-derived; at the cited audit snapshot it was
conditional and this note remains a stretch-attempt
