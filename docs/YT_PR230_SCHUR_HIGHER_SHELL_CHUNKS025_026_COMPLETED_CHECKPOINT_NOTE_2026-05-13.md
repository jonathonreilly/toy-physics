# PR230 Higher-Shell Chunks025-026 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks025-026
completed-mode checkpoints passed; higher-shell support prefix now 26/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks025-026 completed-mode checkpoints passed; higher-shell support prefix 26/63
...
Higher-shell chunks025-026 completed under the separate non-colliding roots:
...
- fixed seeds `2026057025` and `2026057026`;
...
- chunk025: `created_utc=2026-05-13T09:14:57Z`, seed `2026057025`;
- chunk026: `created_utc=2026-05-13T09:15:11Z`, seed `2026057026`.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[27,28]` if
the support campaign continues.

## Boundary

Chunks025-026 are higher-shell support rows only. They extend the completed
higher-shell prefix to 26/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 25 \
  --output outputs/yt_pr230_schur_higher_shell_chunk025_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 26 \
  --output outputs/yt_pr230_schur_higher_shell_chunk026_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_wave_launcher.py --max-concurrent 2
# SUMMARY: PASS=11 FAIL=0; completed_chunk_indices=[1..26]
