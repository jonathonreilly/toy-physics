...
- **"BAE"** = Brannen Amplitude Equipartition, the amplitude-ratio
  ...
  2026-05-09 rename (commit `2cce201b9`, PR #790), legacy aliases
...
| Circulant (R1) | `C_3`-equivariant Hermitian on hw=1 is `aI + bC + b̄C²` | retained per [`KOIDE_CIRCULANT_CHARACTER_DERIVATION_NOTE_2026-04-18.md`](KOIDE_CIRCULANT_CHARACTER_DERIVATION_NOTE_2026-04-18.md) R1 |
| Spectrum (R2) | `λ_k = a + bω^k + b̄ω^{−k} = a + 2\|b\|cos(arg(b) + 2πk/3)` | retained per [`KOIDE_CIRCULANT_CHARACTER_DERIVATION_NOTE_2026-04-18.md`](KOIDE_CIRCULANT_CHARACTER_DERIVATION_NOTE_2026-04-18.md) R2 |
| Bridge | `a₀ = √3 a`, `\|z\|² = 3\|b\|²`, `a₀² − 2\|z\|² = 3a² − 6\|b\|²` | retained per [`KOIDE_CIRCULANT_CHARACTER_BRIDGE_NARROW_THEOREM_NOTE_2026-05-09.md`](KOIDE_CIRCULANT_CHARACTER_BRIDGE_NARROW_THEOREM_NOTE_2026-05-09.md) (positive_theorem) |
| ConeIdentity | Cone equation iff Q = 2/3 (polynomial T2 identity) | retained per [`KOIDE_CONE_THREE_FORM_EQUIVALENCE_NARROW_THEOREM_NOTE_2026-05-02.md`](KOIDE_CONE_THREE_FORM_EQUIVALENCE_NARROW_THEOREM_NOTE_2026-05-02.md) (positive_theorem) |
...
| Campaign | 18-probe terminal residue: `(1,1)`-weighted Frobenius / `U(1)_b` angular quotient | retained per [`KOIDE_A1_11_PROBE_CAMPAIGN_BOUNDED_ADMISSION_META_NOTE_2026-05-08.md`](KOIDE_A1_11_PROBE_CAMPAIGN_BOUNDED_ADMISSION_META_NOTE_2026-05-08.md) + Probes 12, 13, 14, 18 |
...
- NO new axioms (per user 2026-05-09 clarification: closure must come
  from already-retained content or from a derivation extending the
  retained library)
...
derived from retained content for the matter-sector circulant, the
retained polynomial identity
[`KOIDE_CONE_THREE_FORM_EQUIVALENCE`](KOIDE_CONE_THREE_FORM_EQUIVALENCE_NARROW_THEOREM_NOTE_2026-05-02.md)
...
is canonically pinned by retained content (R1: any `C_3`-equivariant
...
1. **CLOSURE**: derive that matter-sector eigenvalues lie on Koide
   cone from retained content. → **NOT ACHIEVED.** The bridge identity
...
2. **STRUCTURAL OBSTRUCTION**: spectrum-localization on cone cannot
   be derived from retained content. → **ACHIEVED (sharpened).** The
...
- Rename commit: `2cce201b9` (PR #790, 2026-05-09).
...
- `feedback_retained_tier_purity_and_package_wiring.md`: probe is
  ...
  audit lane decides. The probe respects retained content (R1, R2,
...
audit_review_points: |
  Conditional on:
   ...
   (d) the verdict "spectrum-level pivot is bridge-illusory" being
       ...
       contradicting any retained content.
