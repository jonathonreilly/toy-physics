...
finite comparison." The audit verdict is terminal under
...
Until one of those lands, this row remains `audited_conditional`
and the safe read is the partial bounded comparison over the
