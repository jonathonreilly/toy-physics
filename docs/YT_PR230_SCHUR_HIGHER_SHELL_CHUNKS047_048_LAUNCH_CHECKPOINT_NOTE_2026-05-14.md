# PR230 Higher-Shell Chunks047-048 Launch Checkpoint

**Status:** run-control support / higher-shell Schur scalar-LSZ chunks047-048
launched; completed higher-shell support prefix remains 46/63; no closure
...
```yaml
actual_current_surface_status: run-control support / higher-shell Schur scalar-LSZ chunks047-048 launched; completed higher-shell support prefix remains 46/63
...
- `outputs/yt_direct_lattice_correlator_production_schur_higher_shell_rows/L12_T24_chunk047`
- `outputs/yt_direct_lattice_correlator_production_schur_higher_shell_rows/L12_T24_chunk048`

The launcher verifies both workers alive after the verification interval. A
separate `ps` check immediately after launch also showed both pids alive. The
completed prefix remains 46/63 until row JSONs exist and completed-mode chunk
checkpoints pass.

## Boundary

Chunks047-048 are run-control only in this checkpoint. Active jobs, logs, pid
