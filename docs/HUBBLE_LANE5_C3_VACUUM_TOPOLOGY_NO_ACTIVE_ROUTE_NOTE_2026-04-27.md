...
listed candidate surfaces. The `(C3)` empty-class verdict is conditional
on the current scoped claims of those candidate notes. A disposition flips
if any candidate surface is later
