...
**Primary runner:** [`scripts/lattice_nn_rg_gravity.py`](../scripts/lattice_nn_rg_gravity.py) (raw NN gravity vs refinement schedule (intentional FAIL rows record continuation limit))
