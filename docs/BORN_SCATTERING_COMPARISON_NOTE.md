...
(`audited_numerical_match`); per repo rules, no
`docs/audit/data/*.json` files are modified by this PR. PATH B simply
makes the **claim scope** in this note honest about what the runner
verifies versus what is imported.
...
authority cited; they are NOT derived from A_min primitives in this
note:
...
- Not a derivation of the lattice slope `−1.43` from A_min primitives.
