...
**Status:** TREE-LEVEL MEAN-FIELD per-channel curvature scale on the canonical surface. NOT a Higgs-mass prediction. The framework's Higgs-mass prediction routes through [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md) (full 3-loop SM RGE from `λ(M_Pl) = 0`).
...
**This note derives** a per-channel symmetric-point curvature scale of V_taste on the canonical mean-field surface:
    ...
    m_curv_tree := √|V_taste''(0)| / N_taste · v
                 = v / (2 u_0)
...
This mirrors PR #951 v3's pattern: the analogous dimensionless ratio derived from V_taste's symmetric-point curvature was renamed from `λ_curv` to `κ_curv` in [`HIGGS_KAPPA_CURV_FROM_VTASTE_SYMMETRIC_POINT_NARROW_THEOREM_NOTE_2026-05-10.md`](HIGGS_KAPPA_CURV_FROM_VTASTE_SYMMETRIC_POINT_NARROW_THEOREM_NOTE_2026-05-10.md) for the same first-principles reason: the symmetric-point object should not carry a name that implies a broken-phase pole or quartic coupling.
...
**The Higgs-mass prediction is in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md).** That note's primary runner is `scripts/frontier_higgs_mass_full_3loop.py`, which integrates the full 3-loop SM RGE from the framework boundary `λ(M_Pl) = 0` down to μ = v and gives `m_H ≈ 125.1 GeV` directly. The present note's `m_curv_tree = 140.3 GeV` is a per-channel symmetric-point curvature scale; it is NOT the Higgs-mass prediction.
...
not enter the downstream Higgs-mass prediction in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md).
...
full CW mechanism), stabilized at v = 246 GeV by the hierarchy theorem
(v = M_Pl * alpha_LM^16). This is the structural reason why
...
in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md) is also
...
non-derived per [`HIGGS_CHANNEL_EFFECTIVE_NTASTE_BOUNDARY_BOUNDED_NOTE_2026-05-08.md`](HIGGS_CHANNEL_EFFECTIVE_NTASTE_BOUNDARY_BOUNDED_NOTE_2026-05-08.md));
...
~125.1 GeV is in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md)
...
[`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md) is also
N_c-independent (consistent finding via a separate chain).
...
The framework's actual Higgs-mass prediction (~125.1 GeV) is delivered
by the full 3-loop SM RGE chain in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md),
not by additively patching this note's symmetric-point curvature scale.
...
|---|---|---|---|---|
| 2-loop CW + RGE running | [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md) (`bounded_theorem`, td=309) + `scripts/frontier_higgs_mass_corrected_yt.py` (corrected-y_t RGE) | audit ledger only | symmetric-point curvature scale → ~119.93 GeV via corrected-y_t at 3L+NNLO | conditional on `y_t` Ward + RGE-transport scaffolding |
...
in [`HIGGS_MASS_DERIVED_NOTE.md`](HIGGS_MASS_DERIVED_NOTE.md), which uses
the full 3-loop SM RGE from `λ(M_Pl) = 0` and does not load-bear on
`m_curv_tree`.
...
[`HIGGS_MASS_WILSON_CHAIN_PARTIAL_PROGRESS_NOTE_2026-05-10_higgsH1.md`](HIGGS_MASS_WILSON_CHAIN_PARTIAL_PROGRESS_NOTE_2026-05-10_higgsH1.md),
[`LATTICE_PHYSICAL_MATCHING_THEOREM_BOUNDED_OBSTRUCTION_NOTE_2026-05-10_match.md`](LATTICE_PHYSICAL_MATCHING_THEOREM_BOUNDED_OBSTRUCTION_NOTE_2026-05-10_match.md),
...
and [`HIGGS_CHANNEL_EFFECTIVE_NTASTE_BOUNDARY_BOUNDED_NOTE_2026-05-08.md`](HIGGS_CHANNEL_EFFECTIVE_NTASTE_BOUNDARY_BOUNDED_NOTE_2026-05-08.md).
...
- `HIGGS_MASS_DERIVED_NOTE.md` -- the framework's actual Higgs-mass prediction (~125.1 GeV) via full 3-loop SM RGE; NOT load-bearing on `m_curv_tree`
