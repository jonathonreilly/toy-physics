# PR #230 FH/LSZ Chunk003 Target-Timeseries Rerun Checkpoint

**Status:** bounded-support / FH-LSZ chunk003 target-timeseries replacement checkpoint  
...
**Certificates:** `outputs/yt_fh_lsz_chunk003_target_timeseries_generic_checkpoint_2026-05-02.json`, `outputs/yt_fh_lsz_autocorrelation_ess_gate_2026-05-02.json`, `outputs/yt_fh_lsz_target_timeseries_replacement_queue_2026-05-02.json`

## Result

`L12_T24_chunk003` was rerun without `--resume`, replacing the old
...
Target-series coverage is now complete for chunks001, 002, 003, 011, and 012,
but still missing for chunks004-010. The refreshed replacement queue is
therefore:

```text
replacement_queue = [4, 5, 6, 7, 8, 9, 10]
next_replacement_chunk = 4
```
