...
The Q-functional **erases** all U(1)_b-non-invariant retained content
...
The retained content currently provides:
...
- The MRU demotion note explicitly flags that the (1,1) weighting
  vs (1,2) weighting choice is **not pinned by retained content**;
  it is "minor and equivalent in scale to MRU-as-observable-principle".
- No retained matter-sector dynamics extremizes `log E_+ + log E_⊥`
...
- **At algebra level (Probes 1-14)**: the closure target is "derive
  `|b|²/a² = 1/2` from retained content". Result: not closeable —
...
| BlockTotalFrob | `E_+ = 3a²`, `E_⊥ = 6|b|²` on `Herm_circ(3)` | retained per [`KOIDE_KAPPA_BLOCK_TOTAL_FROBENIUS_MEASURE_THEOREM_NOTE_2026-04-19.md`](KOIDE_KAPPA_BLOCK_TOTAL_FROBENIUS_MEASURE_THEOREM_NOTE_2026-04-19.md) |
| ConeAlg | Koide `Q = 2/3 ⟺ a₀² = 2\|z\|² ⟺ \|b\|²/a² = 1/2` | retained per [`CHARGED_LEPTON_KOIDE_CONE_ALGEBRAIC_EQUIVALENCE_NOTE.md`](CHARGED_LEPTON_KOIDE_CONE_ALGEBRAIC_EQUIVALENCE_NOTE.md) |
| ConePoly | Polynomial cone three-form equivalence | retained per [`KOIDE_CONE_THREE_FORM_EQUIVALENCE_NARROW_THEOREM_NOTE_2026-05-02.md`](KOIDE_CONE_THREE_FORM_EQUIVALENCE_NARROW_THEOREM_NOTE_2026-05-02.md) |
| P1 | `λ_k = √m_k` (P1 square-root identification) | retained per [`KOIDE_KAPPA_SPECTRUM_OPERATOR_BRIDGE_THEOREM_NOTE_2026-04-19.md`](KOIDE_KAPPA_SPECTRUM_OPERATOR_BRIDGE_THEOREM_NOTE_2026-04-19.md) §1.2 |
| BrannenSO2 | `Q = (c²+2)/6` U(1)_b-invariant on Brannen carrier | retained per [`KOIDE_Q_SO2_PHASE_ERASURE_SUPPORT_NOTE_2026-04-25.md`](KOIDE_Q_SO2_PHASE_ERASURE_SUPPORT_NOTE_2026-04-25.md) |
| Probe13 | Algebra-level residue: U(1)_b SO(2) phase quotient on b-doublet | retained per [`KOIDE_A1_PROBE_REAL_STRUCTURE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe13.md`](KOIDE_A1_PROBE_REAL_STRUCTURE_BOUNDED_OBSTRUCTION_NOTE_2026-05-09_probe13.md) |
| Probe14 | No retained U(1) projects onto U(1)_b on b-doublet | retained per Probe 14 commit `aa4743766` |
...
```
(a) Q-functional U(1)_b-invariance (closes from retained content).
...
principle" but **not derivable from retained content alone**. This
...
retained content. What is **not pinned** is the **canonical
...
1. **Continue derivation hunt**. The residue is now precisely
   ...
   F1 canonicality from retained content (e.g., max-entropy
...
retained content). This **clears one obstruction** but uncovers a
...
- Probe 14 (retained-U(1) hunt) — see commit `aa4743766` for source note
