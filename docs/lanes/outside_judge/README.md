...
**Date:** 2026-04-26
**Status:** PROPOSAL — for review. Not retained, not bounded, not on the
manuscript surface yet. This package proposes opening / clarifying five lanes
that an external referee or senior physicist would identify as the genuinely-open
flagship questions, distinct from the project's internal "Open Flagship Lane"
scoping.

**Branch:** `claude/outside-judge-lanes-proposal-2026-04-26`
...
This package proposes opening / clarifying **five lanes** that should be
treated as outside-judge open flagship lanes, each with explicit derivation
targets, existing scaffolding, and recommended attack approaches. **It does
not promote any claim or close any theorem.** It only proposes lane scoping
for review.
...
## What this package proposes for the manuscript surface
...
These updates would be applied if and when this package is approved for
landing onto `main` after review.

## Reviewer questions to address

The reviewer (Codex) should evaluate:
...
5. **Should this be landed onto `main` as proposal-status documents, or
   converted to retained-grade lane-opening notes (analogous to the frontier
   extension lane opening note)?**
...
If approved for landing, this is roughly a 6–18 month closure program (each
lane is months of focused work, but lanes 2 and 5 are likely close to
single-month closures). If not approved, the lanes remain identified for
future scoping; nothing breaks.
