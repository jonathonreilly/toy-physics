...
is a first-order particle-physics closure target before many downstream
precision sectors.
...
6. Re-audit the bounded charged-lepton compatibility package
   ([CHARGED_LEPTON_MASS_HIERARCHY_REVIEW_NOTE_2026-04-17.md](../../CHARGED_LEPTON_MASS_HIERARCHY_REVIEW_NOTE_2026-04-17.md))
   for possible retained-status replacement once the 3-real PDG observational
   pin is no longer load-bearing.
...
- **Cross-validates:** the V_cb cross-sector bridge `Q_ℓ · α_s² = 4|V_cb|²`
  becomes eligible for retained-status re-audit once Q is retained via the
  Koide flagship lane
...
2. Should the Koide flagship lane be merged with this Lane 6, or kept as a
   dependency? (Current structure: keep separate; Koide is the ratios
...
5. Should the bounded charged-lepton package be re-audited for retained status
