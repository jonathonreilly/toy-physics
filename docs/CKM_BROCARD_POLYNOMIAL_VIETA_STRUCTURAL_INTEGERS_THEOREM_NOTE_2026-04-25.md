...
p_3  =  e_1 p_2 - e_2 p_1 + 3 e_3 =  N_pair^9 + N_pair^8 - 3 N_pair^7 N_color^2,
                                  =  512 + 256 - 3456  =  -2688,
                                  hmm let's recompute below.
```

Wait, let me recompute `p_3`. With `e_1 = 8, e_2 = -32, e_3 = -1152, p_1 = 8, p_2 = 128`:
...
In the runner I had `-2176`. Let me record this correctly.
...
= (Z/2Z)^2`, the **Klein 4-group**. The 4 roots are organised into
two orbits of size 2 each (each orbit is a complex-conjugate pair).
...
| V8 Galois | `(Z/2)³` action with Klein-4 image | recorded |
