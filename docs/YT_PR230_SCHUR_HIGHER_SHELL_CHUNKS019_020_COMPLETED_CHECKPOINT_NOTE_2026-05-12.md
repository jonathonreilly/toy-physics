# PR230 Higher-Shell Chunks019-020 Completed Checkpoint

**Status:** bounded-support / higher-shell Schur scalar-LSZ chunks019-020
completed-mode checkpoints passed; higher-shell support prefix now 20/63; no
closure
...
```yaml
actual_current_surface_status: bounded-support / higher-shell Schur scalar-LSZ chunks019-020 completed-mode checkpoints passed; higher-shell support prefix 20/63
...
Higher-shell chunks019-020 completed under the separate non-colliding roots:
...
- fixed seeds `2026057019` and `2026057020`;
...
- chunk019: `created_utc=2026-05-13T02:31:07Z`, seed `2026057019`,
  runtime `7477.202` seconds;
- chunk020: `created_utc=2026-05-13T02:30:58Z`, seed `2026057020`,
  runtime `7468.071` seconds.
...
no active higher-shell workers, and `planned_launch_chunk_indices=[21,22]` if
the support campaign continues.

## Boundary

Chunks019-020 are higher-shell support rows only. They extend the completed
higher-shell prefix to 20/63 planned chunks, but this is not a complete
...
python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 19 \
  --output outputs/yt_pr230_schur_higher_shell_chunk019_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0

python3 scripts/frontier_yt_pr230_schur_higher_shell_chunk_checkpoint.py \
  --chunk-index 20 \
  --output outputs/yt_pr230_schur_higher_shell_chunk020_checkpoint_2026-05-12.json
# SUMMARY: PASS=15 FAIL=0
