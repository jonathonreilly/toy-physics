...
| joint Feynman-Hellmann / scalar-LSZ chunk combiner gate | requires all 63 L12 chunks to be production phase with run-control provenance, unique chunk artifact dirs, and same-source FH/LSZ observables; two chunks are present/ready, so this remains an acceptance gate only |
| joint Feynman-Hellmann / scalar-LSZ chunk001 production checkpoint | one L12 production-phase chunk is present and combiner-ready, but no combined L12, L16/L24, pole derivative, model-class, or FV/IR certificate exists |
| joint Feynman-Hellmann / scalar-LSZ chunk002 production checkpoint | a second L12 production-phase chunk is present and combiner-ready, but no combined L12, L16/L24, pole derivative, model-class, or FV/IR certificate exists |
