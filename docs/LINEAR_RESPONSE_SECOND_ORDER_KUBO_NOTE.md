...
explicitly audited." The audit verdict is terminal under
...
lands, this row remains `audited_conditional` and the safe read is
the second-order replay (computed §Result) plus the three structural
