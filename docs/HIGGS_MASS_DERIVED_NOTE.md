...
For the current branch central input `y_t(v) = 0.918`, the full 3-loop Higgs
runner gives:
...
- the branch now contains a direct full 3-loop Higgs computation with no
...
- this note
- [scripts/frontier_higgs_mass_full_3loop.py](../scripts/frontier_higgs_mass_full_3loop.py)
- the minimum supporting mechanism notes needed to defend the claim boundary
