...
algebraic core of `NEUTRINO_DIRAC_Z3_SUPPORT_TRICHOTOMY_NOTE`.
...
`NEUTRINO_DIRAC_Z3_SUPPORT_TRICHOTOMY_NOTE` bundles this
...
In the parent note's narrowed scope, all three are explicitly
admitted-context. The parent applies the abstract trichotomy to
