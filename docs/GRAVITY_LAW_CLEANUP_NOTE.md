...
**Primary runner (load-bearing):** [`scripts/gravity_distance_fixed_geometry.py`](../scripts/gravity_distance_fixed_geometry.py) (fixed-geometry generated-DAG distance sweep).
**Primary runner cached log:** [`logs/runner-cache/gravity_distance_fixed_geometry.txt`](../logs/runner-cache/gravity_distance_fixed_geometry.txt) — SHA-pinned cache that backs every load-bearing row in the "Retained result (primary runner)" section below.
...
- script: [`scripts/gravity_mass_scaling_fixed_anchor.py`](../scripts/gravity_mass_scaling_fixed_anchor.py)
...
- script: [`scripts/gravity_distance_channel_observables.py`](../scripts/gravity_distance_channel_observables.py)
...
What is retained from the registered primary runner:
...
What is NOT retained from the registered primary runner:
