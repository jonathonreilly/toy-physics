...
- Observable: lock-in quadrature, phase lag, or a spatial phase ramp in a
...
- Why it might fail: the platform may only reproduce the null, or the
  phase-ramp mapping may be too indirect
...
- Why it might fail: graph transport may remain too easy to distort and fail to
  isolate the retained weak-field law

## 3. Mechanical or Acoustic Front-End for Frontier Transport
...
- Why it could raise external interest: it converts a bounded transport
  ...
  gravity
- Why it might fail: the signal may remain just amplitude loss with no sharper
  frontier observable
...
- Why it might fail: the loop can be too unstable, too small, or dominated by
  topology-induced attenuation

## 5. Frequency / Separation Scaling as an Analog Sensor Card
...
1. Interferometric / waveguide phase-ramp analog
2. Graph-transport analog with tunable coupling
3. Frequency / separation scaling as an analog sensor card
4. Self-consistent feedback analog in a cavity or circuit
