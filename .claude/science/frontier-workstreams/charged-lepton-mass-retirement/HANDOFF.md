...
Cycles 1-6 are complete. The cooperative lock script was unavailable in the
workstream environment, so the run is isolated on the dedicated science branch.
