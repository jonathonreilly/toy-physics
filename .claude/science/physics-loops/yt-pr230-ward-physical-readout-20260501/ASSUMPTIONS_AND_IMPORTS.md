...
| Two-source taste-radial chunks001-050 package | finite `C_ss/C_sx/C_xx` row packet | bounded support only | chunks047-050 are packaged; ready=50/63, combined_rows_written=false; active chunks051-052 are run-control only; finite rows remain non-closure until canonical `O_H`, strict source-Higgs pole rows, scalar-LSZ/FV/IR, W/Z, Schur pole, or neutral primitive authority passes |
