...
| Neutral primitive H3/H4 aperture at chunks001-052 | neutral primitive/rank-one route freshness guard | bounded support plus exact boundary | dynamic row-prefix guard now consumes ready=52/63; H1/H2 Z3 support and finite `C_sx/C_xx` rows do not supply H3 physical neutral transfer/off-diagonal generator authority or H4 source/canonical-Higgs coupling |
