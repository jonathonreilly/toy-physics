...
2. **Scalar-channel Bethe-Salpeter kernel theorem.** The source-bubble stretch
   and HS/RPA contact attempt show the exact next analytic object: derive the
   Wilson-staggered ladder kernel, eigenvalue crossing, and pole residue.
