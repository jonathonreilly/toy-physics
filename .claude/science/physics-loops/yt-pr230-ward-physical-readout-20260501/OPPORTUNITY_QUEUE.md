...
2026-05-02 update: seed-controlled FH/LSZ chunks001-008 are ready
(`8/63`
...
(`n=8`, `relative_stdev=0.9033`, `spread_ratio=5.4765`), so finite `dE/ds`
slopes from `8/63` chunks must remain scout/support only.
