...
```yaml
actual_current_surface_status: exact negative boundary / PR230 non-chunk cycle-25 post-cycle-24 main-audit-status-drift reopen guard: origin/main advanced again only on audit/effective-status surfaces and no listed same-surface artifact is present; positive closure remains open
