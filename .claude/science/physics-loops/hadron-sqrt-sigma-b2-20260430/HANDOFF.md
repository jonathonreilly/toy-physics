...
- the first eleven production intervals completed `L=8` with `1000/1000`
  JSONL records after `10239` sweeps and advanced `L=12` to `102/1000`
  JSONL records after `1250` sweeps. This is a stronger checkpoint, but it
