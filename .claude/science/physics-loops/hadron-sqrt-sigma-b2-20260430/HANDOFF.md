...
- the first eight production intervals completed `L=8` with `1000/1000`
  JSONL records after `10239` sweeps and started `L=12` with `24/1000`
  JSONL records after `450` sweeps. This is a stronger checkpoint, but it
