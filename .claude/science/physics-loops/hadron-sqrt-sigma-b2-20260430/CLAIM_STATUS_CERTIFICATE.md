...
- Production checkpoint evidence exists for `L=8` only: `395` records,
  plaquette `0.59501080 +/- 0.00010576`, and `chi22`
  `0.25396337 +/- 0.00215057`. This does not close B5 because `L=12`
