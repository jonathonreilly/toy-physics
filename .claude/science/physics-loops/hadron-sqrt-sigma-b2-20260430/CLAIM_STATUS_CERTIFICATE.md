...
- Production checkpoint evidence exists for `L=8` only: `259` records,
  plaquette `0.59537995 +/- 0.00013110`, and `chi22`
  `0.25029828 +/- 0.00276516`. This does not close B5 because `L=12`
