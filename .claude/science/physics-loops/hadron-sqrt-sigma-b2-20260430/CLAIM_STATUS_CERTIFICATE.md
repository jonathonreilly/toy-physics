...
- Production checkpoint evidence exists for `L=8` only: `950` records,
  plaquette `0.59442266 +/- 0.00006646`, and `chi22`
  `0.25736352 +/- 0.00136710`. This does not close B5 because `L=12`
