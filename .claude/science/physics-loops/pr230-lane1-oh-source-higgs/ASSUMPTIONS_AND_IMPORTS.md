...
- `H_unit` matrix-element readout or `yt_ward_identity`.
- `y_t_bare` or any definition of `y_t` through a bare matrix element.
- Observed top/yukawa/W/Z/`g2` values as selectors.
...
The current surface does not derive accepted action authority or
