...
1. **Neutral rank-one theorem.**
   ...
   pole, or canonical-Higgs identity.  Block52 adds common-window response
   support only.  Block53 reduces this route to one of three surviving roots:
   physical readout authorization, scalar pole/model-class/FV/IR authority, or
   canonical-Higgs identity / same-surface neutral-transfer authority.
...
5. **Strict source-Higgs pole rows.**
   ...
   chunks001-002 prefix.  Block53 says this path is no longer blocked by L12
   chunk completeness or response-side support; it is blocked by absent
...
6. **Same-source FH-LSZ invariant readout.**
   ...
   is not certified as canonical Higgs radial `O_H`.  Block53 packages this as
