...
## Current-Surface Blockers That Apply

- Source-only and taste-radial rows do not determine source-Higgs overlap.
...
- Complete L12 same-source FH-LSZ support is not positive PR230 closure: the
  ...
  radial `O_H`.
- Common-window response stability support is not physical top-Yukawa readout:
