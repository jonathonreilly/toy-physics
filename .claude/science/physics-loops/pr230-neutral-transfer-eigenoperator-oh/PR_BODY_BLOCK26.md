# [physics-loop] PR230 block26 post-block25 landed checkpoint - open

Block26 is a narrow post-block25 landed checkpoint for draft PR #230.

It verifies that the PR head moved from `a864e5fe` to `8b0d95db` only by the
block25 landed checkpoint commit.  No new source-Higgs, W/Z, or neutral H3/H4
production/certificate packet landed, so no ranked route is currently
admitted.
