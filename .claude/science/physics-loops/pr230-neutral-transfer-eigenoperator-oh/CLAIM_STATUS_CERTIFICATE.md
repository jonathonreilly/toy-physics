...
Current block: `block79_schur_higher_shell_chunks045_046_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block79 higher-shell Schur scalar-LSZ chunks045-046 launched; completed higher-shell support prefix remains 44/63; no retained/proposed_retained closure
