...
Current block: `block93_schur_higher_shell_chunks059_060_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block93 higher-shell Schur scalar-LSZ chunks059-060 launched; completed higher-shell support prefix remains 58/63; no retained/proposed_retained closure
