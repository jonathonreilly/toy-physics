...
Current block: `block71_schur_higher_shell_chunks037_038_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block71 higher-shell Schur scalar-LSZ chunks037-038 launched; completed higher-shell support prefix remains 36/63; no retained/proposed_retained closure
