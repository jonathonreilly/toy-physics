...
Current block: `block73_schur_higher_shell_chunks039_040_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block73 higher-shell Schur scalar-LSZ chunks039-040 launched; completed higher-shell support prefix remains 38/63; no retained/proposed_retained closure
