...
Current block: `block74_schur_higher_shell_chunks039_040_completed_checkpoint`.

```yaml
actual_current_surface_status: bounded-support / block74 higher-shell Schur scalar-LSZ chunks039-040 completed-mode checkpoints passed; completed higher-shell support prefix 40/63; no retained/proposed_retained closure
...
proposal_allowed_reason: "Block74 is bounded support only, not a retained/proposed-retained theorem. Chunks039-040 completed and their completed-mode checkpoints pass, but the 40/63 higher-shell prefix is not a complete higher-shell packet and does not supply canonical O_H, strict C_sH/C_HH pole rows, Schur A/B/C kernel rows, scalar-LSZ/FV/IR authority, W/Z response rows, strict g2, matched covariance, physical kappa_s, or aggregate retained-route approval."
