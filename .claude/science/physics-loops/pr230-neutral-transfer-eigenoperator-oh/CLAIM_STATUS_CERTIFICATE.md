...
Current block: `block95_schur_higher_shell_chunks061_062_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block95 higher-shell Schur scalar-LSZ chunks061-062 launched; completed higher-shell support prefix remains 60/63; no retained/proposed_retained closure
