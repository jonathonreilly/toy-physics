...
Current block: `block94_schur_higher_shell_chunks059_060_completed_checkpoint`.

```yaml
actual_current_surface_status: bounded-support / block94 higher-shell Schur scalar-LSZ chunks059-060 completed-mode checkpoints passed; completed higher-shell support prefix 60/63; no retained/proposed_retained closure
...
proposal_allowed_reason: "Block94 is bounded support only, not a retained/proposed-retained theorem. Chunks059-060 completed-mode checkpoints pass, but the 60/63 higher-shell prefix is not a complete higher-shell packet and the rows remain same-source C_ss plus taste-radial C_sx/C_xx support. They do not supply canonical O_H, strict C_sH/C_HH pole rows, Schur A/B/C kernel rows, scalar-LSZ/FV/IR authority, W/Z response rows, strict g2, matched covariance, physical kappa_s, or aggregate retained-route approval."
