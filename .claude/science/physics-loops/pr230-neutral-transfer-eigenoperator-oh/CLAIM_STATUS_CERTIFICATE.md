...
Current block: `block83_schur_higher_shell_chunks049_050_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block83 higher-shell Schur scalar-LSZ chunks049-050 launched; completed higher-shell support prefix remains 48/63; no retained/proposed_retained closure
