...
Current block: `block91_schur_higher_shell_chunks057_058_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block91 higher-shell Schur scalar-LSZ chunks057-058 launched; completed higher-shell support prefix remains 56/63; no retained/proposed_retained closure
