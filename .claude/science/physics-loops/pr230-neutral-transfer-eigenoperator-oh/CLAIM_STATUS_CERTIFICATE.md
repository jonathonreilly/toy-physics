...
Current block: `block85_schur_higher_shell_chunks051_052_launch_checkpoint`.

```yaml
actual_current_surface_status: run-control support / block85 higher-shell Schur scalar-LSZ chunks051-052 launched; completed higher-shell support prefix remains 50/63; no retained/proposed_retained closure
