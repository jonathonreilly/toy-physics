...
Current block: `block70_schur_higher_shell_chunks035_036_completed_checkpoint`.

```yaml
actual_current_surface_status: bounded-support / block70 higher-shell Schur scalar-LSZ chunks035-036 completed-mode checkpoints passed; completed higher-shell support prefix now 36/63; no retained/proposed_retained closure
...
proposal_allowed_reason: "Block70 is bounded higher-shell support only, not a retained/proposed-retained theorem. Chunks035-036 completed-mode checkpoints pass and row/volume artifacts are present, but the 36/63 prefix is not a complete higher-shell packet and does not supply canonical O_H, strict C_sH/C_HH pole rows, Schur A/B/C kernel rows, scalar-LSZ/FV/IR authority, W/Z response rows, strict g2, matched covariance, physical kappa_s, or aggregate retained-route approval."
