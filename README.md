...
- whether the now-confirmed exhausted-wall repair is best stated as one four-incident flank hinge that restores a local vertical flank ladder plus two inward bridge-bridge closures, rather than as a raw `(-1, 0)` coordinate fact
