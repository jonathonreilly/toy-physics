...
- Uses bounded-memory summary passes for the deterministic, cross-weight, and random perturbation ensembles so the selector-free perturbation diagnostics can run without materializing every case row at once.
