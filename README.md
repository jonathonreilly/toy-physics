...
- The frontier reporting is now split three ways in the script: a case-level overview, a motif-frequency aggregate across both families, and a hard-case trace for the fallback/rescue motifs. That makes it possible to talk about selector-invariant motifs separately from selector-dependent winners.
