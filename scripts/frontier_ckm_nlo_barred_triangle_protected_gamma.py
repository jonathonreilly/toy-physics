...
The protected-gamma identity gamma_bar = gamma_0 = arctan(sqrt(5)) at NLO is
the new structural invariant. Numerical NLO predictions land within
2.2 sigma of all PDG bands without any free parameter; gamma_bar matches
PDG at 0.13 sigma.
"""
