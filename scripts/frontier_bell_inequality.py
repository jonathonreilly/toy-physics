...
def print_summary(pauli_ok, gs_results, dyn_results, results_3d):
    ...
    print(f"  Hilbert space: C^N x C^N (two distinguishable fermion species)")
    ...
    print(f"  distinguishable fermion species carrying explicit Cl(3) taste operators.")
...
def main():
    ...
    print("Two distinguishable fermion species on C^N x C^N tensor product")
