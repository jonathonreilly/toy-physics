#!/usr/bin/env python3
"""Test whether any tiny non-high-degree add-back closes the compact sparse-route gap."""
...
def main() -> None:
    ...
    print(f"compact nonhub bridge analysis started {started}", flush=True)
    total_start = time.time()

    rows = []
    addback_sets = compact_nonhub_bridge_sets()
    ...
    print()
    print("Compact Nonhub Bridge Detail")
    print("============================")
    print(render_compact_sparse_bridge_table(rows))
    print()
    print(
        "compact nonhub bridge analysis completed "
