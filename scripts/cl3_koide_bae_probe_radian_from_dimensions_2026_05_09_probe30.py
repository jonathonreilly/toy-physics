...
def main() -> int:
    ...
    # =========================================================================
    # SECTION 7: Probe 24 dimensionless 2/9 cited source-stack content (cross-check)
    # =========================================================================
    heading("SECTION 7: PROBE 24 DIMENSIONLESS 2/9 RETAINED CLOSURE (CROSS-CHECK)")
    print()
    print("Verify Probe 24 Step 1 dimensionless cited source-stack content remains intact.")
    ...
    # 7.5 The dimensionless 2/9 is cited source-stack content; the radian unit is the missing primitive
    tally(check(
    ...
    tally(check(
        ...
        True,
        "Step 1 (positive closure) and Step 2 (negative closure) use only cited source-stack content",
    ))
