...
def main() -> int:
    ...
    print("  On the actual physical first branch, AXIOM E's retained input")
    print("      delta = 2/9")
    print("  (identified geometrically with a Pancharatnam-Berry holonomy on the")
    print("  physical selected route) combines with the exact scalar-phase bridge")
