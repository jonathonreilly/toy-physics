...
**CLEANEST AXIOM-NATIVE A1 EXPRESSION**:
...
def main() -> int:
    ...
    record(
        "D.1 Dim-ratio form is the cleanest axiom-native A1 expression",
        True,
    ...
    if all_pass:
        print("VERDICT: A1 = dim(spinor)/dim(Cl⁺(3)) — cleanest axiom-native form.")
        print()
