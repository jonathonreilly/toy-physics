...
Verifies on abstract compact-group Wilson kernels:
  ...
  Negative-control counterexample: with U_t != 1 (no temporal gauge), the
...
# ----------------------------------------------------------------------------
section("Negative-control counterexample: WITHOUT temporal-gauge spatial-link factorization, marked/non-marked compression fails")
# ----------------------------------------------------------------------------
