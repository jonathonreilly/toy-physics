...
p6_direct = Jp_w/J_w
print(f"\n*** ⟨P⟩_1(β=6) = {p6_direct:.12f} (direct integration, Ng=1200)")
if abs(p6_direct - 0.422531739650) < 5e-10:
    pass_count += 1
else:
    fail_count += 1
...
for N in range(2, 12):
    ...
    print(f"  a_{N+1} = {a[-1]}")
if a[3] == Rational(1, 648) and a[4] == Rational(1, 2592):
    pass_count += 1
else:
    fail_count += 1
