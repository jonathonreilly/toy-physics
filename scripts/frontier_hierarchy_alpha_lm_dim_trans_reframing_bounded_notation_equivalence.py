...
notation-equivalence packet:
  ...
  T6  Substrate input for the ln(1/alpha_LM) factor (no axiomatic
      substrate identification within the listed primitives).
...
def t6_substrate_input_for_log() -> bool:
    ...
    print("  is substantive content. The listed primitives (Cl(3), Z^3,")
    ...
    return _assert(is_unmatched, "T6: ln(1/alpha_LM) has no substrate-primitive identification within the listed primitives")
...
def main() -> int:
    ...
    print("  not identified within the listed primitives. The reframing does NOT upgrade")
