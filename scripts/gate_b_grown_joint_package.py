#!/usr/bin/env python3
"""Gate B grown-geometry joint package harness.

Freezes the bounded Born / d_TV / MI / decoherence comparison between:
- exact grid geometry
- grown geometry at the retained moderate-drift row
- noisier grown geometry as a stress row

This is a companion to gate_b_farfield_harness.py and gate_b_grown_distance_law.py.
"""
...
def main():
    t0 = time.time()
    print("=" * 74)
    print("GATE B GROWN-GEOMETRY JOINT PACKAGE HARNESS")
    print("  Born / d_TV / MI / decoherence on exact vs grown geometry")
    print("=" * 74)
    ...
    print("  This harness freezes the joint interference/decoherence comparison only.")
    print("  Promote the moderate-drift row if it stays close to the exact grid.")
    print("  Treat the noisier row as a stress test, not as the retained generated-geometry package.")
