#!/usr/bin/env python3
"""
Koide Z³ scalar potential — selected-slice support
==================================================

STATUS: Z³-forced scalar potential V(m) derived exactly on the selected
        slice; cubic coupling pinned by Clifford trace identity; honest gap
        between the Clifford-fixed V_eff minimum and the physical selected
        point flagged
...
Purpose:
  ...
  7. Scale check: slot values at m_* match PDG sqrt(mass) to 0.03%
