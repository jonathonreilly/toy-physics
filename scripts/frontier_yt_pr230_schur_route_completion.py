...
def main() -> int:
    ...
    report("neutral-kernel-basis-or-rows-absent", neutral_basis_absent, str(futures))
    ...
    result = {
        "actual_current_surface_status": "exact negative boundary / Schur A/B/C route not complete on current PR230 surface",
        ...
        "proposal_allowed_reason": "Schur sufficiency is exact support, but current PR230 has no neutral kernel basis, source/orthogonal projector, A/B/C rows, or derivatives.",
        ...
        "exact_next_action": "Move to neutral primitive/rank-one theorem or supply actual Schur row artifacts.",
