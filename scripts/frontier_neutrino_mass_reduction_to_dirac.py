...
def current_atlas_gap_check() -> None:
    ...
    check("The atlas now carries the retained three-generation Majorana zero boundary", has_majorana_row)
    check("The atlas also carries the admitted Higgs / CW electroweak-scalar lane", has_higgs_row)
    check("The atlas now records the reduction of neutrino-mass closure to the Dirac lane", has_dirac_reduction_row)
