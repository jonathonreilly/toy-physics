...
SCIENCE_ONLY_BRANCH = not (
    ROOT / "docs/publication/ci3_z3/NEUTRINO_DIRAC_PMNS_BOUNDARY_PACKET_2026-04-15.md"
).exists()
...
def current_atlas_gap_check() -> None:
    ...
    has_higgs_row = "| Higgs / CW mass lane |" in atlas
    ...
    integration_check("The atlas also carries the admitted Higgs / CW electroweak-scalar lane", has_higgs_row)
