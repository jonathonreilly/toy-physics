...
def section_6_retained_polynomial_closure_step() -> tuple[int, int]:
    ...
    derived from retained content. Since Sections 3-5 show
...
def section_7_verdict() -> tuple[int, int]:
    ...
    # The probe uses only retained content:
