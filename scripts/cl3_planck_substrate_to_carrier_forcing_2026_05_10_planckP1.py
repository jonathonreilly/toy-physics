...
This runner verifies the bounded theorem that the cited RP positivity
...
def main() -> int:
    ...
    print("=" * 78)
    print()
    print("Question: does the cited RP positivity bilinear single out P_A")
    ...
    # factorization (a degree-3 one). The cited RP note (parent) only carries
    ...
    if n_fail == 0:
        print()
        print("Verdict: BOUNDED PASS. The cited RP positivity bilinear, applied")
        ...
        print("carrier forcing support, distinct from the prior link-local first-variation")
