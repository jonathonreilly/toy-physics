...
def main():
    ...
    if n_fail == 0:
        ...
        print("does not close independently of the gravity content's retained-grade")
        print("status: even a fully-retained GRAVITY_CLEAN_DERIVATION would not by")
        print("itself close A1 because barriers G1, G3, G4, G5 are independent of audit")
        print("status.")
        return 0
    else:
        print()
