...
No PDG observed values, no fitted selectors, no admitted unit
...
print("""
  ...
  Audit-lane class:
    ...
    source-note classification documentation (Facts A2, A3). No PDG
    observed values, no fitted selectors, no admitted unit conventions
