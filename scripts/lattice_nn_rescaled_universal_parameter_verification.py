...
This runner converts those theorems into a harness-parameterized
universal theorem by:
...
def run_parameter_point(label: str, p: HarnessParams,
    ...
    # saddle terms identified in #1003/#1027/#1028).
...
def main() -> int:
    ...
    if all_C_arm_per_h_ok and all_c2_ok:
        print("POSITIVE THEOREM: the closed-form predictions")
        print()
        ...
        print()
        print("The bridge can be promoted from 'harness-specific theorem'")
        print("at canonical (BETA=0.8, K_PHYS=5, FANOUT=3, L=40) to")
        print("'harness-parameterized universal theorem' over the tested")
