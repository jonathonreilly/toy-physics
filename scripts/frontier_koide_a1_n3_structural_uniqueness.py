...
This supports A1 CONDITIONAL on:
...
def main() -> int:
    ...
    if all_pass:
        print("VERDICT: n=3 structural-convergence support for A1 documented.")
        print()
        ...
        print()
        print("Therefore A1 (Koide Q = 2/3) has unusually strong n = 3 support")
        print("across several formula families, but the physical/source-law bridge")
        print("still has to identify which law nature actually realizes.")
    else:
