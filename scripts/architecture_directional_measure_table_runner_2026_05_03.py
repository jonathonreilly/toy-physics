...
Review-loop repair runner for `docs/ARCHITECTURE_NOTE_DIRECTIONAL_MEASURE.md`.
The 2026-05-03 review follow-up identified that the note's empirical
...
an EMPIRICAL model parameter on the current A1+A2 primitive core plus the
named directional-measure constraints. The
...
BETA_GRAVITY_CARD = 0.8  # the empirical value identified by review
PASS = 0
FAIL = 0
...
def beta_provenance_summary():
    ...
    print("    is NOT uniquely determined by the current A1+A2 primitive core")
    print("    plus the named directional-measure constraints:")
    ...
    print("    premises or closure routes: higher-order isotropy, action-Lagrangian")
    print("    principle, or direct observable matching. The current beta = 0.8 is route (3),")
...
def main() -> int:
    ...
    print(" Review-loop repair runner for ARCHITECTURE_NOTE_DIRECTIONAL_MEASURE")
    print("=" * 80)
