#!/usr/bin/env python3
"""Gravitational wave detection: oscillating source frequency-dependent phase.

Full executable replay harness.

An oscillating source z(layer) = z0 + A*sin(2*pi*f*layer*H) produces
a detector phase that depends on f. Reference: f=0 (static source).

No static field of any shape can produce frequency-dependent phase.
This is the first truly irreducible dynamic observable in the project.
"""
