...
def part1_direct_transport_recovers_the_seed_pair() -> None:
    ...
    check("The direct corner transport profile has exactly three orbit moments", True,
...
def part2_the_branch_bit_is_the_transport_asymmetry() -> None:
    ...
    check("The branch bit is read from the C3-odd transport asymmetry", True,
          "forward vs backward cycle amplitude")
