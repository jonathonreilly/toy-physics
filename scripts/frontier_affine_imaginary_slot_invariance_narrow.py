...
(claim_type=positive_theorem, audit_status=audited_conditional, td=130,
load_bearing_step_class=A). The narrow theorem isolates the affine-map
imaginary-slot-invariance algebra from any DM-neutrino source-surface
upstream framing.
"""
...
parent = ledger['rows'].get('dm_neutrino_source_surface_active_affine_point_selection_boundary_note_2026-04-16', {})
...
check("parent row class-A load-bearing step (Hermitian-matrix algebra)",
