...
def part_e_non_circularity_audit() -> None:
    ...
    print("    - companion native-gauge FAMILY UNIQUENESS theorem (2026-04-17):")
    print("      under admissibility conditions (A1)-(A5), V_n is FORCED to")
    print("      equal Lambda^2(R^n) uniquely — not just admissibly.")
    print("      Proper bivector subsets are ruled out by O(n)-irreducibility")
    print("      of Lambda^2(R^n) (Part B commutant dim = 1 for n in {2..7}).")
    print("      Arbitrary-n Gamma_k derived from framework graph/eta-phase")
    print("      rules on Z^n, not textbook Clifford machinery.")
    print("      Verified by scripts/frontier_native_gauge_family_uniqueness.py.")
...
def main() -> int:
    ...
    print("  scope/uniqueness/admissibility-closure/Recipe-R forcing notes,")
    print("  the Clifford dimension satisfies spin(n) = su(2), which by")
    print("  dimensional matching has unique positive-integer solution n = 3.")
    print("  This derivation uses only Clifford-bivector counting and Lie-")
    print("  algebra dimension, with no cubic Z^3 orbit, no hw-orbit semantics,")
    print("  and no SM matter content.")
    print()
    print("  With the 2026-04-17 admissibility closure + 2026-04-18 v3")
    print("  Recipe-R forcing theorem (Part H derives (R3) from retained n=3")
    print("  + graph-Z^n B_n-symmetry + Lambda^2(R^n) B_n-irreducibility),")
    print("  the admissibility package (A1)-(A5) and Recipe-R are both on")
    print("  retained + axiomatic footing. The tightness theorem is therefore")
    print("  a retained-grade replacement of the d_s = 3 primitive under the")
    print("  retained n=3 native-gauge authority + Z^n lattice axiom + weak-")
    print("  SU(2) observational input.")
    print("=" * 72)
