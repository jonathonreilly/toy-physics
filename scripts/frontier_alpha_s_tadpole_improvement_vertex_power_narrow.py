...
no PDG comparator, no running bridge to M_Z, and no choice of
...
check("runner does not consume the SM running bridge to M_Z",
      ...
      detail="theorem is purely algebraic in (alpha_bare, u_0); no v -> M_Z"
             " transfer, no quark-mass thresholds, no PDG comparators")
...
print("""
  ...
  Audit-lane class:
    ...
    beta = 6 normalization, no PDG comparator, no running bridge to
