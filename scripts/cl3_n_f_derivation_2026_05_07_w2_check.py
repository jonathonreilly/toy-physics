...
Companion runner for `docs/N_F_BOUNDED_Z2_REDUCTION_THEOREM_NOTE_2026-05-07_w2.md`.

Tests the finite algebraic attack surface recorded in the source note and
records the structural facts that pin (or do not pin) the canonical
...
def main():
    ...
    print("\nAttack vectors checked by the source-note runner:")
    ...
    print("is not closed by this analysis. See the source note for full discussion.")
