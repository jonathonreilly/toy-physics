...
`ckm_atlas_axiom_closure_note` (parent row) via the narrow theorem
`CKM_ATLAS_AXIOM_CLOSURE_NARROW_THEOREM_NOTE_2026-05-10.md`.
...
def main() -> int:
    ...
    print("ckm_atlas_axiom_closure_note")
