...
def main() -> None:
    ...
    # ------------------ TEST 17: G1 bounded scope after CW derivation -----------
    print("-" * 78)
    print("TEST 17: G1 bounded scope after explicit CW derivation")
    print("-" * 78)
    g1_cw_status = "explicit_wilson_link_gauge_insertion_derivation"
    g1_dynamical_status = "bounded_support_via_wilson_link_cw"
    print(f"  g1_cw_residual_status = {g1_cw_status}")
    print(f"  g1_dynamical_status   = {g1_dynamical_status}")
    print("  G1 publication-facing status remains audit-owned")
    t17 = True
    ...
    tests = [
        ...
        (17, "G1 bounded support: explicit CW derivation supplied", t17),
    ]
