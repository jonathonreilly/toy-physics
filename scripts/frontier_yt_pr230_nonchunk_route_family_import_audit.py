...
def family_rows(worklist: dict[str, Any]) -> list[dict[str, Any]]:
    return [
        ...
        },
        {
            ...
            "dramatic_step_score": 2,
            "hard_residual_pressure": 2,
            "current_disposition": "blocked; existing gates are contracts and negative shortcut boundaries",
            "retirement_path": "produce matched rows or prove a same-surface product/covariance theorem",
        },
        {
