#!/usr/bin/env python3
"""Source-resolved Green scaling probe on a larger exact lattice.

This is the size-transfer companion to the small exact Green pocket.
It keeps the same source-resolved kernel and the same weak-field gates,
but moves to a larger exact lattice family to check whether the pocket
survives beyond the smallest feasibility case.
"""
...
def main() -> None:
    ...
    print("=" * 84)
    print("SOURCE-RESOLVED EXACT GREEN SCALING")
    print("  larger exact lattice, source-resolved Green-like field")
    ...
    print("  this is a larger exact-lattice size-transfer positive, not yet a full theory")
