...
deterministically:
  ...
  O1: blocking is non-perturbative (cumulative 1-loop expansion
      parameter 2.594 exceeds starting 1/g^2 = 0.878 — retained P2
      taste-staircase beta-function NO-GO authority).
...
This runner is class A: each obstruction is verified from elementary
algebra or from a single retained framework authority. No PDG / observed
input is consumed.
...
# ============================================================================
section("Setup: retained constants from PLAQUETTE_SELF_CONSISTENCY_NOTE.md")
# ============================================================================
# Canonical-surface anchors (bounded, retained):
#   <P>        = 0.5934
#   u_0        = <P>^(1/4) = 0.87768
...
check(
    "alpha_LM matches retained 0.09067 within 1e-4",
    abs(alpha_LM - 0.09067) < 1e-4,
    detail=f"alpha_LM = {alpha_LM:.5f}",
)
check(
    "g_s(M_Pl)_lat matches retained 1.067 within 1e-3",
...
# ============================================================================
section(
    "Obstruction O1: blocking is non-perturbative (retained P2 NO-GO authority)"
)
...
check(
    "Cumulative 1-loop parameter ~ 2.594 (retained P2 NO-GO eq. (7.1))",
...
# ============================================================================
section("Cross-check vs PR #1099 external narrow theorem note")
...
print(f"  Obstructions O1 (non-perturbative blocking, retained P2 authority),")
