#!/usr/bin/env python3
"""Koide Z_3-equivariant anti-commuting operator disjointness check.
...
Scope-narrow observation: a Yukawa Dirac off-diagonal block, if forced
to be Z_3-equivariant and also identified to anti-commute with Γ_χ on
the same 3-generation triplet, must be zero. Standard multi-factor
Connes-Lott constructions are not addressed.
...
def main() -> int:
    print("=" * 78)
    print("KOIDE Z_3-EQUIVARIANT ANTI-COMMUTING OPERATOR DISJOINTNESS RUNNER")
    print("=" * 78)
    ...
    print("VERDICT:")
    if FAIL_COUNT == 0:
        print("  ALGEBRAIC DISJOINTNESS VERIFIED — Z_3-equivariance + {·,Γ_χ}=0 forces H=0")
