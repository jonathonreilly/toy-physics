...
def main() -> int:
    ...
    record(
        "D.2 Closure chain complete: δ = 2/9 forced, not selected",
        True,
        "The value δ = 2/9 follows from:\n"
        ...
        "All three are retained or textbook. No observational tuning.",
    )
    ...
    if all_pass:
        ...
        print()
        print("The identification δ = 2/9 for the charged-lepton sector is therefore")
        print("structurally forced, not value-of-η selected.")
    else:
