...
- it treats the current support hypotheses as established support
...
print("=" * 78)
print()
print("Test whether the current support hypotheses force the viable bridge into the same")
...
if intrinsic_uv and len(outside_intrinsic) == 0:
    print(
        "Within the scanned constructive family, once the current support hypotheses are"
