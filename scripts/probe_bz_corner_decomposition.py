...
the retained M_3(C) translation character structure.
...
def main() -> int:
    ...
    print(f"   (matches THREE_GENERATION_OBSERVABLE_THEOREM_NOTE retained, order-agnostic)")
    ...
    # M_3(C) generation: translations + C_3 generate M_3(C) (retained)
    ...
    print("  full M_3(C) closure retained per THREE_GENERATION_OBSERVABLE_THEOREM_NOTE")
    print()
    ...
    print()
    print("Theorem (T3) — BZ-corner three-generation forcing — verified.")
    print("Staggered-Dirac on Z^3 APBC has unique 1+3+3+1 BZ-corner")
    print("decomposition by Hamming weight; hw=1 triplet has retained")
    print("M_3(C) algebra structure matching THREE_GENERATION_OBSERVABLE_THEOREM.")
