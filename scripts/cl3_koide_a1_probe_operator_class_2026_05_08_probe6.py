...
def section8_obstruction_theorem():
    ...
    print()
    print("       VERDICT: The Brannen ansatz IS the right operator class")
    print("       for stating A1 — but A1 itself remains unforced from")
    print("       retained content. The 'wrong operator class' hypothesis")
    print("       FAILS as a closure path. A1 admission count UNCHANGED.")
    print()
...
def main():
    ...
    if n_fail == 0:
        ...
        print("  NOT artifacts of the Hermitian sub-class; they reflect a")
        print("  structural absence of forcing principle for A1 in the entire")
        print("  retained C_3-equivariant operator landscape.")
        print()
