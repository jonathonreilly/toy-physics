...
Review-hygiene check, not a physics proof. Verifies that the synthesis:
  ...
  - records the 2 positive candidate results (m_τ Wilson chain, φ_dimensionless=2/9);
  - records the partial-falsification candidate (Probe 29: κ=1 vs κ=2);
  - records the structural impossibility claims (14, 17, 25+27+28);
...
def main() -> int:
    ...
    # ---- 2 positive candidate results recorded ----
    check(
    ...
    # ---- structural impossibility claims recorded ----
    check(
    ...
    check(
        ...
        or ("F1" in note and "structurally absent" in note),
    )

    # ---- partial-falsification candidate (Probe 29) recorded ----
    check(
    ...
    print(
        ...
        "all 30 probes cited, 2 positive candidate results recorded, "
        "structural impossibility claims recorded, "
        "partial-falsification candidate recorded, "
        "2 remaining admissions correctly counted, "
