...
def main():
    ...
    print("Theta-anti-invariant) does NOT break the symmetric half-square reflected")
    print("expectation's real non-negativity; the single-side diagnostic remains real.")
    print("This realises the")
