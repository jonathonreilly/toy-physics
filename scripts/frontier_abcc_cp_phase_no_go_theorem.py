...
STATUS: retained conditional theorem — under the physical hierarchy pairing
...
A-BCC is not yet a retained framework theorem — this runner does not derive
...
def main() -> int:
    ...
    print()
    print("  The A-BCC axiom is elevated from 'physically motivated' to")
    print("  'observationally grounded' by this theorem. It is not yet a retained")
    print("  Cl(3)/Z^3 theorem; closing A-BCC at the framework level (deriving it")
    print("  from the axiom without observational input) remains the last open item.")
    print()
