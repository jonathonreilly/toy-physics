...
def main():
    ...
    # This is the all-R bridge from the cubical-ball Phi-monotonicity
    # (Properties 2 and 2a) to the universal disk conclusion.
    print()
    print("=" * 70)
    ...
    # for every observed boundary vertex at R=2..6.  This certifies that
    # the cubical-ball link coincides with the combinatorial closure that
    # the exhaustive certificate analyses; together they constitute an
    # all-R proof.
    print()
    print("=" * 70)
