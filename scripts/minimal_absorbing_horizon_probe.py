#!/usr/bin/env python3
"""Minimal absorbing-horizon probe on the retained Gate B grown family.

Moonshot goal:
  test whether a tiny absorptive extension creates a genuine trapping / no-return
  threshold on the retained no-restore grown geometry family, while still
  reducing to the current weak-field far-field lane at alpha = 0.
...
def main() -> None:
    ...
    print("=" * 76)
    print("MINIMAL ABSORBING HORIZON PROBE")
    print("  absorptive trapping extension on the retained generated-geometry family")
    print("=" * 76)
    ...
    if threshold is None:
        ...
        print("  - That means this minimal horizon proxy is currently a bounded negative")
        print("    for a strong trapping transition.")
    else:
        print("SAFE READ")
