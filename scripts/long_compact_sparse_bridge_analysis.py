#!/usr/bin/env python3
"""Test minimal add-backs that bridge compact onto the sparse fallback route."""
...
def main() -> None:
    ...
    print(f"compact sparse bridge analysis started {started}", flush=True)
    ...
    print()
    print("Compact Sparse Bridge Detail")
    print("============================")
    print(render_compact_sparse_bridge_table(rows))
    print()
    print(
        "compact sparse bridge analysis completed "
