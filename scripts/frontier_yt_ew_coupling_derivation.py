#!/usr/bin/env python3
"""
EW Coupling Derivation: support scan for the promoted EW package
===============================================================

This script is a support scan, not the canonical package-card runner.
The promoted quantitative rows on `main` are carried by
`frontier_complete_prediction_chain.py` and
