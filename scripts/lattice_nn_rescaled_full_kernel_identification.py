...
positive identification. If any partial deviation appears, the runner
...
def slit_anchored_cross_check(per_ys_at_h: Dict[float, List[Dict]]) -> Dict:
    ...
    reported; the closer one identifies the load-bearing slit-
    anchoring physics.
...
def main() -> int:
    ...
    if all_pass:
        print("POSITIVE IDENTIFICATION: the rescaled NN harness's full kernel")
