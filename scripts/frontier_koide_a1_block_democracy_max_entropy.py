...
def main() -> int:
    ...
    record(
        "D.2 Adoption of block-democracy as a new retained primitive would close A1",
        True,
        "Under block-democracy max-entropy, A1 follows from the proposed\n"
        "primitive rather than from the current retained stack alone.\n"
    ...
    if all_pass:
        print("VERDICT: block-democracy max-entropy candidate for A1 documented.")
        print()
        ...
        print("made explicit. If that primitive is accepted, it yields A1.")
        print("Physical justification: Z_3 as flavor")
