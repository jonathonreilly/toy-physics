...
print("Inputs from the current package stack:")
print(f"  local selector y_loc                 = {LOCAL_SELECTOR_YT:.6f}")
print(f"  package target y_t(v)                = {TARGET_YT_PHYS:.6f}")
...
print("Package target proximity:")
...
print()
print("So the current package has a clean intrinsic endpoint-shift bound on the exact")
