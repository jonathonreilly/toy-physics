#!/usr/bin/env python3
"""
G1-the info-geometric selection obstruction: Information-Geometric Selector — Obstruction + Narrowed-Gap.

Branch: (off ).

This runner pursues the information-geometric attack vector on the remaining
selector gap of the selector doublet-block law. It does NOT close the selector.
...
Attack vector inputs (all atlas-native, already retained/theorem-grade):
 ...
 - DM_NEUTRINO_SOURCE_SURFACE_SCHUR_SCALAR_BASELINE_THEOREM_NOTE_2026-04-17.md
...
def part_d_narrowed_gap() -> None:
  ...
  Before this runner: the remaining the selector gap was a single missing ingredient
...
def print_summary() -> None:
  ...
  print(" the selector gate is NOT closed by this runner.")
  print(" DM flagship gate remains OPEN.")


def main() -> int:
  print("=" * 88)
  print("G1-the info-geometric selection obstruction: Information-Geometric Selector — OBSTRUCTION + NARROWED-GAP")
  print("=" * 88)
  print("Branch: ")
