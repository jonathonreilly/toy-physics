...
Class-A assertions verify the global and per-side exponents within
numerical tolerance, plus the all-ATTRACT-all-CLEAN claim.
...
def main() -> int:
    ...
    # Note's claims, with generous tolerance for stochastic per-config noise
    EXP_TOL = 0.20  # exponent tolerance: ~5% of typical -3.5
    R2_TOL = 0.02   # R^2 tolerance: should match to within 2%
