...
def section_9_synthesis(T3, T8):
    ...
    print("  framework's matter sector and must be imported from the relevant")
    print("  structure chains (CL3_COLOR_AUTOMORPHISM and per-site Hilbert dim 2).")
    print()
...
# =========================================================================
def main():
    section("Cl(3) N_F V_3 trace selection runner — w2-binary bridge check")
    ...
    print("  Under these imported, non-trivial identifications, V_3 trace selection")
    print("  is structurally supported by the joint V3+V5+V8 argument.")
    print()
    print("  Without the matter-sector bridge identification, the W2-prior")
    print("  binary admission {V_3, V} remains open.")
