...
that on the retained NLO Wolfenstein protected-gamma-bar surface
  ...
  lambda^2  = alpha_s / 2                  (retained Wolfenstein W1)

force the named Pythagorean sum rule

  (P1) R_b_bar^2 = rho_bar^2 + eta_bar^2 = (4 - alpha_s)^2 / 96  [retained N3]
...
sympy-based exact-symbolic verification:
  ...
  (b) imports retained (N1), (N2), (N3) and Wolfenstein W1 verbatim;
...
N1-N3, Wolfenstein W1, structural counts N_pair = 2, N_quark = 6) are
...
def main() -> int:
    ...
    print("parametric in alpha_s on the retained NLO protected-gamma-bar surface.")
    print("=" * 88)
