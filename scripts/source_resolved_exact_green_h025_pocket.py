#!/usr/bin/env python3
"""Source-resolved Green-pocket probe on the compact exact h=0.25 lattice.

Moonshot goal:
  Check whether the exact-lattice Green pocket survives one refinement-style
  exact family while preserving the weak-field lane with nontrivial amplitude.
...
The question is not whether the response exists. It is whether the refinement
family keeps the sign, the mass-scaling class, and enough amplitude to count as
a real refinement-positive pocket instead of a tiny exact-lattice fluke.
"""
...
def main() -> None:
    ...
    print("=" * 84)
    print("SOURCE-RESOLVED EXACT GREEN H025 POCKET")
    print("  compact exact h=0.25 refinement family, source-resolved Green-like field")
    ...
    print("  this is a compact h=0.25 refinement-positive pocket, not yet a full theory")
