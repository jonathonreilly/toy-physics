...
def main() -> int:
    ...
    print("\nBoundary:")
    print(
        "Given the displayed log-det generator and invariant background, the local "
        "Hessian is the inverse-metric supermetric normal form on symmetric `3+1` "
        "perturbations."
    )
    print(
        "This does not prove the scalar-generator selection premises or the exact "
        "Einstein/Regge dynamical gluing law."
    )
