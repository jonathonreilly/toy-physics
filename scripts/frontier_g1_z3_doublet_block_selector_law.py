...
Branch: claude/g1-z3-doublet-selector (off main).
...
What this runner explicitly does NOT do:
  ...
  - claim the full G1 law is closed
...
def part5_narrowed_gap() -> None:
    ...
    What is new after this runner:
      - the remaining G1 gap is reduced from the pair
    ...
    check(
        "The G1 gap has been strictly narrowed (baseline sub-objection closed)",
        True,
...
def main() -> int:
    ...
    print("=" * 88)
    print("Branch: claude/g1-z3-doublet-selector")
