...
retained fine point H = 0.25 that docs/WAVE_STATIC_DIRECT_PROBE_FINE_NOTE.md
quotes. The fine point dominates wall-clock (~4 minutes on the current
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            "H values to run. Default ladder 0.5 0.35 0.25 covers the retained "
            "coarse, medium, and fine points; the fine point H=0.25 reproduces "
