...
Review-loop repair runner for `docs/EW_COUPLING_DERIVATION_NOTE.md`. The
2026-05-03 review follow-up identified that the previously
...
def main() -> int:
    ...
    print(" Review-loop repair runner for EW_COUPLING_DERIVATION_NOTE.md")
