...
def part5_right_handed_charges(G5_4D, gammas_4D, P_L, P_R, taste_mats):
    ...
    print("  STEP 4: Anomaly cancellation uniquely fixes right-handed charges")
    print()
    ...
    print("    the five anomaly conditions UNIQUELY fix:")
...
def main():
    ...
    print()
    print("  5. ANOMALY CANCELLATION FIXES RIGHT-HANDED CHARGES (Part 5)")
    ...
    print("     U(1)_Y hypercharges of C^8_R are UNIQUELY fixed by the five")
    print("     anomaly conditions to give the SM right-handed content:")
    ...
    print("  uniquely determined by anomaly cancellation -- the same mechanism")
    print("  that fixes them in the Standard Model itself.")
