...
def part6_generic_family() -> None:
    ...
    print("  contributing a pair of Koide-satisfying eigenvectors. Combined,")
    print("  these eigenvectors trace out the Koide cone in R^3.")
...
def main() -> int:
    ...
    print("Koide. As h varies, these eigenvectors trace out the Koide cone.")
    print()
