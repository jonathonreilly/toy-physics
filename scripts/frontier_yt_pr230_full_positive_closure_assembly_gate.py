...
def main() -> int:
    ...
    z3_heat_kernel_source_coupling_blocks_h4 = (
        ...
        in statuses["pr230_z3_heat_kernel_source_coupling_no_go"]
        and certs["pr230_z3_heat_kernel_source_coupling_no_go"].get(
            "proposal_allowed"
        )
        is False
        and certs["pr230_z3_heat_kernel_source_coupling_no_go"].get(
    ...
    source_overlap_blocks = (
        ...
        and z3_heat_kernel_source_coupling_blocks_h4
