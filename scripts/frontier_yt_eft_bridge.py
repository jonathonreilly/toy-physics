#!/usr/bin/env python3
"""
This script supports the bounded backward-Ward bridge for the renormalized
y_t lane.
=======================================================================

ROLE:
  - support the current zero-import authority stack
  - show why the low-energy bridge is anchored at v
  - show why backward Ward transfer is the correct bounded bridge
  - show why the naive direct-EFT Ward alternative fails
...
ALPHA_BARE = CANONICAL_ALPHA_BARE    # g_bare = 1
