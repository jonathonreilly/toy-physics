#!/usr/bin/env python3
"""Targeted boundary probe for the second grown-family complex-action candidate.

This is the quick companion to the wider basin scan. It keeps the same guard
rails but narrows the drift window around the anchor row so we can get a fast
boundary read without waiting for the full sweep.
"""
...
def main() -> None:
    print("=" * 100)
    print("SECOND GROWN FAMILY COMPLEX TARGETED")
    ...
    print()
    print(
        f"{'drift':>5s} {'born':>10s} {'g0':>12s} {'d01':>12s} {'d05':>12s} "
    ...
    for drift in DRIFTS:
        ...
        print(
            ...
            f"{row.delta_01:+12.6e} {row.delta_05:+12.6e} "
