"""
Frontier runner — P3 Sylvester Linear-Path Signature Theorem.
...
This is the certifying evidence surface for the local theorem note
...
# ---------------------------------------------------------------------------
# Step 7 — Theorem-note minimum cross-check
# ---------------------------------------------------------------------------

check(
    "min p = 0.878309... (matches theorem note)",
    abs(min_val_num - 0.878309) < 0.001,
    f"min = {min_val_num:.6f}",
)
