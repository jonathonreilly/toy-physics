"""
SU(3) NNLO Convention C-iso support runner — extends the NLO closed-form
of [`scripts/cl3_c_iso_su3_nlo_2026_05_08_su3nlo.py`](cl3_c_iso_su3_nlo_2026_05_08_su3nlo.py)
with NNLO, NNNLO, and N4LO rational targets identified numerically.
...
This work identifies rational targets for the SU(3) Wilson single-plaquette
asymptotic at NNLO, NNNLO, and N4LO via mpmath high-precision Weyl integration
over the SU(3) Cartan torus. It does not provide the symbolic
Vandermonde-Gaussian derivation of those targets.

Key bounded support result (this work)
======================================
...
from the fitted rational targets.

Verification
============
1. Rational targets identified from mpmath fits at multiple large beta
   values (with mp.dps = 50-100):
     - c_2 = -1                     (matches PR #685 / 2026-05-08)
...
def main() -> int:
    ...
    print(f"\n=== SU(3) NNLO Convention C-iso Support ===")
    ...
    print("\n" + "=" * 76)
    print("SUPPORT SUMMARY — SU(3) NNLO Convention C-iso rational identification")
    print("=" * 76)
    print(f"\nWilson coefficient rational targets (THIS WORK extends NLO support to N5LO):")
    print(f"  c_2 (NLO)   = -1                  [retained from PR #685]")
    print(f"  c_3 (NNLO)  = -13/3 ≈ -4.3333..   [THIS WORK, numerical rational target]")
    print(f"  c_4 (NNNLO) = -37/2 = -18.5       [THIS WORK, numerical rational target]")
    print(f"  c_5 (N4LO)  = -3071/36 ≈ -85.31.. [THIS WORK, numerical rational target]")
    print(f"  c_6 (N5LO)  = -20873/48 ≈ -434.85 [THIS WORK, fit-limited target]")
