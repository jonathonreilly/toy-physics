...
gate:
    ...
    →
    matter measure must be Grassmann on the bounded support surface
...
def main() -> int:
    ...
    print()
    print("Bounded theorem (T1) — Grassmann Partition Forcing — verified via dependency chain.")
    ...
    print()
    print("Substep 1 has bounded source support; retained-grade use awaits")
    print("independent audit of S2 and the dependency chain.")
