...
Findings (mirrors hostile-review tone):
  ...
  P4.  PMNS via U_PMNS = U_e^dagger U_nu = U_nu (since U_e = I on the
       ...
       flat trimaximal magnitudes; in the standard PMNS angle extraction
       this means sin^2 theta_13 = 1/3 and sin^2 theta_12 = sin^2 theta_23 = 1/2.
       The observed angles are perturbations around this. Q_nu = 2/3 in
...
#
# This gives:
#   sin^2 theta_12 = (1/3)/(1 - 1/3) = 1/2 ~ 0.500
#   sin^2 theta_13 = 1/3 ~ 0.333  (much larger than observed 0.022!)
#   sin^2 theta_23 = (1/3)/(1 - 1/3) = 1/2 ~ 0.500
#
