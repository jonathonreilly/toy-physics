...
def main() -> int:
    ...
    check(
        ...
        effective_label not in note and effective_token not in note,
    )
    ...
    check(
        "reclassified at engineering-frontier level",
        "Convention C-iso" in note and "engineering" in note,
    )
    ...
    print(
        ...
        "Option C parameter targets are research frontiers, no new axiom."
    )
    return 0
