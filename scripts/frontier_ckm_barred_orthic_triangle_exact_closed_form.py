...
Key NEW identities on the retained NLO Wolfenstein protected-gamma_bar surface:
  ...
  (O1) ORTHIC TRIANGLE: triangle whose vertices are the three altitude
       ...
       triangle is inscribed in the nine-point circle (Feuerbach 1822).
  ...
  (O6) FEUERBACH CONNECTION: orthic triangle's circumcircle = nine-point
       circle of the original triangle (classical, verified retained-surface).
  ...
  (O8) Second LO-equivalent degeneracy at alpha_s = 4:
        At alpha_s = 4, (4 - alpha_s) = 0 and the original triangle itself
        degenerates (V_3 -> V_1). So orthic also degenerates.
...
def audit_o6_feuerbach_connection(N: dict, S: dict, vertices: dict) -> None:
    banner("O6: Feuerbach connection -- orthic-circumcircle = nine-point circle")
    ...
    print("  equals the original triangle's nine-point circle (Feuerbach 1822).")
...
def audit_o7_area_ratio(N: dict, S: dict, vertices: dict) -> None:
    ...
    print("                                =  N_pair^? alpha_s (N_pair^2 (N_quark - 1) + alpha_s)")
    print("                                   / (N_color (N_pair^4 (N_quark - 1) + alpha_s^2)).")


def audit_o8_double_degeneracy(N: dict, S: dict, vertices: dict) -> None:
    banner("O8: Second degeneracy at alpha_s = 4 (where (4 - alpha_s) = 0)")
    ...
    print("  The original triangle degenerates to a line segment.")
    print("  Orthic triangle also degenerates (all vertices on the x-axis).")
    ...
    check("O8: Area_orthic vanishes at alpha_s = 4 (second degeneracy locus)",
          area_at_4 == 0)
...
def audit_summary() -> None:
    ...
    print()
    print("    (O6) Feuerbach: orthic triangle's circumcircle = nine-point circle of")
    ...
    print()
    print("    (O8) Second degeneracy at alpha_s = 4:")
    print("           At alpha_s = 4, rho_bar = eta_bar = 0, so V_3 -> V_1 and the")
    print("           original triangle degenerates. Orthic also degenerates.")
...
def main() -> int:
    ...
    audit_o6_feuerbach_connection(N, S, vertices)
