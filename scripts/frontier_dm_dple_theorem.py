...
Theorem.  On the retained linear Hermitian pencil
...
selector reproduces the retained F4 condition on all four basins
{1, N, P, X}.  F4 is therefore demoted from axiom to theorem.
...
def main() -> int:
    print("=" * 72)
    print("  DPLE (Dim-Parametric log|det| Extremum) Theorem")
    print("=" * 72)
    task1_verify_degree()
    task2_cp_counts()
    task3_f3_equals_f4()
