...
# retained content equals alpha_LM^16.
# The retained content has only C_3-trivial scalar content: lambda_0 = lambda_1.
...
check("3.11 retained content forces lambda_0 = lambda_1 = alpha_LM^16",
...
print("  which is NOT in the retained content. The Wilson chain does")
...
print("  remains structurally compatible with hw=1 retained content")
