...
def section9_honest_closure_status():
    ...
    print("  spontaneous symmetry breaking, OR an explicitly approved")
    print("  new framework axiom. No new axiom is proposed here.")
    print()
    ...
    print("  (b) EXPLICITLY APPROVED NEW AXIOM (A3/AC_phi-lambda track)")
