...
load_bearing_step_class=A). The narrow theorem isolates the response-
master identity from any Koide / charged-lepton / observable-principle /
second-order-return framework framing.
"""
...
parent = ledger['rows'].get('koide_one_scalar_obstruction_triangulation_theorem_note_2026-04-18', {})
...
print("""
  ...
  obstruction conclusion still requires the upstream A1 retained
