...
def main():
    ...
    print("  3. The top-2 dominance grows with cut_x distance (sigma_0/sigma_2 ratio")
    print("     increases). Far from sources, only 2 modes survive significantly.")
    print("  4. With a 2-slit barrier, rank drops to exactly 2 (or near it),")
    print("     confirming the barrier enforces exact rank reduction.")
    print()
    ...
    print("  y-reflection symmetry decomposes M into parity sectors, and the")
    print("  edge-source/edge-sink modes at y = +/-height dominate due to")
    print("  exponential amplitude growth at the boundaries.")
    print()
    print("  The original 'rank 2' observation was likely due to:")
    print("  (a) Measuring rho_B = M @ M^dagger eigenvalues with a coarse threshold,")
    print("      where small singular values squared become negligible, OR")
    print("  (b) The two-slit barrier in the original experiment enforced exact rank 2.")
    print()
    print("  A 1-slit barrier gives rank 1 (single channel).")
    print("  A 2-slit barrier gives rank 2 (two channels).")
    print("  N slits give rank ~ N (each slit is an independent channel).")
    print()
