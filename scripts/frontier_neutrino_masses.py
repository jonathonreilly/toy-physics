...
Boundary note:
  This script is the bounded phenomenology lane. For the exact axiom-first
  classification of the bare quadratic Majorana operator, use
  frontier_neutrino_majorana_operator.py.
"""
