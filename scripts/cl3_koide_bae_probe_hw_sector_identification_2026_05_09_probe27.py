...
Tests whether retained content forces the charged-lepton sector to be at
hw=1 (current convention) versus hw=2 or hw=3 (alternative sectors), and
whether retained dynamics on each candidate hw=N gives F1 (BAE,
...
Expected verdict (by retained-content reasoning):
...
print("for N != 1, restoring F1 (BAE) under retained dynamics?")
print()
print("Background:")
...
# Check eigenvalues match retained content per THREE_GENERATION_OBSERVABLE_THEOREM
...
print("complementation (Test F). Therefore retained dynamics on either gives")
...
print("  (c) the projection is unique up to retained content")
...
print("  recover F1 (BAE) selection from retained dynamics:")
print()
...
print("          structure as hw=1, hence retained dynamics gives F3 there")
print("          as well.")
