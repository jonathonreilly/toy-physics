...
def measure_dm(h_val: float):
    ...
    h_early = solve_wave(nl, pw, h_val, S_PHYS, early, src_layer)
    h_late = solve_wave(nl, pw, h_val, S_PHYS, late, src_layer)
...
def main() -> int:
    ...
    parser.add_argument("--hs", type=float, nargs="*", default=[0.5], help="H values to probe. Default: 0.5")
