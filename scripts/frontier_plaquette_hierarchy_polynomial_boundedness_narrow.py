...
group, Haar measure, source-deformed partition function, physical Cl(3)
local algebra, or Z^3 spatial substrate input is consumed; the narrow
theorem treats p(t) as an abstract real polynomial.
"""
...
print("""
  ...
  Audit-lane class:
    ...
    physical Cl(3) local algebra / Z^3 spatial substrate input is consumed.
  ...
  reviewed independently of any lattice-gauge authority.
""")
