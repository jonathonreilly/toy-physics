...
Addresses the reviewer's 2026-04-17 uniqueness blocker by upgrading the
native-gauge scope theorem from an admissible extension to a forced
uniqueness theorem inside the admissibility package (A1)-(A5).
...
def part_e_pipeline() -> None:
    ...
    print("  This completes the strongest current support-route d_s = 3")
    print("  package under admissibility conditions (A1)-(A5).")
...
def main() -> int:
    ...
    print("  this uniquely forces n = 3 within that admissibility package.")
    print("  That upgrades d_s = 3 from a bare axiom to the strongest")
    print("  current support-route theorem on main, but not yet to retained")
    print("  closure.")
    print("=" * 72)
