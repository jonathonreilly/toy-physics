...
def main() -> None:
    ...
    print(f"  h=0.5 frontier closed? {'yes' if 'degenerate point-like cases' in sweep_3d else 'no'}")
    print(f"  2D threshold closed? {'yes' if 'every scanned topn value stayed stable' in threshold_2d else 'no'}")
